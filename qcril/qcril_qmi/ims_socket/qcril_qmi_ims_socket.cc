...
boolean qcril_qmi_ims_socket_agent::init_socket_listenfd()
{
    ...
    strncpy(servaddr.sun_path, QCRIL_QMI_IMS_SOCKET_PATH, sizeof(servaddr.sun_path)-1);
    unlink(QCRIL_QMI_IMS_SOCKET_PATH);
...
{
    QCRIL_LOG_FUNC_ENTRY();
    qcril_qmi_ims_socket_agent::get_instance()->init();
    QCRIL_LOG_FUNC_RETURN();
} // qcril_qmi_ims_socket_init
