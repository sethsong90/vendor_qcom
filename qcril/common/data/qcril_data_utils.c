...
#define QCRIL_DATA_UTIL_MAX_PARTIAL_RETRY_TIMEOUT      (100)
...
)
{
  ...
  if (timeout > QCRIL_DATA_UTIL_MAX_PARTIAL_RETRY_TIMEOUT)
  {
    timeout = QCRIL_DATA_UTIL_MAX_PARTIAL_RETRY_TIMEOUT;
  }
