...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/netiface/rel/11.03/inc/ps_stat_iface.h#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
typedef enum
{
  ...
  /* Desc : Time in seconds since the iface has been open*/
  /* type : uint32 */
  PS_STAT_IFACE_TOTAL_OPEN_TIME_SINCE_POWER_UP   = 8,
  /* Desc : Time in seconds since the iface has been active*/
  /* type : uint32 */
  PS_STAT_IFACE_TOTAL_ACTIVE_TIME_SINCE_POWER_UP   = 9,
  /* Desc : # bytes transferred since last reset upto now*/
  /* type : uint64 */
  PS_STAT_IFACE_TOTAL_BYTES_TRANSFERRED_SINCE_POWER_UP   = 10,
  /* Desc : # of bytes transferred during current connection*/
  /* type : uint64 */
  PS_STAT_IFACE_BYTES_TRANSFERRED   = 11,
  /* Desc : Time in seconds since the last IO on this iface*/
  /* type : uint32 */
  PS_STAT_IFACE_LAST_UPSTATE_TIMESTAMP   = 12,
  /* Desc : Time in seconds since last time this iface was brought up*/
  /* type : uint32 */
  PS_STAT_IFACE_FIRST_IO_TIEMSTAMP   = 13, 
  /* Desc : state of the interface */
  /* type : uint16 */
  PS_STAT_IFACE_STATE            = 14,
