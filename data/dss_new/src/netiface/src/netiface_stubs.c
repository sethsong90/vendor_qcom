...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/netiface/rel/11.03/src/netiface_stubs.c#1 $
...
#include "ds_Utils_DebugMsg.h"
  ...
  #define _NO_QOS_STUBS
#endif /* FEATURE_DATA_PS_QOS */

//#ifndef _NO_QOS_STUBS
//#error QOS Stubs defined
//#else
//#error QOS Stubs undefined
//#endif

#ifdef FEATURE_DATA_PS_MCAST
  #define _NO_MCAST_STUBS
  ...
  #define _NO_DPL_STUBS
#endif /* FEATURE_DATA_PS_DATA_LOGGING */
#endif /* FEATURE_DATA_PS */

#if !defined(_NO_FLOW_QOS_STUBS) || !defined(_NO_MCAST_STUBS) ||          \
    !defined(_NO_IPV6_STUBS) || !defined(_NO_DPL_STUBS)

#define NETIFACE_STUBS_EXT_PERROR_NO_FEAT(api, feat)                      \
  LOG_MSG_ERROR(#api": "#feat" feature(s) turned off."                        \
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  MCAST_PERROR(ps_iface_mcast_get_group_list);
  return NULL;
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  MCAST_PERROR(ps_iface_mcast_get_querier_v1_timer);
  return 0;
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  MCAST_PERROR(ps_iface_enable_multicast);
  return -1;
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  MCAST_PERROR(ps_iface_disble_multicast);
  return -1;
...
RETURN VALUE
  Pointer to string containing descrition of specified ps_iface
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_get_iface_desc);
  return NULL;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_set_iface_desc);
  return FALSE;
}
...
DESCRIPTION
  Get flow description from ps_flow structure.
  CALLER MUST NOT MODIFY MEMORY AT THE RETURN ADDRESS!
...
RETURN VALUE
  Pointer to string containing descrition of specified flow
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_get_flow_desc);
  return NULL;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_set_flow_desc);
  return FALSE;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_get_phys_link_desc);
  return NULL;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_set_phys_link_desc);
  return FALSE;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_support_network_logging);
  return -1;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_support_flow_logging);
  return -1;
}
...
{
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  DPL_PERROR(ps_iface_dpl_support_link_logging);
  return -1;
}
#endif /* _NO_DPL_STUBS */
#endif /* QOS_STUBS || MCAST_STUBS || IPV6_STUBS || DPL_STUBS */
