...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/netiface/rel/11.03/src/ps_acl.c#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
)
{
  if(policy_info_ptr != NULL)
  {
    ...
    policy_info_ptr->is_sock_orig       = FALSE;
