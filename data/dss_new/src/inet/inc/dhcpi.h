...
$Id: //source/qcom/qct/modem/datamodem/protocols/inet/rel/11.03/inc/dhcpi.h#1 $
...
===========================================================================*/
/*===========================================================================
FUNCTION DHCP_ARP_IPV4_CACHE_UPDATE()

DESCRIPTION
  This function is called  to set or clear AR entries related to a 
  particular LLE. If there is no LLE associated with this PS_IFACE,
  no action is taken.
...
SIDE EFFECTS
  None
===========================================================================*/
void dhcp_arp_ipv4_cache_update
(
...
/*===========================================================================
FUNCTION DHCP_SERVER_AM_MP_NEW()

DESCRIPTION
  This function allocates and initializes a dhcp_am handle with
  multiplexing support for the multiple IP address Address Manager.
  This works by keeping track of all existing address
  manager handles that have been allocated.  If we are reusing one,
  then pass that handle back.  If not, then set up a new MP address
  manager that points at the multiple/single IP address manager. 
...
===========================================================================*/
void *
dhcp_server_am_mp_new
( 
  dhcp_am_init * init
);

/*===========================================================================
FUNCTION DHCP_AM_MP_GET_CONN_INFO()

DESCRIPTION
  This function returns the info about the devices 
  which are currently connected.

DEPENDENCIES
  Handle must have been previously allocated and started.
  Memory must have been allocated for   the required number 
  of conn_devs elements.

PARAMETERS
  void * - Handle to the glue needed to get at the connection
           details.
  dhcp_server_conn_devices_info_s * conn_devs - Contains information about the 
                                                connected devices.
  uint32   num_conn_devs - contains the required number of connected devices 
                           information.

RETURN VALUE
  uint32: least of the actual connected devices and num_conn_devs.
...
/*===========================================================================
FUNCTION DHCP_AM_MP_RELEASE_CONN()

DESCRIPTION
  This function updates the lease info associated with 
  the client being disconnected by WLAN
...
PARAMETERS
  void * - Handle to the glue needed to get at the connection
           details.
  dhcp_server_conn_devices_info_s  *dev_info - Info on device 
...
/*===========================================================================
FUNCTION DHCP_AM_MP_GET_NUM_CONN()

DESCRIPTION
  This function returns the number of devices which 
...
RETURN VALUE
  uint32 - The number of connected devices.

SIDE EFFECTS
  None
===========================================================================*/
uint32
dhcp_am_mp_get_num_conn
( 
  void * handle 
);
