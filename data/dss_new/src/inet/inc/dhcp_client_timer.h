...
$Id: //source/qcom/qct/modem/datamodem/protocols/inet/rel/11.03/inc/dhcp_client_timer.h#1 $
...
/*===========================================================================
FUNCTION DHCP6_CLIENTI_TIMER_STOP

Description:
  This function stops the timer layer.  This will cause any resources
  in use to be freed. 
