...
$Id: //source/qcom/qct/modem/datamodem/protocols/inet/rel/11.03/inc/dhcp_clienti.h#1 $
...
#ifdef FEATURE_DATA_PS_DHCP_RAPID_COMMIT
  boolean rapid_commit_option;       /* RFC 4039 */
#endif /* FEATURE_DATA_PS_DHCP_RAPID_COMMIT */
...
#ifdef FEATURE_DATA_PS_DHCP_CLIENT_ID_CUSTOM
  uint8 client_id[DHCP_CLIENT_CLIENT_ID_MAX_LEN];
#endif /* FEATURE_DATA_PS_DHCP_CLIENT_ID_CUSTOM */
