...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/protocols/inet/rel/11.03/inc/ps_icmp.h#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
typedef enum
{
  ...
  IMCP_RTR_SOL         = 10,                    /*  MIP agent solicitation */
