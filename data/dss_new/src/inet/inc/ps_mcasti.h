...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/protocols/inet/rel/11.03/inc/ps_mcasti.h#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
/*---------------------------------------------------------------------------
 Macro to generate a random time delay in the interval (0, x] seconds
---------------------------------------------------------------------------*/
#define MCAST_RANDOM_DELAY(x) ((ran_next() % x) + 1)
