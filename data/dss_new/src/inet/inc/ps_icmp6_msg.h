...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/protocols/inet/rel/11.03/inc/ps_icmp6_msg.h#1 $
...
typedef struct
{
  ...
  uint32                retrans_timer; /* Time in ms between retransmitted */
                                       /* neighbor soclicitation messages  */
  boolean               src_link_addr_incl; /* link addr option included ? */
  ...
  uint16                       route_info_option_cnt;   /* # pf route opts
                                                           included        */
