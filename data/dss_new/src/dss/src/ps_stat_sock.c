...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dss/rel/11.03/src/ps_stat_sock.c#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...

{
  ...
  {
    LOG_MSG_ERROR(" Instance pointer should be NULL for Socket stats",0,0,0);
