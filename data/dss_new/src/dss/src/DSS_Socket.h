...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dss/rel/11.03/src/DSS_Socket.h#1 $
...
//-------------------------------------------------------------------
  protected:
    ...
    static uint32 GetEventHandlerFunc(ds::Sock::SocketEventType eventId);
    AEEResult CreateSignal(ISignalCtl** ppiSignalCtl, ISignal** ppiSignal,
...
//-------------------------------------------------------------------
     ...
     static void ReadSignalFcn(void *pEventId);
     static void WriteSignalFcn(void *pEventId);
     static void CloseSignalFcn(void *pEventId);
     static void AcceptSignalFcn(void *pEventId);
     static void StaticSdbAckSignalFcn(void *pEventId);
