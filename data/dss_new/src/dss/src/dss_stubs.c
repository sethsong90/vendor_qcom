...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dss/rel/11.03/src/dss_stubs.c#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
#include "customer.h"
  ...
  #define _NO_DS_SOCKETS_STUBS /* DS_SOCKETS Stubs not required */
...
#include "ps_acl.h"
  ...
  #define _NO_QOS_STUBS /* QOS Stubs not required */
#endif /* FEATURE_DATA_PS_QOS */

#ifdef FEATURE_DATA_PS_DNS
  #define _NO_DNS_STUBS /* DNS Stubs not required */
#endif /* FEATURE_DATA_PS_DNS */

#endif /* FEATURE_DATA_PS */

#if !defined(_NO_DS_SOCKETS_STUBS) || !defined(_NO_DNS_STUBS) || \
!defined(_NO_QOS_STUBS) 
...
#endif  /* DNS_STUBS */
#endif  /* DS_SOCKETS_STUBS || DNS_STUBS */
