...
/*!
  ...
  Please see ds::Net::QoSSecondaryState for more documentation about the 
  meaning of these.
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dsnet/rel/11.03/src/ds_Net_QoSSecondary.h#1 $
...
private:
  ...
  QoSSecondaryJson   mQoSSecondaryJson;
  /*!
  @brief      
  Private destructor.
...
public:
  ...
  */
  ...
  @param[in] requestedSpec - Pointer to the modify QOS spec Json string.
  ...
  */
  ...
  the state of the interface is ds::Net::QoSSecondaryState::
  ...
  */
  ...
  register for ds::Net::QoSSecondaryEvent::STATE_CHANGED, and verify that 
  the state of the interface is ds::Net::QoSSecondaryState::SUSPENDED
  ...
  */
  ...
  @see    ds::Net::QoSSecondaryStateType
  ...
  */
  ...
  (
    QoSSecondaryStateInfoType* pState
  );
