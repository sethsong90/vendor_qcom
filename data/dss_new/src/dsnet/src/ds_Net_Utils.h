...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dsnet/rel/11.03/src/ds_Net_Utils.h#1 $
...
#ifdef FEATURE_DSNET_NO_OPERATOR_OVERLOADING

#define DSNET_OVERLOAD_OPERATOR_NEW(pool_id) 
#define DSNET_OVERLOAD_OPERATOR_DELETE
#define DSNET_OVERLOAD_OPERATORS(pool_id)
