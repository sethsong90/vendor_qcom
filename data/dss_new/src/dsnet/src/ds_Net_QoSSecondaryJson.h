#ifndef DS_NET_QOS_SECONDARY_JSON_H
#define DS_NET_QOS_SECONDARY_JSON_H
/*===========================================================================
@file ds_Net_QoSSecondaryJson.h

This file defines the class of QoS Secondary implimentation using JSon
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dsnet/rel/11.03/src/ds_Net_QoSSecondaryJson.h#1 $
  $DateTime: 2011/06/17 12:02:33 $$Author: zhasan $

  when       who what, where, why
  ---------- --- ------------------------------------------------------------
  2010-08-10 en  Created module.
...
namespace ds
{
  namespace Net
  {
    class QoSSecondaryJson
    {
      private:
        int32      mHandle;
      public:
        QoSSecondaryJson(int32 ifaceHandle);
        /*! 
        @brief
        ...
        */
        ...
        @return     None.
        */
        virtual ~QoSSecondaryJson() throw() {};
        ...
        DSNET_OVERLOAD_OPERATORS(PS_MEM_DS_NET_QOS_SECONDARY_JSON);
...
#endif //DS_NET_QOS_SECONDARY_JSON_H
