...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dsnet/rel/11.03/src/ds_Net_Conversion.h#1 $
...
/*!
  @brief
  This function translates a static NAT Entry from PS to DS format.

  @details
  This function translates a static NAT Entry from PS to DS format. 

  @param[in]   pPSIPNatEntry - Pointer to input NAT entry.
  @param[out]  pDSNetIPNatEntry - Pointer to output NAT entry.
  @return      None.
*/
...
/*!
  @brief
  This function translates a static NAT Entry from DS to PS format.

  @details
  This function translates a static NAT Entry from DS to PS format. 

  @param[in]   pDSNetIPNatEntry - Pointer to input NAT entry.
  @param[out]  pPSIPNatEntry - Pointer to output NAT entry.
  @return      None.
*/
...
/*!
  @brief
  This function translates a DMZ Entry from DS to PS format.

  @details
  This function translates a DMZ Entry from DS to PS format. 

  @param[in]   pDSNetDMZEntry - Pointer to input DMZ entry.
  @param[out]  pPSDMZEntry - Pointer to output DMZ entry.
  @return      None.
*/
void DS2PSDMZEntry
(
...
/*!
  @brief
  This function translates a DMZ Entry from PS to DS format.

  @details
  This function translates a DMZ Entry from PS to DS format. 

  @param[in]   pPSDMZEntry - Pointer to input DMZ entry.
  @param[out]  pDSNetDMZEntry - Pointer to output DMZ entry.
  @return      None.
*/
void PS2DSDMZEntry
(
...
/*!
  ...
  @return     The iface state in ds layer format.
  @return     ds::Net::QoSSecondaryState::UNAVAILABLE when the state is 
              down or invalid input
*/
ds::Net::QoSSecondaryStateType PS2DSFlowState
(
