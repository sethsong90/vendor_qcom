...
/*=============================================================================
        Copyright 2005 - 2007 Qualcomm Technologies, Inc.
               All Rights Reserved.
...
{
   virtual int CDECL CheckPrivileges(AEEPRIVID *aprivs, int nPrivsLen) = 0;
   virtual int CDECL GetPrivileges(AEEPRIVID *aprivs, int nPrivsLen,
                                   int* pnPrivsLenReq) = 0;
   virtual int CDECL CreateSubset(const AEEPRIVID* aprivSubset,
