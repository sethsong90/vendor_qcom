...
/*===========================================================================
  ...
  $Header: //linux/pkgs/proprietary/oncrpc/main/source/dsm/dsm_item.h#3 $
...
#ifdef FEATURE_DSM_SMALL_HEADERS

#ifndef DSM_TRACE_LEN
#define DSM_TRACE_LEN (0)
#endif

/* Header size + pad + free-stack */
#define DSM_ITEM_HEADER_SIZE (((24+(DSM_TRACE_LEN*8))&~31)+32+4)

#else /* FEATURE_DSM_SMALL_HEADERS */
...
#endif /* FEATURE_DSM_SMALL_HEADERS */
...
#endif /* DSM_KIND */           /* Also user-defined                       */
