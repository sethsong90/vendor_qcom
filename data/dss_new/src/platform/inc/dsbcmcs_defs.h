...
/*===========================================================================
  ...
  $Header: //depot/asic/sandbox/users/hmurari/qcmapi_porting/stubs/inc/dsbcmcs_defs.h#1 $ $DateTime: 2009/06/27 17:34:52 $ $Author: hmurari $
...
/*~ CASE DSBCMCS_ZONE_HDR dsbcmcs_zone.zone.subnet */
/*~ DEFAULT dsbcmcs_zone.zone.void */
...
/*~ FIELD dsbcmcs_zone.zone DISC dsbcmcs_zone.type */
