...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/protocols/linklayer/rel/11.03/inc/ps_stat_ppp.h#2 $ $DateTime: 2011/07/04 00:45:23 $ $Author: ttv $
...
#define PS_STAT_INST_DESC_PPP_MAX_DEV_NAME_LEN             6

/*--------------------------------------------------------------------------
