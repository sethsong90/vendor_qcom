...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datahlos/interface/qmiifacectls/rel/11.01.01/src/ds_qmimsglib_task.c#1 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for( ;; )
  {
    ...
    if( !(ret_val & set_sigs) )
    {
      MSG_MED(" The previously set signal was not set",0,0,0);
    }
