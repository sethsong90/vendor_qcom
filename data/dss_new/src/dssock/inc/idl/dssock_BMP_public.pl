...
print("\n*************************************************************************************************\n");
print("**************************** BMP review validation for DSSOCK QCM API ***************************\n");
print("*************************************************************************************************\n");
print("********* USAGE: perl dssock_BMP_public.pl <path of //brewery/review/ on local machine> *********\n");
print("*************************************************************************************************\n");
...
#open input file
open(INFILE,"dssock_BMP_public.txt") or die("Can't open file dssock_BMP_public.txt\n");
