...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dssock/rel/11.03/inc/ds_Sock_AddrUtils.h#1 $
  ...
  namespace Sock
  {
    namespace AddrUtils
    {
      ...
      */
      ...
      {
        std_memmove((void*)(familyPtr),addrStorage,sizeof(ds::AddrFamilyType));
        return AEE_SUCCESS;
      };
      ...
      */
      ...
      {
        std_memmove(addrStorage,(const void*)(&family),sizeof(ds::AddrFamilyType));
        return AEE_SUCCESS;
      };
