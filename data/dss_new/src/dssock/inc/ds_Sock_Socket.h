...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/dssock/rel/11.03/inc/ds_Sock_Socket.h#3 $
  $DateTime: 2011/07/08 11:33:55 $ $Author: smasetty $
    ...
    */
    ...
    namespace SocketEvent
    {
      ...
      typedef enum
      {
        ...
        WRITE_BIT_MASK_WAITING_FOR_IFACE_UP            = 0x00800000
      ...
      typedef enum
      {
        ...
        READ_BIT_MASK_WAITING_FOR_IFACE_UP             = 0x00800000
                   ...
                   public ds::Utils::SignalHandlerBase
    {
      public:
        ...
        */
        ...
        /*-------------------------------------------------------------------
          ISocketPriv methods
        -------------------------------------------------------------------*/
        virtual ds::ErrorType CDECL StartNetwork
        (
          void
        );

        virtual ds::ErrorType CDECL SetCloseOnNullBearerTimeout
        (
          int timeoutSec
        );
        ...
        /*-------------------------------------------------------------------
          IPort1 interface Methods
        -------------------------------------------------------------------*/
        virtual ds::ErrorType CDECL Readable
        (
          ISignal * signalObjPtr
        );

        virtual ds::ErrorType CDECL Writeable
        (
          ISignal * signalObjPtr
        );

        virtual ds::ErrorType CDECL Control
        (
          AEEUID        uidControl,
          const byte *  inPtr,
          int           inLen,
      ...
      protected:
        ...
        */
        ...
        /**
          ...
          @param[in] privset   The privilege set of the client created
                               this socket.
        ...
        */
        ...
        /**
          @brief Check privileges for set option operations

          Check that the client has privileges for a set option operation

          @param[in] optName  Option name
          @retval AEE_SUCCESS If has privileges
          @retval AEE_EPRIVLEVEL If has no privileges
        */
        ds::ErrorType CheckSetOptPrivileges
        (
          OptNameType   optName
        );

        /**
          @brief Check privileges for set option privileged operations

          Check that the client has privileges for a set option privileged operation

          @param[in] optName  Option name
          @retval AEE_SUCCESS If has privileges
          @retval AEE_EPRIVLEVEL If has no privileges
        */
        ds::ErrorType CheckSetOptPrivPrivileges
        (
          OptNameTypePriv   optName
        );
        ...
        */
        ...
        /**
          ...
          maintained on receving events such as IFACE_DOWN_EV.
        ...
        */
        ...
        virtual ds::ErrorType StartNetworkInternal
        (
          void
        );
      ...
      private:
        ...
        /**
          @brief Check for readable relevant events bit mask and
          clear the signal bus if all the relevant events are not set.

          @retval None

          @see ds::Sock::Event
          @see Readable in AEEIPort1.idl
        */
        void ClearReadableEvent
        (
        )
        throw();

        /**
          @brief Check for writeable relevant events bit mask and
          clear the signal bus if all the relevant events are not set.

          @retval None

          @see ds::Sock::Event
          @see Writeable in AEEIPort1.idl
        */
        void ClearWriteableEvent
        (
        )
        throw();
        ...
        ds::Utils::OnDemandSignalBus  readableSignalBus;
        ds::Utils::OnDemandSignalBus  writeableSignalBus;
