...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/inc/ps_crit_sect.h#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
#define PS_ENTER_CRIT_SECTION(a) ps_enter_crit_section(a,__LINE__,__FILE__)
...
*/
#ifdef FEATURE_DEBUG_CRIT_SECTS
#define PS_LEAVE_CRIT_SECTION(a) ps_leave_crit_section(a,__LINE__,__FILE__)
