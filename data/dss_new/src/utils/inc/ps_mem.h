...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/inc/ps_mem.h#1 $
...
typedef enum
{
  ...
  PS_MEM_DS_NET_QOS_MANAGER_JSON       = 88,
  ...
  PS_MEM_DSAL_PRIMARY_NET_APP_TYPE    = 103,
  PS_MEM_DSAL_SECONDARY_NET_APP_TYPE  = 104,
  ...
  PS_MEM_DS_UTILS_FULL_PRIV_SET        = 121,
  PS_MEM_SOCK_1_NET_CTL_TYPE           = 122,
  PS_MEM_SOCK_2_NET_CTL_TYPE           = 123,
  PS_MEM_SOCK_3_NET_CTL_TYPE           = 124,
  PS_MEM_DS_NET_NETWORK_FACTORY_CLIENT_TYPE = 125,
  PS_MEM_DS_NET_QOS_JSON_2_PS            = 126,
  PS_MEM_DS_NET_QOS_JSON                 = 127,
  PS_MEM_DS_NET_QOS_SECONDARY_JSON       = 128,
  PS_MEM_DS_NET_QOS_DEFAULT_JSON         = 129,
