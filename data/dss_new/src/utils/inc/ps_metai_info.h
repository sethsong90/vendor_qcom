...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/inc/ps_metai_info.h#1 $
...
#define PS_RT_META_INFO_GET(rt_mi_ptr)                                  \
  ...
  RT_META_INFO_DEBUG( "RT_META_INFO_GET ptr 0x%p", rt_mi_ptr, 0, 0 );     \
  if ((rt_mi_ptr) != NULL)                                                        \
  {                                                                        \
...
#define PS_PKT_META_INFO_GET(pkt_mi_ptr)                                     \
  ...
  if ((pkt_mi_ptr) != NULL)                                                          \
  {                                                                      \
    PKT_META_INFO_DEBUG( "PKT_META GET ptr 0x%p", (pkt_mi_ptr), 0, 0 );    \
...
#define PS_TX_META_INFO_GET(tx_mi_ptr)                                 \
  ...
  if ( (tx_mi_ptr) != NULL )                                              \
  {                                                                         \
    TX_META_INFO_DEBUG( "TX_META GET ptr 0x%p",tx_mi_ptr, 0, 0 );    \
...
#define PS_RX_META_INFO_GET(rx_mi_ptr)                                  \
  ...
  RX_META_INFO_DEBUG("RX_META GET ptr 0x%p",rx_mi_ptr,0,0);          \
  if ((rx_mi_ptr) != NULL)                                                \
  {                                                                        \
