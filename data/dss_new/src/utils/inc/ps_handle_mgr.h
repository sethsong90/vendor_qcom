...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/inc/ps_handle_mgr.h#2 $
  $DateTime: 2011/07/20 10:24:09 $
  $Author: brijeshd $
...
typedef enum
{
  ...
  PS_HANDLE_MGR_CLIENT_PS_QTF           = 11,
#endif

  PS_HANDLE_MGR_CLIENT_DSS_SOCK_FD      = 12,
...
PARAMETERS
  ...
  min_base_handle         : Minimum base value that client wants to use 
                            for a handle,i.e. minimum value of a handle is 
							"min_base_handle"
