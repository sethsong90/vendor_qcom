...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/inc/ds_Utils_CSSupport.h#1 $
...
#define DSIQI_CREATE_INSTANCE(ns,classname)                                 \
    ...
    {                                                                       \
        ...
        (ns::classname::CreateInstance(clsid, env, privset, newObj));       \
    }
...
#define DSIQI_IMPL_CREATE_INSTANCE2(ns1,ns2,classname)                      \
    ...
    {                                                                       \
        return static_cast<int>                                             \
        (ns1::ns2::classname::CreateInstance(env, clsid, privset, newObj)); \
    }
...
#define DSIQI_ADDREF()                                                   \
  ...
  {                                                                      \
    ...
    LOG_MSG_INFO3("Obj 0x%p, refCnt %d", this, refCnt, 0);               \
    return refCnt;                                                       \
  }
    ...
    {                                                                    \
      ...
      default:                                                           \
        return AEE_ECLASSNOTSUPPORT;                                     \
                                                                         ...
                                                                         \
    LOG_MSG_INFO2 ("Obj 0x%p, IID 0x%x", this, iid, 0);                  \
    return AEE_SUCCESS;                                                  \
  }
...
#define DS_UTILS_IWEAKREF_ADDREF_WEAK()                                     \
  ...
  {                                                                         \
    ...
    LOG_MSG_INFO3("Obj 0x%p, weakRefCnt %d", this, tmpRefCnt, 0);           \
    return tmpRefCnt;                                                       \
  }
