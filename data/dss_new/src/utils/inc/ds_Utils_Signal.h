...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/inc/ds_Utils_Signal.h#1 $
...
private:
  ...
  /*!
    ...
    @param[in]  uArgA - Registered callback function.
    @param[in]  uArgB - The "me" object.
