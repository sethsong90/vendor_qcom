...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/src/pstimer_cs.c#1 $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  {
    LOG_MSG_FATAL_ERROR("Callback from timer API with invalid handle %d!\n",
              (handle & PS_TIMER_HANDLE_MASK), 0, 0);
  }
...
void ps_timer_dtor(void* pv)
{
  ...
  std_memset(ps_timer, 0, sizeof(*ps_timer));
}
