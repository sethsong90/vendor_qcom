...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/datamodem/interface/utils/rel/11.03/src/ps_utils_cs.c#1 $ $DateTime: 2011/06/17 12:02:33 $ $Author: zhasan $
...
RETURN VALUE
  Status returned from the NV read request.  An LOG_MSG_FATAL_ERROR is logged if status is
  other than:
