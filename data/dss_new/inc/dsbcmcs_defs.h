...
INITIALIZATION AND SEQUENCING REQUIREMENTS
 ...
 Copyright (c) 2004 - 2010 by Qualcomm Technologies, Inc.
 All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/dsbcmcs_defs.h#1 $ $DateTime: 2011/01/10 09:44:56 $ $Author: maldinge $
