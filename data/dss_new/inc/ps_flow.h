...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ps_flow.h#2 $
  $DateTime: 2011/07/25 10:55:04 $ $Author: anupamad $
...
struct ps_flow_s
{
  ...
  struct
  {
    ...
    uint32                valid_cookie;
    q_type                event_q_array[(int)FLOW_MAX_EV - (int)FLOW_MIN_EV];
