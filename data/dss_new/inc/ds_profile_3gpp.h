...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ds_profile_3gpp.h#9 $ $DateTime: 2011/07/25 16:18:02 $ $Author: anupamad $
...
/*---------------------------------------------------------------------------
  Profile Family type. 
  Currently 2 profile families are supported -
  Embedded profile family for all socket calls.
  Tethered profile family for all ATCoP and RmNET calls.
---------------------------------------------------------------------------*/
...
typedef enum
{
  ...
  DS_PROFILE_3GPP_PROFILE_PARAM_MAX = DS_PROFILE_3GPP_PROFILE_PARAM_LINGER_PARAMS
