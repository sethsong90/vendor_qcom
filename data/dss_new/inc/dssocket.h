...
Copyright (c) 1998-2011 by Qualcomm Technologies, Inc.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/dssocket.h#3 $ $DateTime: 2011/04/29 14:20:57 $ $Author: anupamad $
...
typedef enum
{
  ...
  DSS_NET_DOWN_REASON_EHRPD_ERR_VSNCP_3GPP2I_ERROR_MAX = 
