...
Copyright (c) 1998-2011 Qualcomm Technologies, Inc.
All Rights Reserved.
...
$Header: //source/qcom/qct/modem/api/datamodem/main/latest/ps_svc.h#3 $ $DateTime: 2011/06/22 21:10:56 $ $Author: maldinge $
...
---------------------------------------------------------------------------*/
  ...
  PS_BC_RX_DATA_Q_SIGNAL          = 18,   /* BCMCS data q signal           */

  PS_LO_TX_DATA_Q_SIGNAL          = 19,   /* loopback data q signal        */
  ...
  -------------------------------------------------------------------------*/
  PS_PDP0_UM_RX_Q_SIGNAL          = 20,   /* UMTS Um PDP0 Rx data Signal   */
  PS_PDP1_UM_RX_Q_SIGNAL          = 21,   /* UMTS Um PDP1 Rx data signal   */
  PS_PDP2_UM_RX_Q_SIGNAL          = 22,   /* UMTS Um PDP2 Rx data signal   */
  PS_PDP_MAX_UM_RX_Q_SIGNAL       = PS_PDP2_UM_RX_Q_SIGNAL, /* Max instance*/

  PS_RESV_ONCRPC_REPLY_SIGNAL     = 23,   /* Reserved for ONCRPC IPCs      */
  PS_DVBH_RX_DATA_Q_SIGNAL        = 24,   /* DVB-H Rx data q signal        */
  PS_SLIP_RX_DATA_Q_SIGNAL        = 25,   /* SLIP Rx data q signal         */
  PS_LAN_802_1X_TX_DATA_Q_SIGNAL  = 26,   /* 802.1X Tx Data queue signal   */
  PS_SIG_MASK_CHANGE_SIGNAL       = 27,   /* Indicates sig mask has changed*/

  PS_RESV_SEC_OP_COMP_SIGNAL      = 28,   /* Reserved Security signal      */

  PS_FLO_BC_RX_DATA_Q_SIGNAL      = 29,   /* FLO BCMCS data q signal       */
  PS_RESV_EFS_OP_COMP_SIGNAL      = 30,   /* Reserved EFS -  signal        */
  PS_RESV_DM_FLASH_DRV_SIGNAL     = 31,   /* Reserved Data Mover signal    */
  /*------------------------------------------------------------------------
    Extended Signals #1 (range 32-63) - RX Signals for PS interfaces

    Modules using these need to set/clear them using the PS_EXT
  -------------------------------------------------------------------------*/
  PS_EXT1_RX_SIGNAL_BASE          = 32,   /* PS RX signal base             */
  PS_RX_RMNET1_SIGNAL             = 32,   /* RmNet1 RX signal              */
  PS_RX_RMNET2_SIGNAL             = 33,   /* RmNet2 RX signal              */
  PS_RX_RMNET3_SIGNAL             = 34,   /* RmNet3 RX signal              */
  PS_RX_RMNET4_SIGNAL             = 35,   /* RmNet4 RX signal              */
  PS_RX_RMNET5_SIGNAL             = 36,   /* RmNet5 RX signal              */
  PS_HDLC_PP_FRAMER_SIGNAL        = 37,   /* HDLC PP Framer signal         */
  PS_HDLC_PP_DEFRAMER_SIGNAL      = 38,   /* HDLC PP Deframer signal       */
  PS_RX_UICC_SIGNAL               = 39,

  PS_RX_UW_FMC_SIGNAL             = 40,
  PS_RX_PROXY1_SIGNAL             = 41,   /* Proxy IFACE1 RX signal        */
  PS_RX_PROXY2_SIGNAL             = 42,   /* Proxy IFACE2 RX signal        */
  PS_RX_PROXY3_SIGNAL             = 43,   /* Proxy IFACE3 RX signal        */
  PS_RX_PROXY4_SIGNAL             = 44,   /* Proxy IFACE4 RX signal        */
  PS_RX_PROXY5_SIGNAL             = 45,   /* Proxy IFACE5 RX signal        */
  PS_3GPP_UM_RX_Q_SIGNAL_0        = 46,   /* 3GPP Bearer 0 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_1        = 47,   /* 3GPP Bearer 1 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_2        = 48,   /* 3GPP Bearer 2 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_3        = 49,   /* 3GPP Bearer 3 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_4        = 50,   /* 3GPP Bearer 4 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_5        = 51,   /* 3GPP Bearer 5 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_6        = 52,   /* 3GPP Bearer 6 signal          */
  PS_3GPP_UM_RX_Q_SIGNAL_7        = 53,   /* 3GPP Bearer 7 signal          */
  PS_LAN_WAPI_TX_DATA_Q_SIGNAL    = 54,   /* WAPI Tx Data queue signal     */
  PS_3GPP_RMSM_AT_UM_RX_Q_SIGNAL  = 55,   /* RMSM AT UM data TX signal     */
  PS_QTF_SYNC_SIGNAL              = 56,   /* PS QTF synchronization signal */
  PS_3GPP_LO_B_UM_RX_Q_SIGNAL     = 57,   /* 3GPP Loopback mode B Rx Sig   */
  PS_RX_RMNET1_LLC1_SIGNAL        = 58,   /* To support simultaneous IPV4/IPV6 over single QMI instance*/
  PS_RX_RMNET1_LLC2_SIGNAL        = 59,
  PS_RX_RMNET2_LLC1_SIGNAL        = 60,
  PS_RX_RMNET2_LLC2_SIGNAL        = 61,
  PS_RX_RMNET3_LLC1_SIGNAL        = 62,
  PS_RX_RMNET3_LLC2_SIGNAL        = 63,
  PS_RX_RMNET4_LLC1_SIGNAL        = 64,
  PS_RX_RMNET4_LLC2_SIGNAL        = 65,
  PS_RX_RMNET5_LLC1_SIGNAL        = 66,
  PS_RX_RMNET5_LLC2_SIGNAL        = 67,
  PS_ALG_TX_SIGNAL                = 68,   /* To support ALG mgr to tx 
                                           * translated payloads */
  PS_MAX_SIGNALS,                         /* use next value for enum       */
  PS_EXT1_RX_SIGNAL_MAX = PS_MAX_SIGNALS  /* = MIN (PS_MAX_SIGNALS, 63)    */
} ps_sig_enum_type;
...
typedef enum
{
 ...
 /*-------------------------------------------------------------------------
  ...
  ,PS_IP6_SM_MAX_CMD             = PS_IP6_SM_STOP_CMD
                                       /* used to do math                  */
  ,PS_DHCP_START_CMD             = 52
  ,PS_DHCP_STOP_CMD              = 53
  ,PS_DHCP_CLIENT_START_CMD      = 54 /* Start the DHCP client             */
  ,PS_DHCP_CLIENT_STOP_CMD       = 55 /* Stop the DHCP client              */
  ,PS_DHCP_CLIENT_RENEW_CMD      = 56 /* Send a RENEW to the client        */
  ,PS_DHCP_CLIENT_RELEASE_CMD    = 57 /* Send a RELEASE to the client      */
  ,PS_DHCP_CLIENT_INFORM_CMD     = 58 /* Send an INFORM to the client      */
  ,PS_DHCP_CLIENT_SOCK_EVENT_CMD = 59 /* Send notifation of a socket event */

  ,PS_LAN_LLC_START_CMD          = 60 /* Start an LLC instance             */
  ,PS_LAN_LLC_STOP_CMD           = 61 /* Stop an LLC instance              */

  /*-------------------------------------------------------------------------
     Commands for dial-up networking
  -------------------------------------------------------------------------*/
  /* Dial-up packet control module commands */
  ,PS_DUN_PKT_CTL_IFACE_UP_CMD       = 62
  ,PS_DUN_PKT_CTL_IFACE_DOWN_CMD     = 63
  ,PS_DUN_PKT_CTL_IFACE_EVT_CMD      = 64
  ,PS_DUN_PKT_CTL_PHYS_LINK_UP_CMD   = 65
  ,PS_DUN_PKT_CTL_PHYS_LINK_DOWN_CMD = 66
  ,PS_DUN_PKT_CTL_PPP_EVT_CMD        = 67

  /* Dial-up physical link module commands */
  ,PS_DUN_PHYS_LINK_BRING_UP_CMD     = 68
  ,PS_DUN_PHYS_LINK_TEAR_DOWN_CMD    = 69
  ,PS_DUN_PHYS_LINK_DTR_CHANGED_CMD  = 70
  ,PS_DUN_PHYS_LINK_RDM_OPEN_CMD     = 71
  ,PS_DUN_PHYS_LINK_RDM_CLOSE_CMD    = 72
  ,PS_DUN_PHYS_LINK_PORT_CLOSED_CMD  = 73

  ,PS_SOCKET_FLOW_EVENT_CMD          = 74     /* Flow event         */

  /* Commands for ARP */
  ,PS_ARP_FLUSH_CMD                  = 75 /* Flush an ARP instance's cache */

  /* Commands for Stats */
  ,PS_STAT_LOG_ON_DEMAND_CMD         = 76 /* Process log on demand request */

  ,PS_LAN_LLC_RECONFIG_CMD           = 77 /* Reconfigure an LLC instance   */

  ,PS_TIMER_CALLBACK_CMD             = 78 /* PS Timer expired call cback
                                             in PS context.                */
  ,PS_HDRRSP_CMD                     = 79 /* Route Selection Protocol      */

  ,PS_DHCP_SERVER_SOCK_EVENT_CMD     = 80 /* Send notifation of socket event*/

  ,PS_LL_ADDR_MGR_START_CMD          = 81 /* Start the Link local address mgr */

  ,PS_LL_ADDR_MGR_STOP_CMD           = 82 /* Stop the Link local address mgr  */

  ,PS_LL_ADDR_MGR_CLAIM_CMD          = 83 /* CLAIM an IP address        */

  ,PS_DHCP6_CLIENT_START_CMD         = 84  /* Start the DHCPv6 client   */

  ,PS_DHCP6_CLIENT_STOP_CMD          = 85  /* Stop the DHCPv6 client    */

  ,PS_DHCP6_CLIENT_INFORM_CMD        = 86  /* Send INFORMATION-REQUEST  */

  ,PS_DHCP6_CLIENT_SOCK_EVENT_CMD    = 87  /* Send notification of
                                            * socket event */

  ,PS_RSVP_SOCKET_EVENT_CMD          = 88  /* RSVP socket event call back */

  /* Commands for IGMP/MLD */
  ,PS_MCAST_SEND_REPORT_CMD          = 89 /* Send IGMP/MLD JOIN Message     */

  ,PS_MCAST_SEND_LEAVE_CMD           = 90 /* Send IGMP/MLD LEAVE Message    */

  ,PS_DSS_PING_SEND_PING_CMD         = 91 /* Send ICMP ECHO_REQUEST */

  ,PS_DSS_PING_NET_CB_CMD            = 92 /* Ping network callback */

  ,PS_DSS_PING_SOCK_CB_CMD           = 93 /* Ping socket callback */

  ,PS_DSS_PING_RSP_TIMEOUT_CB_CMD    = 94 /* Ping response timeout cb */

  ,PS_DSM_MEM_EVENT_CTRL_CMD         = 95 /* Post WRITE_EV on sockets      */

  /*-------------------------------------------------------------------------
     Commands for DSS Net Manager
  -------------------------------------------------------------------------*/
  ,PS_DSS_NET_MGR_NET_UP_CMD         = 96 /* Net mgr net up */
  ,PS_DSS_NET_MGR_NET_DOWN_CMD       = 97 /* net mgr net down cmd          */

  /*-------------------------------------------------------------------------
    Domain Name System resolver command.
  -------------------------------------------------------------------------*/
  ,PS_DNS_RESOLVE_CMD                = 98 /* To start the DNS resolver     */
  ,PS_DNS_IO_MGR_SOCK_EVENT_CMD      = 99 /* IO manager sock event cmd     */
  ,PS_DNS_RESOLVER_TIMEOUT_CMD       = 100 /* Resolver timeout event        */
  ,PS_DNS_DELETE_SESSION_CMD         = 101 /* Delete session command        */

  /* Commands for MCAST */
  ,PS_MCAST_JOIN_CMD                 = 102 /* Send MCAST JOIN Message */

  ,PS_MCAST_LEAVE_CMD                = 103 /* Send MCAST LEAVE Message */

  /*-------------------------------------------------------------------------
    MIPv6 Registration State Machine commands
  -------------------------------------------------------------------------*/
  ,PS_MIP6_RSM_REG_CMD               = 104  /* Trigger registration        */
  ,PS_MIP6_RSM_DEREG_CMD             = 105  /* Trigger de-registration     */
  ,PS_MIP6_RSM_REG_SUCCESS_CMD       = 106  /* Reg success                 */
  ,PS_MIP6_RSM_REG_FAIL_CMD          = 107  /* Reg failure                 */
  ,PS_MIP6_RSM_CLOSE_CMD             = 108  /* Tear-down the RSM           */

  /*-------------------------------------------------------------------------
    Instance statistics logging commands
   ------------------------------------------------------------------------*/
  ,PS_STAT_INST_GET_DESC_CMD         = 109  /* Get instance description    */
  ,PS_STAT_INST_GET_STAT_CMD         = 110  /* Get instance stats          */
  ,PS_STAT_INST_RESET_STAT_CMD       = 111  /* Reset instance statistics   */

  /*-------------------------------------------------------------------------
    SIM event handling commands
   ------------------------------------------------------------------------*/
  ,PS_SIM_EVENT_HANDLER_CMD          = 112  /* Handle SIM_INIT_COMPLETED ev*/

  /*-------------------------------------------------------------------------
    EAP/PPP-MMGSDI registration events handling
  -------------------------------------------------------------------------*/
  ,PS_EAP_CLNT_REG_CMD               = 113  /* EAP-MMGSDI client reg       */
  ,PS_EAP_SESSION_EVT_CB_CMD         = 114  /* EAP-MMGSDI session reg      */
  ,PS_PPP_CLNT_REG_CMD               = 115  /* PPP-MMGSDI client reg       */
  ,PS_PPP_EAP_TASK_CMD               = 116  /* PPP/EAP MMGSDI task switch  */

  /*-------------------------------------------------------------------------
    DSSOCK/DSNET commands to process iface, flow, phys link, DOS_ACK events.
  -------------------------------------------------------------------------*/
  ,PS_DSSOCK_PROCESS_GENERIC_EVENT_CMD  = 117
  ,PS_DSSOCK_PROCESS_DOS_ACK_EVENT_CMD  = 118
  ,PS_DSNET_PROCESS_GENERIC_EVENT_CMD   = 119

 /*-------------------------------------------------------------------------
    DHCP MULTIPLE IP MGR event handling commands
   ------------------------------------------------------------------------*/
  ,PS_DHCP_SERVER_MGR_START_CMD         = 120 /* Multiple IP DHCP mgr start */
  ,PS_DHCP_SERVER_MGR_STOP_CMD          = 121 /* Multiple IP DHCP mgr stop */
  ,PS_DNS_PROXY_SOCK_EVENT_CMD          = 122  /* DNS Proxy Socket ev cmd   */
  ,PS_DNS_PROXY_ENABLE_CMD              = 123  /* DNS Proxy Enable command  */
  ,PS_DNS_PROXY_DISABLE_CMD             = 124  /* DNS Proxy Disable command */
  ,PS_DNS_PROXY_IFACE_EVENT_CMD         = 125  /* DNS Proxy Iface ev command*/

  /*-------------------------------------------------------------------------
    PS UTILS AKA commands
  -------------------------------------------------------------------------*/
  ,PS_UTILS_AKA_CMD                     = 126  /* PS UTILS AKA CMD handler */
   
  /*-------------------------------------------------------------------------
    PPP NCP commands (contd..)
  -------------------------------------------------------------------------*/
  ,PS_PPP_NCP_RESYNC_CMD                = 127 /* resync an NCP instance    */ 
  ,PS_PPP_NCP_ABORT_CMD                 = 128 /* abort an NCP instance     */ 
  ,PS_NAT_DELETE_DMZ_CMD                = 129 /* Delete DMZ command        */

  /*-------------------------------------------------------------------------
    PPP DEVICE STOP command
  -------------------------------------------------------------------------*/
  ,PS_PPP_DEVICE_STOP_CMD               = 130 /* PPP Device STOP command   */
