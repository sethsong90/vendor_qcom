...
/*===========================================================================
  ...
  $PVCSPath: $
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/dss_ping.h#1 $ $DateTime: 2011/01/10 09:44:56 $ $Author: maldinge $
...
typedef struct
{
  ...
  uint8  num_pkts_sent;  /* Number of pings sent so far          */
  uint8  num_pkts_recvd; /* Number of responses recieved so far  */
  uint8  num_pkts_lost;  /* Number of responses not received     */
