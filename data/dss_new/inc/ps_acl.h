...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ps_acl.h#1 $ $DateTime: 2011/01/10 09:44:56 $ $Author: maldinge $
...
typedef struct
{
  ...
  ps_ip_addr_type                  ip_addr;       /* assoc iface ip addr     */
  ps_ip_addr_type                  cmpn_ip_addr;  /* companion iface ip addr */
...
struct acl_policy_info_s
{
  ...
  boolean              is_sock_orig; /* Lookup from local stack?           */
