...
Copyright (c) 2002-2012 Qualcomm Technologies, Inc.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ps_iface_ioctl.h#5 $ $DateTime: 2011/06/30 12:05:29 $ $Author: maldinge $
...
#define PS_MAX_DEVICE_NAME_LEN 13
...
typedef enum
{
  ...
  PS_IFACE_IOCTL_GET_EPC_HANDOFF_CTXT     = 122,/* Ctxt from EPC aware sys's*/
  ...
  /*------------------------------------------------------------------------
    ...
    applications.
  -------------------------------------------------------------------------*/
  PS_IFACE_IOCTL_RESERVED_MIN             = 1000,/* Min reserved value     */
  ...
  /* Get device info for iface */
  PS_IFACE_IOCTL_GET_DEVICE_INFO,
  PS_IFACE_IOCTL_GET_INTERFACE_GATEWAY_V4_ADDR,
...
/*---------------------------------------------------------------------------
  PS_IFACE_IOCTL_GET_DEVICE_INFO parameter type
---------------------------------------------------------------------------*/

typedef struct ps_iface_ioctl_get_device_info_s {
  int                 if_index;                             /*Index of the data path interface*/
  char                device_name[PS_MAX_DEVICE_NAME_LEN];  /*data path interface name*/
} ps_iface_ioctl_device_info_type;
