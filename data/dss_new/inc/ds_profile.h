...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ds_profile.h#5 $ $DateTime: 2011/06/01 15:56:43 $ $Author: anupamad $
...
/* DS Profile version. First two digits indicate major version last two minor */
...
typedef enum
{
  ...
  DS_PROFILE_REG_RESULT_ERR_INVAL_SUBS_ID,     /* Subscription id is invalid */
  DS_PROFILE_REG_INVAL_PROFILE_FAMILY,         /* Invalid profile family     */
...
typedef enum
{
  ...
  DS_PROFILE_ACTIVE_SUBSCRIPTION_MAX  = 0xff
...
/*---------------------------------------------------------------------------
  Definitions to configure profiles
  -------------------------------------------------------------------------*/
typedef enum
{
  DS_PROFILE_CONFIG_MASK_NONE        = 0x00,
  DS_PROFILE_CONFIG_MASK_PERSISTENCE = 0x01
...
PARAMETERS
  tech       : technology type
  config_ptr : Configuration to tune how profiles are created
  num        : pointer to return profile number of profile created
...
DESCRIPTION
  This function sets the given profile number as default profile for the
  family of the specified tech and subscription.
...
RETURN VALUE
  ...
  DS_PROFILE_REG_RESULT_ERR_INVAL_PROFILE_TYPE : Profile type is invalid
  DS_PROFILE_REG_RESULT_ERR_INVAL_PROFILE_NUM  : Invalid profile number
  DS_PROFILE_REG_RESULT_ERR_INVAL_OP           : Operation not supported for
                                                 tech type
  DS_PROFILE_REG_RESULT_FAIL                   : On general errors. This return
                                                 code provides blanket coverage
...
DESCRIPTION
  This function gets the default profile number for the family of the
  specified tech and subscription.
