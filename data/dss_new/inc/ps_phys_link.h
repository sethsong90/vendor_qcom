...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ps_phys_link.h#1 $ $DateTime: 2011/01/10 09:44:56 $ $Author: maldinge $
...
struct ps_phys_link_s
{
  ...
  struct private_info_type
  {
    ...
    q_type                 event_q_array[PHYS_LINK_MAX_EV]; /* event q's   */
