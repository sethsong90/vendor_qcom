...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/dss_iface_ioctl.h#4 $ $DateTime: 2011/08/04 11:10:56 $ 
...
/* Enable the slot cycle index mode. This mode will allow for the slot cycle
  ...
  DSS_IFACE_IOCTL_GET_DEVICE_INFO         = PS_IFACE_IOCTL_GET_DEVICE_INFO,
...
/*---------------------------------------------------------------------------
  DSS_IFACE_IOCTL_GET_INTERFACE_GATEWAY_V4_ADDR parameter type
  - Iface Gateway IPV4 address
---------------------------------------------------------------------------*/
typedef ip_addr_type dss_iface_ioctl_gateway_ipv4_addr_type;
...
/*---------------------------------------------------------------------------
  DSS_IFACE_IOCTL_GET_DEVICE_INFO parameter type
---------------------------------------------------------------------------*/
typedef ps_iface_ioctl_device_info_type dss_iface_ioctl_device_info_type;
