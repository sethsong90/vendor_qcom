...
/*===========================================================================
   ...
   $Header: //source/qcom/qct/modem/api/datamodem/main/latest/qmi_framework.h#1 $ 
...
typedef struct
{
  qmi_framework_common_msg_hdr_type  common_hdr;  /* framework common msg header */ 
  uint16                             msg_id;      /* msg ID               */ 
  uint16                             msg_len;     /* msg length           */  
} qmi_framework_msg_hdr_type;
