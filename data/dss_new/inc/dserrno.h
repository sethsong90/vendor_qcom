...
Copyright (c) 1998-2010 Qualcomm Technologies, Inc.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/dserrno.h#1 $ $DateTime: 2011/01/10 09:44:56 $ $Author: maldinge $
