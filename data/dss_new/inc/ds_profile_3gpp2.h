...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/api/datamodem/main/latest/ds_profile_3gpp2.h#7 $ $DateTime: 2011/05/27 11:37:40 $ $Author: anupamad $
...
/*
   Offset for 3gpp2 params.
   This is needed to avoid the overlap between 3gpp and 3gpp2 params.
   These new values are inline with the updated QMI WDS spec.
*/
...
/* RAT (Radio Access Technology) Type, can be used as bit mask */
typedef enum
{
...
typedef enum
{
  ...
  DS_PROFILE_3GPP2_PROFILE_PARAM_LINGER_PARAMS           = 0x2C + 
                                    DS_PROFILE_3GPP2_PARAM_OFFSET,
  DS_PROFILE_3GPP2_PROFILE_PARAM_MAX  = DS_PROFILE_3GPP2_PROFILE_PARAM_LINGER_PARAMS
