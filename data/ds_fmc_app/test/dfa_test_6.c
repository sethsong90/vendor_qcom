...
main(int argc, char ** argv)
{
  ...
  fprintf(stderr, "Test case to indicate failure of WLAN socket connect\n");
  ...
  s = inet_pton(AF_INET, "10.42.36.87", (char*)&(addr->sin_addr));  
  ...
  tunnel_mgr_ds.dest_strm_id = 20001;
  ...
  /* Receive failure because the WLAN socket will fail to connect 
     to an invalid IP */
  ...
  /* Verify whether message received indicates failure */
