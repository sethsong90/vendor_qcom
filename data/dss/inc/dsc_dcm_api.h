...
/******************************************************************************
  ...
  @file    dsc_dcm_api.h
  @brief   DSC's DCM (Connection Manager) RPC API header file

  DESCRIPTION
  RPC API header file for DCM (Data Connection Manager) module.
...
/******************************************************************************
  ...
  $Id: //source/qcom/qct/platform/linux/common/main/latest/apps/dsc/inc/dsc_dcm_api.h#4 $
...
#include "ds_linux.h"
#include "dsci.h"
#include "dssocket_defs_linux_rpc.h"
