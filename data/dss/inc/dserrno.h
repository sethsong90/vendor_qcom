...
DESCRIPTION
 ...
 ----------------------------------------------------------------------------
 Copyright (c) 1998,1999, 2002 Qualcomm Technologies, Inc. 
...
/*===========================================================================
  ...
  $Header: //linux/pkgs/proprietary/data/main/source/dss/inc/dserrno.h#2 $ $DateTime: 2008/07/11 17:04:22 $ $Author: smasetty $
...
---------------------------------------------------------------------------*/
#define DS_LINUX_ERRNO_BASE 1000
#define DS_ENETRECONFIGURED DS_LINUX_ERRNO_BASE+1 /* subsystem reconfigured */
