...
)
{
  ...
  do
  {
    ...
    if (!(DSI_IS_HNDL_VALID(st_hndl)))
    {
      DSI_LOG_ERROR( "dsi_release_qos invalid arg, st_hndl [%x]",
                       (unsigned int)st_hndl );
      break;
    }
...
)
{
  ...
  do
  {
    ...
    if (!(DSI_IS_HNDL_VALID(st_hndl)))
    {
      DSI_LOG_ERROR( "dsi_modify_qos invalid arg, st_hndl [%x]",
                       (unsigned int)st_hndl );
      break;
    }
...
)
{
  ...
  do
  {
    ...
    if (!(DSI_IS_HNDL_VALID(st_hndl)))
    {
      DSI_LOG_ERROR( "dsi_suspend_qos invalid arg, st_hndl [%x]",
                       (unsigned int)st_hndl );
      break;
    }
...
)
{
  ...
  do
  {
    ...
    if (!(DSI_IS_HNDL_VALID(st_hndl)))
    {
      DSI_LOG_ERROR( "dsi_resume_qos invalid arg, st_hndl [%x]",
                       (unsigned int)st_hndl );
      break;
    }
...
)
{
  ...
  do
  {
    ...
    if (!(DSI_IS_HNDL_VALID(st_hndl)))
    {
      DSI_LOG_ERROR( "dsi_get_granted_qos invalid arg, st_hndl [%x]",
                       (unsigned int)st_hndl );
      break;
    }
...
)
{
  ...
  do
  {
    ...
    if (!(DSI_IS_HNDL_VALID(st_hndl)))
    {
      DSI_LOG_ERROR( "dsi_get_qos_status invalid arg, st_hndl [%x]",
                       (unsigned int)st_hndl );
      break;
    }
