...
int qdp_test_10(void)
{
  ...
  do
  {
    ...
    QDP_TEST_LOG("profile setting lte qos g_dl_bit_rate to %d", lte_qos_params.g_dl_bit_rate);
    QDP_TEST_LOG("profile setting lte qos max_ul_bit_rate to %d", lte_qos_params.max_ul_bit_rate);
    ...
    QDP_TEST_LOG("profile setting pdn_inactivity_timeout to %d",
    ...
    profile_params.umts_profile_params.addr_alloc_pref );
    QDP_TEST_LOG("profile  lte qos g_dl_bit_rate to %d",
      profile_params.umts_profile_params.lte_qos_params.g_dl_bit_rate);
    QDP_TEST_LOG("profile  lte qos max_ul_bit_rate to %d",
      profile_params.umts_profile_params.lte_qos_params.max_ul_bit_rate);
    QDP_TEST_LOG("profile  apn_disabled_flag to %d",
      profile_params.umts_profile_params.apn_disabled_flag);
    QDP_TEST_LOG("profile  pdn_inactivity_timeout  to %d",
      profile_params.umts_profile_params.pdn_inactivity_timeout);


    QDP_TEST_LOG("%d", "Enter any key to quit\n");
    getchar();
