...
/******************************************************************************
  ...
  @file    dss_test_100.c
  @brief   DSS API Test 100

  DESCRIPTION
  Tests DSS Net Open and Close Success Case for 2 PDPs
...
/******************************************************************************
  ...
  $Id: //linux/pkgs/proprietary/data/main/source/test/dss/src/dss_test_100.c#1 $
...
const char Test_id[]   = "dss_test_100";
const char Test_name[] = "test net open and close for 2 PDPs";
const char Test_desc[] = " Two applicaions open network then close network, no data transfer, 2 PDPs";
