...
/******************************************************************************
  ...
  @file    dss_test_103.c
  @brief   DSS API Test 103

  DESCRIPTION
  Tests DSS Net Open and Close Success Case for 2 apps, 1 PDP
...
/******************************************************************************
  ...
  $Id: //linux/pkgs/proprietary/data/main/source/test/dss/src/dss_test_103.c#1 $
...
const char Test_id[]   = "dss_test_103";
const char Test_name[] = "test net open and close for 2 apps sharing a PDP using different profiles";
const char Test_desc[] = "Two applications open network then close network, no data transfer, 1 PDP, different profiles";
