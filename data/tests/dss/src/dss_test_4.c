...
/******************************************************************************
  ...
  $Id: //linux/pkgs/proprietary/data/main/source/test/dss/src/dss_test_4.c#1 $
...
const char Test_id[]   = "dss_test_4";
const char Test_name[] = "test net open and close for iface of type DSS_IFACE_WWAN";
const char Test_desc[] = "Opens network then closes network, no data transfer, iface type is DSS_IFACE_WWAN";
...
dss_test_4 (void)
{
    ...
    net_policy.iface.info.name = DSS_IFACE_WWAN;
