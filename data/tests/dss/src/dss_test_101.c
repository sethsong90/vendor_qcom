...
/******************************************************************************
  ...
  $Id: //linux/pkgs/proprietary/data/main/source/test/dss/src/dss_test_101.c#1 $
...
const char Test_id[]   = "dss_test_101";
const char Test_name[] = "test net open and close for 2 apps sharing a PDP";
const char Test_desc[] = "Two applications open network then close network, no data transfer, 1 PDP";
