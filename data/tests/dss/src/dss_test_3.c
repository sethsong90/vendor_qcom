...
/******************************************************************************
  ...
  $Id: //linux/pkgs/proprietary/data/main/source/test/dss/src/dss_test_3.c#1 $
...
const char Test_id[]   = "dss_test_3";
const char Test_name[] = "test net open and close for iface of type DSS_IFACE_ANY";
const char Test_desc[] = "Opens network then closes network, no data transfer, iface type is DSS_IFACE_ANY";
