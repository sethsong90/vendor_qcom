...
/******************************************************************************
  ...
  @file    dss_test_10.c
  @brief   DSS API Test 10

  DESCRIPTION
  Tests DSS Net Open Success Case using policy UP_PREF when a PDP is  
  already active.
...
/******************************************************************************
  ...
  $Id: //linux/pkgs/proprietary/data/main/source/test/dss/src/dss_test_10.c#1 $
...
const char Test_id[]   = "dss_test_10";
const char Test_name[] = "test net open success using policy UP_PREF with an IFACE already active";
const char Test_desc[] = "test net open success using policy UP_PREF with an IFACE already active";
