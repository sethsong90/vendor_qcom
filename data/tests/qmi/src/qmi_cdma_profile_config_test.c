...
)
{
  ...
  profile_id.profile_index = profile_index;
  ...
  fprintf( stderr,"AR_HACK: 3GPP2 APN STRING LEN[%d] VAL[%s]\n",
	   strlen(profile_params.cdma_profile_params.apn_name),
	   profile_params.cdma_profile_params.apn_name );
  fprintf( stderr,"AR_HACK: 3GPP2 USERNAME STRING LEN[%d] VAL[%s]\n",
