...
typedef long I32_ASF;
typedef unsigned long U32_ASF;
...
void CheckAvailableDataSize(uint32 pUserData,uint64* bufDataSize,boolean* pbEndOfData);
...
private:
  ...
  */
  ...
  unsigned long getMSecValueForFrameRateCalculation(U64_ASF);
