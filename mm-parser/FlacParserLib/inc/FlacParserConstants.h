...
/* =======================================================================
                             PERFORCE HEADER
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/FlacParserLib/main/latest/inc/FlacParserConstants.h#8 $
========================================================================== */
...
#define FLAC_PARSER_BUFFER_SIZE                    (65535 + FLAC_MAX_HEADER_BYTES)
...
unsigned char const FLACFieldNames[FLAC_MAX_FIELDNAMES_SUPPORTED][13] =
{
  "TITLE",
  "VERSION",
  "ALBUM",
