...
#define QCP_PARSER_H
  ...
  $Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/QCPParserLib/main/latest/inc/qcpparser.h#17 $
...
extern uint32 QCPCallbakGetData (uint64 nOffset,
...
//=======================================================================
  public:
//qcpParser APIs
  qcpParser(uint32 pUData, uint64 fsize, OSCL_FILE *FilePtr);
...
//=======================================================================
  ...
  uint32             m_pUserData;   /* User callback data */
