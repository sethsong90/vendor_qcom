...
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/AMRNBParserLib/main/latest/src/amrfile.cpp#36 $
                         ...
                         uint32 ulUserData )
{
  if(ulUserData)
  {
    AMRFile *pAMRFile = (AMRFile *)ulUserData;
    uint32 ulReadData = 0;
    ulReadData = pAMRFile->FileGetData(ullOffset,
                                       ulNumBytesRequest,
                                       ulMaxSize,
                                       pucData);
    return (ulReadData);
  }
  MM_MSG_PRIO(MM_FILE_OPS, MM_PRIO_FATAL, "AMRCallbakGetData ulUserData is NULL");
  return 0;
}
...
bool AMRFile::ParseAMRHeader()
{
  ...
  m_pamrParser = MM_New_Args(amrParser,((uint32)this,m_fileSize,m_AMRFilePtr));
                                             ...
                                             uint32 &rulIndex)
{
  ...
  amr_audio_info samr_audio_info;
...
uint64 AMRFile::resetPlayback(  uint64 repos_time, uint32 id, bool bSetToSyncSample,
...
SIDE EFFECTS:
  None.
======================================================================*/
uint32 AMRFile::getMovieTimescale() const
{
...
SIDE EFFECTS:
  None.
======================================================================*/
uint64 AMRFile::getTrackMediaDuration(uint32 id)
{
  uint64 nTrackDuration;
  if(!m_pamrParser)
  {
    return 0;
  }

  nTrackDuration = m_pamrParser->GetClipDurationInMsec();
...
SIDE EFFECTS:
  None.
======================================================================*/
uint32 AMRFile::getTrackMediaTimescale(uint32 id)
{
...
SIDE EFFECTS:
  None.
======================================================================*/
unsigned long AMRFile::GetNumAudioChannels(int id)
{
