...
/* =======================================================================
                             PERFORCE HEADER
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/AVIParserLib/main/latest/inc/aviparser.h#35 $
========================================================================== */
#include <stdio.h>
#include <stdlib.h>
...
*/
extern avi_int32 AVICallbakGetData (avi_int64 nOffset,
                                    avi_uint32 nNumBytesRequest,
                                    unsigned char* pData,
                                    avi_int32  nMaxSize,
                                    avi_uint32  u32UserData);
extern avi_int64 AVICheckAvailableData (avi_uint32 u32UserData);
/*
*aviParser class.
*/
class aviParser
