...
/* =======================================================================
                             PERFORCE HEADER
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/AVIParserLib/main/latest/src/avifile.cpp#153 $
========================================================================== */
...
========================================================================== */
avi_int64 AVICheckAvailableData (avi_uint32 u32UserData)
{
  if(u32UserData)
  {
...
========================================================================== */
avi_int32 AVICallbakGetData (avi_int64         nOffset,
                             ...
                             avi_uint32        u32UserData)
{
  ...
  {
    AVIFile *pAviFile = (AVIFile *)u32UserData;
    return(pAviFile->FileGetData((uint64)nOffset, nNumBytesRequest, nMaxSize, pData));
  }
  else
  {
    MM_MSG_PRIO(MM_FILE_OPS, MM_PRIO_FATAL, "AVICallbakGetData u32UserData is NULL");
  }
  return 0;
}
/* ======================================================================
...
bool AVIFile::ParseMetaData()
{
  ...
  {
    m_pAVIParser =
      MM_New_Args(aviParser,((avi_uint32)this,m_fileSize,(m_playAudio)?false:true,(m_playVideo)?false:true, bHttpStreaming));
  }
  if(m_pAVIParser)
  {
...
RETURN VALUE:
  nEncodeOpt of type unsigned long
...
unsigned long AVIFile::GetAudioEncoderOptions(int id)
{
     ...
     ((audioCodec == WM_AUDIO) || (audioCodec == WM_PRO_AUDIO) ))
  {
    ...
    {
      nEncodeOpt = (unsigned long)(wmaInfo.nEncodeOpt);
    }
  }
  else
  {
...
SIDE EFFECTS:
  None.
======================================================================*/
unsigned long AVIFile::GetFixedAsfAudioPacketSize(int id)
{
  avi_audio_info aInfo ;
  if ( m_pAVIParser && (m_pAVIParser->GetAudioInfo(id,&aInfo)==AVI_SUCCESS))
            ...
            if(
              ...
              )
              {
                ...
                m_bframesMayPresent = TRUE;
                     ...
                     (!memcmp(&vInfo.strfVideo.biCompression,"MPEG4",sizeof(fourCC_t)))||
                     (!memcmp(&vInfo.strhVideo.fccHandler,"MPEG4",sizeof(fourCC_t)))
                   )
            {
...
bool AVIFile::getMetaDataSize ( void )
{
  ...
  avi_uint32 pUserData = (avi_uint32)this;
