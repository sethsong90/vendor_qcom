...
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/AMRWBParserLib/main/latest/src/amrwbfile.cpp#34 $
$DateTime: 2013/04/04 20:01:20 $
$Change: 3576040 $
                           ...
                           uint32 ulUserData )
{
  if(ulUserData)
  {
    AMRWBFile *pAMRWBFile = (AMRWBFile *)ulUserData;
    uint32 ulReadData = 0;
    ulReadData = \
      pAMRWBFile->FileGetData(ullOffset, ulNumBytesRequest, ulMaxSize, pucData);
    return (ulReadData);
  }
  MM_MSG_PRIO(
    MM_FILE_OPS,
    MM_PRIO_FATAL,
    "AMRWBCallbakGetData ullUserData is NULL");
  return 0;
}
...
bool AMRWBFile::ParseAMRWBHeader()
{
  ...
  m_pamrwbParser = MM_New_Args(amrwbParser,((uint32)this,m_fileSize,m_AMRWBFilePtr));
                                               ...
                                               uint32 &rulIndex)
{
  ...
  amrwb_audio_info samrwb_audio_info;
...
/* ======================================================================
  ...
  SIDE EFFECTS:
    None.
======================================================================*/
uint64 AMRWBFile::resetPlayback(  uint64 repos_time, uint32 id, bool bSetToSyncSample,
...
/* ======================================================================
  ...
  SIDE EFFECTS:
    None.
======================================================================*/
uint32 AMRWBFile::getMovieTimescale() const
{
  uint32 uTime = 0;

  if(m_pamrwbParser)
  {
    uTime = AMRWB_STREAM_TIME_SCALE;
  }
...
/* ======================================================================
  FUNCTION:
    AMRWBFile::getTrackMediaDuration
  ...
  SIDE EFFECTS:
    None.
======================================================================*/
uint64 AMRWBFile::getTrackMediaDuration(uint32 id)
{
  uint64 nTrackDuration = 0;

  if(m_pamrwbParser)
  {
    nTrackDuration = m_pamrwbParser->GetClipDurationInMsec();
  }
...
/* ======================================================================
  FUNCTION:
    AMRWBFile::getTrackMediaTimescale
  ...
  SIDE EFFECTS:
    None.
======================================================================*/
uint32 AMRWBFile::getTrackMediaTimescale(uint32 id)
{
...
/* ======================================================================
  ...
  SIDE EFFECTS:
    None.
======================================================================*/
unsigned long AMRWBFile::GetNumAudioChannels(int id)
{
