...
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/AMRWBParserLib/main/latest/src/amrwbparser.cpp#26 $
...
amrwbParser::amrwbParser(uint32 pUData,
                         uint64 fsize,
                         OSCL_FILE *FilePtr)
{
  m_pUserData = pUData;
                                             ...
                                             amrwb_header_type &header) const
{
  PARSER_ERRORTYPE eStatus = PARSER_ErrorNone;
  // Get the frame type
  header.frame_type = (frame & AUDIO_AMRWB_FS::FRAME_TYPE_MASK)
