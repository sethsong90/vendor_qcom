...
*/
typedef struct {
  uint32 rows;       /* number of rows in the table       */
  uint32 columns;    /* number of columns in the table    */
...
typedef struct {
  ...
  uint32  syntax_pos;   /* current position in syntax string               */
  uint32  syntax_end;   /* end marker for current scope in syntax          */
