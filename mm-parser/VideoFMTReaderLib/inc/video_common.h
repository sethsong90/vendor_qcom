...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/VideoFMTReaderLib/main/latest/inc/video_common.h#17 $
...
typedef enum {
  ...
  VIDEO_FMT_STREAM_AUDIO_EC3,            /* EC3 codec (ETSI TS 102 366)    */
