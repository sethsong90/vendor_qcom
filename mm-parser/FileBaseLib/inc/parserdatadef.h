...
/* =======================================================================
                             Edit History
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/FileBaseLib/main/latest/inc/parserdatadef.h#52 $$
...
static const unsigned long AAC_SAMPLING_FREQUENCY_TABLE [] = {
...
typedef enum
{
  ...
  MP3_VER_UNKNOWN        /* Unable to determine version information       */
}mp3_ver_enum_type;
...
typedef enum
{
  ...
  MP3_LAYER_UNKNOWN        /* Unable to determine layer information       */
}mp3_layer_enum_type;
