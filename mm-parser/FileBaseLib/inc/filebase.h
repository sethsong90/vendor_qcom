...
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/FileBaseLib/main/latest/inc/filebase.h#128 $
...
void copyByteSwapData(uint8 *pucDstBuf, uint32 uSize, uint8 *pucSrcBuf,
                      boolean byteSwap, uint32 uAmount);
...
======================================================================*/
  ...
  */
  ...
  virtual bool             isMetaDatainUTF8() {return false;};
  ...
  */
  ...
  virtual uint32 GetNumAudioChannels(int) {return 0;};
...
virtual unsigned long GetAudioBitsPerSample(int) {return 0;};
  ...
  virtual bool GetFlacCodecData(int id,flac_format_data* pData){return false;}
