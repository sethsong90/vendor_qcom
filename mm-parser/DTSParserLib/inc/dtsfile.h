...
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/DTSParserLib/main/latest/inc/dtsfile.h#5 $
...
public:
  ...
  virtual unsigned long GetNumAudioChannels(int);
  ...
  virtual uint8  getTrackOTIType(uint32 id) {return m_OTIType;};
