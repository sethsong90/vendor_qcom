...
/* =======================================================================
                             PERFORCE HEADER
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/MKAVParserLib/main/latest/inc/mkavparserdatadefn.h#26 $
========================================================================== */
/*
*******************************************************************
* Data types
...
typedef struct _block_info_t
{
  ...
  uint64 nDataOffset;
  uint8  nFrames;
  uint32 nFramesParsed;
  uint32 *pFramesSize;
}blockinfo;

typedef struct _block_group_t
{
  uint64     nBlockDuration;
  int64      nRefBlock;
  blockinfo* pBlockInfo;
  uint32     nBlockinfo;
  uint32     nBlocksParsed;
  uint64     nBlockEndOffset;
}blockgroup_info;
