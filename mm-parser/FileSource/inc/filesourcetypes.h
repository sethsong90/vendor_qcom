...
/* =======================================================================
                             Edit History
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/FileSource/main/latest/inc/filesourcetypes.h#105 $$
...
/*!
*@brief Enumeration to identify configuratiom item
*/
typedef enum
{
  //!Get/Set basetime.
