...
/* =======================================================================
                             PERFORCE HEADER
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/MP3ParserLib/main/latest/inc/mp3parser.h#29 $
========================================================================== */
#include <stdio.h>
#include <stdlib.h>
...
extern uint32 MP3CallbakGetData (uint64         nOffset,
...
public:
                         mp3Parser(uint32,uint64,OSCL_FILE*,
...
private:
  ...
  uint64 calc_frame_time (const struct tech_data_mp3 &header_info) const;
