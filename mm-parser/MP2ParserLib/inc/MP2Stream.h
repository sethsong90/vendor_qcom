...
public:
  ...
  virtual bool resetMediaPlayback(uint32)  {return false;}
  ...
  virtual FILESOURCE_STRING getTitle() const{return 0;}
  virtual FILESOURCE_STRING getAuthor() const{return 0;}
  virtual FILESOURCE_STRING getDescription() const{return 0;}
  virtual FILESOURCE_STRING getRating() const{return 0;}
  virtual FILESOURCE_STRING getCopyright() const{return 0;}
  virtual FILESOURCE_STRING getVersion() const{return 0;}
  virtual FILESOURCE_STRING getCreationDate() const{return 0;}

  virtual FILESOURCE_STRING getPerf()const{return 0;}; //not available.
  virtual FILESOURCE_STRING getGenre()const{return 0;};//not available.
  virtual FILESOURCE_STRING getClsf()const{return 0;};//not available.
  virtual FILESOURCE_STRING getKywd()const{return 0;};//not available.
  virtual FILESOURCE_STRING getLoci()const{return 0;};//not available.
  ...
  virtual int16 getTrackContentVersion(uint32 id){return 0;}
  virtual uint8 trackRandomAccessDenied(uint32 id){return 0;}
  ...
  virtual unsigned long GetAudioBitsPerSample(int id){return 0;}
  virtual unsigned long GetNumAudioChannels(int id);
  virtual unsigned long GetAudioEncoderOptions(int id){return 0;}

  // this returns Sequence (VOL) Header and its size //
  virtual uint8 *getTrackDecoderSpecificInfoContent(uint32 id){return 0;}
  virtual uint32 getTrackDecoderSpecificInfoSize(uint32 id){return 0;}
  ...
  virtual bool SetTimeStampedSample(uint32 id, uint64 TimeStamp,
                                    uint64 *newTimeStamp, boolean isRewind)
                                    {return 0;}

  virtual uint64 getFileSize(){return m_fileSize;}

  virtual void getCodecName(char *codecName,uint32 bufLen,uint32 trackId){}
  ...
  virtual uint32        GetMaximumBitRateForTrack(uint32 trackId){return 0;}
