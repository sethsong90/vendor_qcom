...
/* =======================================================================
                             PERFORCE HEADER
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/OGGParserLib/main/latest/inc/OGGStreamParserConstants.h#9 $
========================================================================== */
...
*/
typedef enum _OGG_METADATAINDEX
{
  TAG_OGG_TITLE,
  TAG_OGG_VERSION,
  TAG_OGG_ALBUM,
...
unsigned char const OGGFieldNames[MAX_FIELDNAMES_SUPPORTED][13] =
{
  "TITLE",
  "VERSION",
  "ALBUM",
