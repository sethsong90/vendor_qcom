...
$Header: //source/qcom/qct/multimedia2/Video/Source/FileDemux/OGGParserLib/main/latest/inc/OGGStreamParser.h#17 $
========================================================================== */
...
class OGGStreamParser
{
  ...
  * ======================================================================*/
   ...
   */
   ...
   uint32               GetTrackMinBitRate(uint32);
   uint32               GetTrackMaxBitRate(uint32);
