...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/wms/main/latest/src/wireless_messaging_service_v01.c#21 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t wms_set_smsc_address_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_set_smsc_address_req_msg_v01, smsc_address_type) - QMI_IDL_OFFSET8(wms_set_smsc_address_req_msg_v01, smsc_address_type_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
...
static const qmi_idl_service_message_table_entry wms_service_command_messages_v01[] = {
  ...
  {QMI_WMS_SET_SMSC_ADDRESS_REQ_V01, QMI_IDL_TYPE16(0, 25), 30},
