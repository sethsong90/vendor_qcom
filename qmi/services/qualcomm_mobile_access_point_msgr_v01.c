...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/qcmap_msgr/main/latest/src/qualcomm_mobile_access_point_msgr_v01.c#20 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.4 
   ...
   It was generated on: Thu Sep  5 2013 (Spin 0)
...
static const qmi_idl_service_message_table_entry qcmap_msgr_service_command_messages_v01[] = {
  ...
  {QMI_QCMAP_MSGR_USB_LINK_UP_REQ_V01, QMI_IDL_TYPE16(0, 109), 14},
  {QMI_QCMAP_MSGR_USB_LINK_DOWN_REQ_V01, QMI_IDL_TYPE16(0, 111), 14},
  ...
  {QMI_QCMAP_MSGR_SET_WWAN_POLICY_REQ_V01, QMI_IDL_TYPE16(0, 113), 26},
  {QMI_QCMAP_MSGR_GET_WWAN_POLICY_REQ_V01, QMI_IDL_TYPE16(0, 115), 0},
  {QMI_QCMAP_MSGR_GET_IPV6_STATE_REQ_V01, QMI_IDL_TYPE16(0, 14), 0},
  {QMI_QCMAP_MSGR_ENABLE_UPNP_REQ_V01, QMI_IDL_TYPE16(0, 117), 0},
  {QMI_QCMAP_MSGR_DISABLE_UPNP_REQ_V01, QMI_IDL_TYPE16(0, 119), 0},
  {QMI_QCMAP_MSGR_ENABLE_DLNA_REQ_V01, QMI_IDL_TYPE16(0, 121), 0},
  {QMI_QCMAP_MSGR_DISABLE_DLNA_REQ_V01, QMI_IDL_TYPE16(0, 123), 0},
  {QMI_QCMAP_MSGR_SET_FIREWALL_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 125), 15},
  {QMI_QCMAP_MSGR_GET_FIREWALL_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 127), 7},
  {QMI_QCMAP_MSGR_ENABLE_MULTICAST_DNS_RESPONDER_REQ_V01, QMI_IDL_TYPE16(0, 129), 0},
  {QMI_QCMAP_MSGR_DISABLE_MULTICAST_DNS_RESPONDER_REQ_V01, QMI_IDL_TYPE16(0, 131), 0},
  {QMI_QCMAP_MSGR_GET_UPNP_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 133), 0},
  {QMI_QCMAP_MSGR_GET_DLNA_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 135), 0},
  {QMI_QCMAP_MSGR_GET_MULTICAST_DNS_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 137), 0},
  ...
  {QMI_QCMAP_MSGR_SET_QCMAP_BOOTUP_CFG_REQ_V01, QMI_IDL_TYPE16(0, 139), 14},
  {QMI_QCMAP_MSGR_GET_QCMAP_BOOTUP_CFG_REQ_V01, QMI_IDL_TYPE16(0, 141), 0},
  {QMI_QCMAP_MSGR_SET_DLNA_MEDIA_DIR_REQ_V01, QMI_IDL_TYPE16(0, 143), 505},
  {QMI_QCMAP_MSGR_GET_DLNA_MEDIA_DIR_REQ_V01, QMI_IDL_TYPE16(0, 145), 0},
  ...
  {QMI_QCMAP_MSGR_GET_DATA_BITRATE_REQ_V01, QMI_IDL_TYPE16(0, 147), 7},
  {QMI_QCMAP_MSGR_GET_UPNP_NOTIFY_INTERVAL_REQ_V01, QMI_IDL_TYPE16(0, 149), 0},
  {QMI_QCMAP_MSGR_SET_UPNP_NOTIFY_INTERVAL_REQ_V01, QMI_IDL_TYPE16(0, 151), 7},
  {QMI_QCMAP_MSGR_GET_DLNA_NOTIFY_INTERVAL_REQ_V01, QMI_IDL_TYPE16(0, 153), 0},
  {QMI_QCMAP_MSGR_SET_DLNA_NOTIFY_INTERVAL_REQ_V01, QMI_IDL_TYPE16(0, 155), 7},
  {QMI_QCMAP_MSGR_ADD_DHCP_RESERVATION_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 157), 121},
  {QMI_QCMAP_MSGR_GET_DHCP_RESERVATION_RECORDS_REQ_V01, QMI_IDL_TYPE16(0, 159), 7},
  {QMI_QCMAP_MSGR_EDIT_DHCP_RESERVATION_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 161), 128},
  {QMI_QCMAP_MSGR_DELETE_DHCP_RESERVATION_RECORD_REQ_V01, QMI_IDL_TYPE16(0, 163), 14},
  {QMI_QCMAP_MSGR_ACTIVATE_HOSTAPD_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 165), 21},
  {QMI_QCMAP_MSGR_ACTIVATE_SUPPLICANT_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 167), 7},
...
static const qmi_idl_service_message_table_entry qcmap_msgr_service_response_messages_v01[] = {
  ...
  {QMI_QCMAP_MSGR_USB_LINK_UP_RESP_V01, QMI_IDL_TYPE16(0, 110), 7},
  {QMI_QCMAP_MSGR_USB_LINK_DOWN_RESP_V01, QMI_IDL_TYPE16(0, 112), 7},
  ...
  {QMI_QCMAP_MSGR_SET_WWAN_POLICY_RESP_V01, QMI_IDL_TYPE16(0, 114), 7},
  {QMI_QCMAP_MSGR_GET_WWAN_POLICY_RESP_V01, QMI_IDL_TYPE16(0, 116), 26},
  {QMI_QCMAP_MSGR_GET_IPV6_STATE_RESP_V01, QMI_IDL_TYPE16(0, 15), 11},
  {QMI_QCMAP_MSGR_ENABLE_UPNP_RESP_V01, QMI_IDL_TYPE16(0, 118), 7},
  {QMI_QCMAP_MSGR_DISABLE_UPNP_RESP_V01, QMI_IDL_TYPE16(0, 120), 7},
  {QMI_QCMAP_MSGR_ENABLE_DLNA_RESP_V01, QMI_IDL_TYPE16(0, 122), 7},
  {QMI_QCMAP_MSGR_DISABLE_DLNA_RESP_V01, QMI_IDL_TYPE16(0, 124), 7},
  {QMI_QCMAP_MSGR_SET_FIREWALL_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 126), 7},
  {QMI_QCMAP_MSGR_GET_FIREWALL_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 128), 15},
  {QMI_QCMAP_MSGR_ENABLE_MULTICAST_DNS_RESPONDER_RESP_V01, QMI_IDL_TYPE16(0, 130), 7},
  {QMI_QCMAP_MSGR_DISABLE_MULTICAST_DNS_RESPONDER_RESP_V01, QMI_IDL_TYPE16(0, 132), 7},
  {QMI_QCMAP_MSGR_GET_UPNP_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 134), 14},
  {QMI_QCMAP_MSGR_GET_DLNA_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 136), 14},
  {QMI_QCMAP_MSGR_GET_MULTICAST_DNS_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 138), 14},
  ...
  {QMI_QCMAP_MSGR_SET_QCMAP_BOOTUP_CFG_RESP_V01, QMI_IDL_TYPE16(0, 140), 7},
  {QMI_QCMAP_MSGR_GET_QCMAP_BOOTUP_CFG_RESP_V01, QMI_IDL_TYPE16(0, 142), 21},
  {QMI_QCMAP_MSGR_SET_DLNA_MEDIA_DIR_RESP_V01, QMI_IDL_TYPE16(0, 144), 7},
  {QMI_QCMAP_MSGR_GET_DLNA_MEDIA_DIR_RESP_V01, QMI_IDL_TYPE16(0, 146), 512},
  ...
  {QMI_QCMAP_MSGR_GET_DATA_BITRATE_RESP_V01, QMI_IDL_TYPE16(0, 148), 42},
  {QMI_QCMAP_MSGR_GET_UPNP_NOTIFY_INTERVAL_RESP_V01, QMI_IDL_TYPE16(0, 150), 14},
  {QMI_QCMAP_MSGR_SET_UPNP_NOTIFY_INTERVAL_RESP_V01, QMI_IDL_TYPE16(0, 152), 7},
  {QMI_QCMAP_MSGR_GET_DLNA_NOTIFY_INTERVAL_RESP_V01, QMI_IDL_TYPE16(0, 154), 14},
  {QMI_QCMAP_MSGR_SET_DLNA_NOTIFY_INTERVAL_RESP_V01, QMI_IDL_TYPE16(0, 156), 7},
  {QMI_QCMAP_MSGR_ADD_DHCP_RESERVATION_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 158), 7},
  {QMI_QCMAP_MSGR_GET_DHCP_RESERVATION_RECORDS_RESP_V01, QMI_IDL_TYPE16(0, 160), 2231},
  {QMI_QCMAP_MSGR_EDIT_DHCP_RESERVATION_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 162), 7},
  {QMI_QCMAP_MSGR_DELETE_DHCP_RESERVATION_RECORD_RESP_V01, QMI_IDL_TYPE16(0, 164), 7},
  {QMI_QCMAP_MSGR_ACTIVATE_HOSTAPD_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 166), 7},
  {QMI_QCMAP_MSGR_ACTIVATE_SUPPLICANT_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 168), 7},
