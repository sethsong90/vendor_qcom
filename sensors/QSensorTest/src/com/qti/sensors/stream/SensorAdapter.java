...
public class SensorAdapter extends QSensor {
  ...
  public String title() {
    ...
    if(this.sensor().getType() == Sensor.TYPE_GRAVITY ||
        this.sensor().getType() == Sensor.TYPE_LINEAR_ACCELERATION ||
        this.sensor().getType() == Sensor.TYPE_ROTATION_VECTOR)
      return SensorAdapter.sensorTypeString(this.sensor()) + ": " + this.sensor().getVendor();
    else
      return SensorAdapter.sensorTypeString(this.sensor()) + ": " + this.sensor().getName();
  }
