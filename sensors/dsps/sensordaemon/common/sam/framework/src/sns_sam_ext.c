...
*/
/*=======================================================================*/
void sns_sam_process_single_sensor_info_response(
   void* respMsgPtr,
   sns_sam_sensor_info_s sensorInfo[])
{
   ...
   if (msgPtr->Resp.sns_result_t == SNS_SUCCESS)
   {
      for( j = 0; j < msgPtr->SensorInfo.data_type_info_len; j++ )
      {
         ...
         if( i != -1 )
         {
            sensorInfo[i].maxPower = FX_CONV_Q16(msgPtr->SensorInfo.data_type_info[j].MaxPower, 0);
...
*/
/*=======================================================================*/
sns_err_code_e sns_sam_send_single_sensor_info_req(
   uint8_t sensorId)
{
   sns_smr_header_s msgHdr;
...
*/
/*=======================================================================*/
void sns_sam_get_all_sensor_attributes(
