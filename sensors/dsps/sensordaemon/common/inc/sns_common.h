...
#define SNS_MODULE_APPS_SAM       (SNS_MODULE_APPS + 01)    /* Sensor Algorithm Manager */
...
sns_rtb_s sns_rtb[] = {
    ...
    { SNS_REG_SVC_ID_V01,                 SNS_MODULE_APPS_REG,  SNS_GET_SVC_OBJ(REG, 01),                     NULL }, /* 3 - DEPRECATED */
    ...
    { SNS_SAM_CMC_SVC_ID_V01,             SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_CMC, 01),                 NULL }, /* 41 */
