...
/* Init functions for DSPS test builds */
#  define SNS_INIT_FUNCTIONS   \
  {   sns_memmgr_init,         \
      ...
      sns_pm_init,             \
#endif /* FEATURE_MSM8960 */
      sns_init_tests,          \
      NULL }
#elif defined(SNS_DSPS) || defined(SNS_DSPS_BUILD)
/* Init functions for DSPS */
#ifdef FEATURE_MSM8960
#  define SNS_INIT_FUNCTIONS   \
  {   sns_memmgr_init,         \
      sns_init_dsps,           \
...
#  define SNS_INIT_FUNCTIONS                          \
  { { sns_memmgr_init, "sns_memmgr_init" },           \
    ...
    { sns_smr_init, "sns_smr_init" },                 \
    { sns_reg_init, "sns_reg_init" },                 \
    { sns_smgr_init, "sns_smgr_init" },               \
    { sns_sam_init, "sns_sam_init" },                 \
    { sns_time_init, "sns_time_init" },               \
    { sns_debug_test_init2, "sns_debug_test_init2" }, \
    { sns_acm_init, "sns_acm_init" },                 \
    { sns_playback_init, "sns_playback_init" },       \
    {  NULL, ""} }
#else
#  define SNS_INIT_FUNCTIONS                          \
  { { sns_memmgr_init, "sns_memmgr_init" },           \
    ...
    {  NULL, ""} }
#endif
#endif /* defined(SNS_PCSIM) || defined(SNS_DSPS) */
/*============================================================================
  Type Declarations
  ============================================================================*/
...
/*!
  ...
  i.e a new task for power measurement purposes.
