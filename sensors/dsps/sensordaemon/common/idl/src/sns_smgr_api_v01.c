...
static const uint8_t sns_smgr_single_sensor_info_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, num_buffered_reports) - QMI_IDL_OFFSET16RELATIVE(sns_smgr_single_sensor_info_resp_msg_v01, num_buffered_reports_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
...
/* Type Table */
static const qmi_idl_type_table_entry  SNS_SMGR_SVC_type_table_v01[] = {
...
{&SNS_SMGR_SVC_qmi_idl_type_table_object_v01, &sns_common_qmi_idl_type_table_object_v01};

/*Type Table Object*/
static const qmi_idl_type_table_object SNS_SMGR_SVC_qmi_idl_type_table_object_v01 = {
  sizeof(SNS_SMGR_SVC_type_table_v01)/sizeof(qmi_idl_type_table_entry ),
  sizeof(SNS_SMGR_SVC_message_table_v01)/sizeof(qmi_idl_message_table_entry),
  1,
  SNS_SMGR_SVC_type_table_v01,
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_command_messages_v01[] = {
  ...
  {SNS_SMGR_BUFFERING_QUERY_REQ_V01, QMI_IDL_TYPE16(0, 25), 28}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_response_messages_v01[] = {
  ...
  {SNS_SMGR_SINGLE_SENSOR_INFO_RESP_V01, QMI_IDL_TYPE16(0, 8), 391},
  ...
  {SNS_SMGR_BUFFERING_QUERY_RESP_V01, QMI_IDL_TYPE16(0, 26), 14}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_indication_messages_v01[] = {
  ...
  {SNS_SMGR_BUFFERING_IND_V01, QMI_IDL_TYPE16(0, 24), 1676},
  {SNS_SMGR_BUFFERING_QUERY_IND_V01, QMI_IDL_TYPE16(0, 27), 1623}
};
