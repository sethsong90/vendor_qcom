...
static const qmi_idl_service_message_table_entry SNS_DIAG_DSPS_SVC_service_command_messages_v01[] = {
  ...
  {SNS_DIAG_SET_LOG_MASK_REQ_V01, QMI_IDL_TYPE16(0, 0), 22},
  {SNS_DIAG_SET_DEBUG_MASK_REQ_V01, QMI_IDL_TYPE16(0, 2), 11}
};
...
static const qmi_idl_service_message_table_entry SNS_DIAG_DSPS_SVC_service_response_messages_v01[] = {
  ...
  {SNS_DIAG_SET_LOG_MASK_RESP_V01, QMI_IDL_TYPE16(0, 1), 5},
  {SNS_DIAG_SET_DEBUG_MASK_RESP_V01, QMI_IDL_TYPE16(0, 3), 5}
};
