...
static const qmi_idl_service_message_table_entry SNS_SAM_MAG_CAL_SVC_service_command_messages_v01[] = {
  {SNS_SAM_MAG_CAL_CANCEL_REQ_V01, TYPE16(1, 0), 0},
  {SNS_SAM_MAG_CAL_VERSION_REQ_V01, TYPE16(1, 2), 0},
  {SNS_SAM_MAG_CAL_ENABLE_REQ_V01, TYPE16(0, 0), 14},
  {SNS_SAM_MAG_CAL_DISABLE_REQ_V01, TYPE16(0, 2), 4},
  {SNS_SAM_MAG_CAL_GET_REPORT_REQ_V01, TYPE16(0, 5), 4}
};

static const qmi_idl_service_message_table_entry SNS_SAM_MAG_CAL_SVC_service_response_messages_v01[] = {
  {SNS_SAM_MAG_CAL_CANCEL_RESP_V01, TYPE16(1, 1), 5},
  {SNS_SAM_MAG_CAL_VERSION_RESP_V01, TYPE16(1, 3), 17},
  {SNS_SAM_MAG_CAL_ENABLE_RESP_V01, TYPE16(0, 1), 9},
  {SNS_SAM_MAG_CAL_DISABLE_RESP_V01, TYPE16(0, 3), 9},
  {SNS_SAM_MAG_CAL_GET_REPORT_RESP_V01, TYPE16(0, 6), 44}
};

static const qmi_idl_service_message_table_entry SNS_SAM_MAG_CAL_SVC_service_indication_messages_v01[] = {
  {SNS_SAM_MAG_CAL_REPORT_IND_V01, TYPE16(0, 4), 39},
  {SNS_SAM_MAG_CAL_ERROR_IND_V01, TYPE16(0, 7), 8}
};

/*Service Object*/
const struct qmi_idl_service_object SNS_SAM_MAG_CAL_SVC_qmi_idl_service_object_v01 = {
  0x04,
  0x01,
