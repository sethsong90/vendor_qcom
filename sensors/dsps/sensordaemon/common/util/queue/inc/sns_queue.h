...
$Header: //source/qcom/qct/core/pkg/dsps/dev/gulansey.gulansey_common_smr/adsp_proc/Sensors/common/util/queue/inc/sns_queue.h#1 $ $DateTime: 2013/01/25 10:55:20 $ $Author: coresvc $
   
when       who    what, where, why
--------   ---    ----------------------------------------------------------
2012-04-09 sc     Removed FEATURE_Q_NO_SELF_QPTR macro.
2011-04-20 br     deleted the definition FEATURE_Q_NO_SELF_QPTR, and fixed because of the deletion
2010-07-06 br     Branch from //source/qcom/qct/core/services/utils/main/latest/inc/queue.h#2.
...
===========================================================================*/
void* sns_q_check (sns_q_s  *q_ptr);
...
===========================================================================*/
void* sns_q_last_check ( sns_q_s *q_ptr );
...
===========================================================================*/
void* sns_q_next  ( sns_q_s *q_ptr, sns_q_link_s *link_ptr );
