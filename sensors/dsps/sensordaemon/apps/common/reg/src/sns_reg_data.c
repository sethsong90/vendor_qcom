...
const sns_reg_item_info_s sns_reg_item_info[] =
{
  ...
  /* Max offset for this group should be (MAX_GROUP_SIZE * 51) - 1 */
};
...
const sns_reg_group_info_s sns_reg_group_info[] =
{
  ...
  { 12,                                   (MAX_GROUP_SIZE * 31),     SNS_REG_GROUP_SSI_GPIO_CFG_V02             },
  ...
  { 32,                                   (MAX_GROUP_SIZE * 36),     SNS_REG_SAM_GROUP_DISTANCE_BOUND_V02       },
