...
/*============================================================================
  ...
  $Header: //source/qcom/qct/core/sensors/dsps/apps/la/main/latest/sensordaemon/init/src/sns_init_la.c#8 $
  $DateTime: 2011/09/07 12:48:32 $

  when       who    what, where, why
  ---------- --- -----------------------------------------------------------
  2011-12-05 jtl Don't call smr_close on signals. File will get closed when
                 the process exits.
  2011-08-19 gju Fixed wrong variable use in sns_init_send_tid_to_debugger
  2011-08-12 jtl Reboot DSPS on SIGHUP
  2011-07-27 sc  Fixed compilation error on LA_SIM
  2011-07-14 jtl Calling debugger thread on crashes to generate logcat traces.
  2011-06-21 sc  Define log macros in LA_SIM
  2011-05-17 jtl Returning an error and stopping init if any error occurs.
  2011-05-03 jtl Adding debug message in signal handler
  2010-12-03 jtl Removing DSPS boot from here, and moving to sns_pwr.c
  2010-10-28 sj  Change module id from SMR module id to debug module id
  2010-10-22 jtl Calling sns_smr_close() on process exit
  2010-10-15 jtl Opening /dev/dsps when the process starts.
                 Fixing signal handling so LA process exits.
  2010-10-07 jtl Using proper debug printf functions
  2010-09-08 jtl Added signal handling for task exit processing.
  2010-08-25 jtl Initial revision
...
#include "sns_osa.h"
#include "sns_pwr.h"
#include "sns_smr.h" /* For sns_smr_close */
