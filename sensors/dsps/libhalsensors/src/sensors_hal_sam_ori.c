/*============================================================================
  @file sensors_hal_sam_ori.c

  @brief
  File handles all requests to the SAM Orientation Algorithm.
...
#define SVC_NUM SNS_SAM_ORIENTATION_SVC_ID_V01
...
/*===========================================================================
  FUNCTION:  hal_sam_ori_send_enable
===========================================================================*/
static int
hal_sam_ori_send_enable( hal_sensor_control_t* sensor_ctl, uint32_t report_rate )
{
...
/*===========================================================================
  FUNCTION:  hal_sam_ori_send_batch
===========================================================================*/
static int
hal_sam_ori_send_batch( hal_sensor_control_t* sensor_ctl,
...
/*===========================================================================
  FUNCTION:  hal_sam_ori_send_batch_update
===========================================================================*/
static int
hal_sam_ori_send_batch_update( hal_sensor_control_t* sensor_ctl, uint32_t batch_rate )
{
  sensor1_error_e  error;
  sensor1_msg_header_s req_hdr;
  sns_sam_orient_update_batch_period_req_msg_v01 *sam_req;
  float batch_rate_in_hz;
  ...
  /* Message Body */
  error = sensor1_alloc_msg_buf( sensor_ctl->hndl,
                                 sizeof(sns_sam_orient_update_batch_period_req_msg_v01),
                                 (void**)&sam_req );
  ...
  req_hdr.service_number = SVC_NUM;
  req_hdr.msg_id = SNS_SAM_ORIENT_UPDATE_BATCH_PERIOD_REQ_V01;
  req_hdr.msg_size = sizeof( sns_sam_orient_update_batch_period_req_msg_v01 );
  req_hdr.txn_id = TXN_ID_NO_RESP_SIGNALLED;
...
/*===========================================================================
  FUNCTION:  hal_sam_ori_get_report
===========================================================================*/
static int
hal_sam_ori_get_report( hal_sensor_control_t* sensor_ctl )
{
  return -1;
}
...
/*===========================================================================
  FUNCTION:  hal_sam_ori_parse_ind
===========================================================================*/
hal_sam_sample_t*
hal_sam_ori_parse_ind( sensor1_msg_header_s *msg_hdr, void *msg_ptr, int *count )
{
...
/*===========================================================================
  FUNCTION:  hal_sam_ori_init
===========================================================================*/
void hal_sam_ori_init( hal_sam_sensor_t *sam_sensor )
{
  sam_sensor->curr_report_rate = 0;
}

/*===========================================================================
  FUNCTION:  hal_sam_ori_info
===========================================================================*/
int
hal_sam_ori_info( hal_sam_sensor_t *sam_sensor )
{
  sam_sensor->enable_func = &hal_sam_ori_send_enable;
  sam_sensor->get_report_func = &hal_sam_ori_get_report;
  sam_sensor->batch_func = &hal_sam_ori_send_batch;
  sam_sensor->batch_update_func = &hal_sam_ori_send_batch_update;
  sam_sensor->parse_ind_func = &hal_sam_ori_parse_ind;
  sam_sensor->init_func = &hal_sam_ori_init;
  sam_sensor->svc_num = SVC_NUM;
  strlcpy( sam_sensor->algo_name, "ori", HAL_SAM_NAME_MAX_LEN - 1 );
