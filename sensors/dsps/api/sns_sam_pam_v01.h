...
#define SNS_SAM_PAM_SVC_V01_IDL_MINOR_VERS 0x04
...
typedef enum {
  ...
  SNS_SAM_PAM_DEV_STATE_UNKNOWN_V01 = -2, 
  SNS_SAM_PAM_DEV_STATE_STATIONARY_V01 = -1, 
  SNS_SAM_PAM_DEV_STATE_MOTION_V01 = 0, 
