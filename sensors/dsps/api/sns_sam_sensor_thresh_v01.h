...
#define SNS_SAM_SENSOR_THRESH_SVC_V01_IDL_MINOR_VERS 0x05
...
typedef enum {
  ...
  SNS_SAM_SENSOR_ABSOLUTE_THRESHOLD_V01 = 0, 
  SNS_SAM_SENSOR_RELATIVE_THRESHOLD_V01 = 1, 
...
typedef struct {
  ...
  */
  ...
  /**<   threshold type as specified by enum threshold_type_e*/
