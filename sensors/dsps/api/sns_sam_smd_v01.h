...
#define SNS_SAM_SMD_SVC_V01_IDL_MINOR_VERS 0x01
...
typedef enum {
  ...
  SNS_SAM_SMD_STATE_UNKNOWN_V01 = 0, 
  SNS_SAM_SMD_STATE_NO_MOTION_V01 = 1, 
  SNS_SAM_SMD_STATE_MOTION_V01 = 2, 
...
typedef struct {
  ...
  */
  ...
  /**<  
    Probability of the reported motion state scaled to percentage (range 0 to 100).
  */
...
typedef struct {
  ...
  uint32_t timestamp;
  /**<   Timestamp of input with which latest state was detected; in SSC ticks  */
