...
#define SNS_SAM_BASIC_GESTURES_SVC_V01_IDL_MINOR_VERS 0x03
...
typedef enum {
  ...
  BASIC_GESTURE_PUSH_V01 = 1, /**<  Phone is jerked away from the user, in the direction perpendicular to the screen  */
  BASIC_GESTURE_PULL_V01 = 2, /**<  Phone is jerked toward  from the user, in the direction perpendicular to the screen  */
