...
#define SNS_SAM_ORIENTATION_SVC_V01_IDL_MINOR_VERS 0x05
...
/** @addtogroup SNS_SAM_ORIENTATION_SVC_qmi_messages
    @{
  */
/** Indication Message; Report containing Orientation algorithm output */
typedef struct {
...
/** @addtogroup SNS_SAM_ORIENTATION_SVC_qmi_messages
    @{
  */
/** Indication Message; Asynchronous error indication for a Orientation algorithm. */
typedef struct {
