...
{
   if ( os_kf_state == NULL || init_params == NULL)
   {
      return -1;
   }

   FilterDataStructType* tmp_os_kf_state = (FilterDataStructType*)calloc(1, sizeof(FilterDataStructType));
   if ( tmp_os_kf_state == NULL )
   {
      return -2;
   }

   tmp_os_kf_state->meas_noise_func = init_params->meas_noise_func;
   tmp_os_kf_state->proc_noise_func = init_params->proc_noise_func;
   tmp_os_kf_state->outlier_limit = init_params->outlier_limit;
   tmp_os_kf_state->n_var_thresh = init_params->n_var_thresh;
   tmp_os_kf_state->min_unc_to_init = init_params->min_unc_to_init;
   tmp_os_kf_state->diverge_threshold = init_params->diverge_threshold;
   tmp_os_kf_state->time_update_interval = init_params->time_update_interval;

   *os_kf_state = tmp_os_kf_state;
...
/*===========================================================================
  ...
  ===========================================================================*/
int os_kf_init_filter(void* os_kf_state, os_kf_meas* unfilt_meas, uint64_t t_TimeUpdate)
{
   if ( os_kf_state == NULL || unfilt_meas == NULL)
   {
      return -1;
   }

   FilterDataStructType* kf_state = (FilterDataStructType*)os_kf_state;
...
/*===========================================================================
  ...
  ===========================================================================*/
int os_kf_filter_update(void* os_kf_state, os_kf_meas* unfilt_meas, uint64_t t_TimeUpdate)
{
...
{
   if ( os_kf_state == NULL || filt_meas == NULL)
   {
      return -1;
   }
...
{
   if ( os_kf_state == NULL || filt_meas_unc == NULL)
   {
      return -1;
   }
