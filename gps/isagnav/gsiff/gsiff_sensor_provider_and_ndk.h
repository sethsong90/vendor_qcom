/******************************************************************************
  @file:  gsiff_sensor_provider_and_ndk.h
...
======================================================================*/
#ifndef __GSIFF_SENSOR_PROVIDER_ANDROID_NDK_H__
#define __GSIFF_SENSOR_PROVIDER_ANDROID_NDK_H__
...
DESCRIPTION
  Function updates the current running status of the barometer from sensor
  provider. If baro is already reporting sensor data and it is requested to
  start again, this function is a nop. If baro is already stopped and it is
  requested to stop this function is a nop.
...
#endif /* __GSIFF_SENSOR_PROVIDER_ANDROID_NDK_H__ */
