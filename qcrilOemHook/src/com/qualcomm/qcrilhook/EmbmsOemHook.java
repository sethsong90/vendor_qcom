 ...
 *
 * This is compatible with version 00.04.06 of the IDL.
 *
 * ---------------------------------------------------------------------------
...
public class EmbmsOemHook extends Handler{
    ...
    private void handleResponse(HashMap<Integer, Object> map) {
        ...
        switch (msgId) {
            ...
            case EMBMSHOOK_MSG_ID_UNSOL_STATE_CHANGE: {
                ...
                notifyUnsol(UNSOL_TYPE_STATE_CHANGE, info);
                break;
            }
            ...
            case EMBMSHOOK_MSG_ID_GET_AVAILABLE: {
                ...
                notifyUnsol(UNSOL_TYPE_AVAILABLE_TMGI_LIST, list);
                break;
            }
            ...
            case EMBMSHOOK_MSG_ID_GET_ACTIVE: {
                ...
                TmgiListIndication list = new TmgiListIndication(respByteBuf, msgId);
                notifyUnsol(UNSOL_TYPE_ACTIVE_TMGI_LIST, list);
                break;
            }
            ...
            case EMBMSHOOK_MSG_ID_GET_COVERAGE: {
                ...
                notifyUnsol(UNSOL_TYPE_BROADCAST_COVERAGE, cs);
                break;
            }
    ...
    public int activateTmgi(int traceId, byte callId, byte[] tmgi, int priority,
                            int[] saiList, int[] earfcnList, Message msg) {
    ...
    public int actDeactTmgi(int traceId, byte callId, byte[] actTmgi, byte[] deActTmgi,
                            int priority, int[] saiList, int[] earfcnList, Message msg) {
    ...
    public int getAvailableTMGIList(int traceId, byte callId) {
        ...
        try {
            mQmiOemHook.sendQmiMessageAsync(EMBMS_SERVICE_ID,
                                            ...
                                            req.getTypes(), req.getItems(), null);
        } catch (IOException e) {
                ...
                try {
                    ...
                    switch (type) {
                        case TLV_TYPE_UNSOL_AVAILABLE_IND_TMGI_ARRAY_OR_RESPONSE_CODE:
                            ...
                            //then this TLV represnts the response code.
                ...
                try {
                    ...
                    switch (type) {
                        ...
                        case TLV_TYPE_UNSOL_CELL_ID_IND_MNC:{
                            ...
                            Log.i(LOG_TAG, "MNC = " + mcc);
                            break;
                        }
                        case TLV_TYPE_UNSOL_CELL_ID_IND_CID:{
                            id = Integer.toHexString(buf.getInt());
    ...
    /**
     * Response class representing the async response to get the get time
     */
