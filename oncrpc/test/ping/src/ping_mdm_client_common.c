...
/*=====================================================================
  ...
  $Id: //linux/pkgs/proprietary/modem-api/main/source/test/oncrpc/ping/src/ping_mdm_client_common.c#4 $
...
/*===========================================================================
  FUNCTION  ping_mdm_client_common_data_test
===========================================================================*/
/*!
@brief
  Common data test
...
*/
/*=========================================================================*/
int ping_mdm_client_common_data_test(
  uint32 test_length,
  ...
  )
{
  ...
  else
  {
    ...
    if( errcnt == 0 )
    {
      ping_client_common_calc_stats_timespec(num_loops,data_size_words,1,&time_info_start,&time_info_end,results);
      results->rc = -errcnt;
    }
    else
    {
...
/*===========================================================================
  FUNCTION  ping_mdm_client_common_data_test_random
===========================================================================*/
/*!
@brief
...
*/
/*=========================================================================*/
int ping_mdm_client_common_data_test_random(
  uint32 test_duration_ms,
  boolean verbose,
  ping_client_results_type *results)
{
...
/*===========================================================================
  FUNCTION  ping_mdm_client_common_calc_stats
===========================================================================*/
/*!
@brief
...
*/
/*=========================================================================*/
void ping_mdm_client_common_calc_stats(
  uint32 num_loops,
  uint32 data_size_words,
