...
/*=====================================================================
  ...
  $Id: //linux/pkgs/proprietary/modem-api/main/source/test/oncrpc/ping/src/ping_mdm_client_test_0000.c#6 $
...
static int ping_test_main(int test_length, int data_size_words, int test_duration_ms)
{
  ...
  rc = ping_mdm_client_common_data_test(test_length,data_size_words,test_duration_ms,1,&results);
  if(rc == 0)
  {
    printf("Test Passed\n");
    printf("Performance: \n");
