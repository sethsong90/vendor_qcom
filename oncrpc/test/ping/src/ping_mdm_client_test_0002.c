...
/*=====================================================================
  ...
  $Id: //linux/pkgs/proprietary/modem-api/main/source/test/oncrpc/ping/src/ping_mdm_client_test_0002.c#6 $
...
static int ping_test_main(int test_duration_ms)
{
  ...
  rc = ping_mdm_client_common_data_test_random(test_duration_ms,1,&results);
    if(rc == 0)
    {
...
int main(int argc, char *argv[])
{
  ...
  printf("\n\n %s version %s\n",__FILE__,VersionStr);
  printf("Usage: %s test_duration_ms(500 msec) \n",argv[0]);
