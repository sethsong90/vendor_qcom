...
/*=====================================================================
     Forward Declaration
======================================================================*/
static int ping_lte_test_main( uint32 test_duration_ms,uint32 num_tasks);
...
static int ping_lte_test_main(uint32 test_duration_ms,uint32 num_tasks)
{
   ...
   printf("\n\n\nPING LTE CALLBACK TEST STARTED with %d tasks ...\n",(unsigned int)num_tasks);
...
int main(int argc, char *argv[])
{
   ...
   printf("Usage: ping_lte_clnt_test_1001 test_duration_ms(%d msec) num_tasks (%d) \n",(unsigned int)test_duration_ms,(unsigned int)num_tasks);
   oncrpc_init();
   oncrpc_task_start();
   ...
   rc = ping_lte_test_main(test_duration_ms,num_tasks);
   if( rc == 0 )
   {
      printf("PASS\n");
   }
