...
/*=====================================================================
  ...
  $Id: //linux/pkgs/proprietary/modem-api/main/source/test/oncrpc/ping/src/ping_lte_client_common.c#4 $
  ...
  )
{
  ...
  if( ( 0 == test_duration_ms ) && ( 0 == test_length ) )
  {
    ...
    while( 1 )
    {
      retsum = ping_lte_data(data,data_size_words);
      if( verbose )
      {
...
#ifndef FEATURE_PING_LTE_TIMER_BASED_TEST
...
{
  uint32 *data;
  uint32  max_data_size_words = PING_LTE_MAX_WORDS;
  uint32 data_size_words;
...
/*===========================================================================
  FUNCTION  ping_lte_client_common_calc_stats
===========================================================================*/
/*!
@brief
...
*/
/*=========================================================================*/
void ping_lte_client_common_calc_stats(
  uint32 num_loops,
  uint32 data_size_words,
