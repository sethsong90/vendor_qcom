...
/*=====================================================================
  ...
  $Id: //linux/pkgs/proprietary/modem-api/main/source/test/oncrpc/ping/src/ping_lte_client_test_0000.c#6 $
...
static int ping_test_main(int test_length, int data_size_words, int test_duration_ms)
{
  ...
  rc = ping_lte_client_common_data_test(test_length,data_size_words,test_duration_ms,1,&results);
    if(rc == 0)
    {
...
int main(int argc, char *argv[])
{
  ...
  printf("\n\n %s version %s\n",__FILE__,VersionStr);
  printf("Usage: ping_client_test_0000 test_duration_ms(2000 msec) data_size_words(1000) test_length(0) \n");
