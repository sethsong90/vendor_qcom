...
/*===========================================================================
  ...
  $Id: //linux/pkgs/proprietary/oncrpc/main/source/oncrpc/oncrpcxdr.h#3 $ 
...
extern boolean xdr_send_enum( xdr_s_type *xdr, int32 value );
extern boolean xdr_recv_enum( xdr_s_type *xdr, void *value, uint32 size );
...
extern boolean xdr_send_auth( xdr_s_type *xdr, const opaque_auth *auth );
extern boolean xdr_recv_auth( xdr_s_type *xdr,
                              opaque_auth *auth );
extern void    xdr_free_auth( opaque_auth *auth );

extern boolean xdr_call_msg_start( xdr_s_type *clnt,
                                   uint32 prog,
                                   uint32 ver,
                                   uint32 proc,
                                   opaque_auth *cred,
...
extern boolean xdr_reply_msg_start( xdr_s_type *srv, opaque_auth *verf );
...
extern bool_t oncrpc_xdr_enum( XDR *xdr, enum_t *ep, uint16 size );
extern bool_t oncrpc_xdr_array (XDR * xdrs, caddr_t *addrp, u_int *sizep,
			 u_int maxsize, u_int elsize, xdrproc_t elproc);
extern bool_t oncrpc_xdr_bytes( XDR *xdr, char **cpp, u_int *sizep, u_int maxsize );
extern bool_t oncrpc_xdr_opaque( XDR *xdr, caddr_t cp, u_int cnt );
extern bool_t oncrpc_xdr_string (XDR *xdr, char **cpp, u_int maxsize);
extern bool_t oncrpc_xdr_union (XDR *xdr, enum_t *dscmp, uint16 size, 
                         char *unp, const struct xdr_discrim *choices,
			 xdrproc_t dfault);
extern bool_t oncrpc_xdr_char (XDR *xdr, char *cp);
extern bool_t oncrpc_xdr_u_char (XDR *xdr, u_char *cp);
extern bool_t oncrpc_xdr_vector (XDR *xdrs, char *basep, u_int nelem,
			  u_int elemsize, xdrproc_t xdr_elem);
extern bool_t oncrpc_xdr_reference (XDR *xdrs, caddr_t *xpp, u_int size,
			     xdrproc_t proc);
extern bool_t oncrpc_xdr_pointer (XDR *xdrs, char **_objpp,
			   u_int obj_size, xdrproc_t xdr_obj);
extern bool_t oncrpc_xdr_wrapstring (XDR *xdr, char **cpp);
extern bool_t oncrpc_xdr_hyper (XDR *__xdrs, quad_t *__llp);
extern bool_t oncrpc_xdr_u_hyper (XDR *__xdrs, u_quad_t *__ullp);
extern bool_t oncrpc_xdr_int64_t (XDR *__xdrs, int64_t *__llp);
extern bool_t oncrpc_xdr_uint64_t (XDR *__xdrs, uint64_t *__ullp);
extern bool_t oncrpc_xdr_longlong_t (XDR *__xdrs, quad_t *__llp);
extern bool_t oncrpc_xdr_u_longlong_t (XDR *__xdrs, u_quad_t *__ullp);
extern bool_t oncrpc_xdr_quad_t (XDR *__xdrs, quad_t *__llp);
extern bool_t oncrpc_xdr_u_quad_t (XDR *__xdrs, u_quad_t *__ullp);
