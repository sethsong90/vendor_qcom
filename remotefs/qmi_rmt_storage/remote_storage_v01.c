...
static const qmi_idl_service_message_table_entry rmtfs_service_command_messages_v01[] = {
  {QMI_RMTFS_OPEN_REQ_V01, TYPE16(0, 0), 258},
  {QMI_RMTFS_CLOSE_REQ_V01, TYPE16(0, 2), 7},
  {QMI_RMTFS_RW_IOVEC_REQ_V01, TYPE16(0, 4), 3079},
  {QMI_RMTFS_ALLOC_BUFF_REQ_V01, TYPE16(0, 6), 14},
  {QMI_RMTFS_GET_DEV_ERROR_REQ_V01, TYPE16(0, 8), 7}
};

static const qmi_idl_service_message_table_entry rmtfs_service_response_messages_v01[] = {
  {QMI_RMTFS_OPEN_RESP_V01, TYPE16(0, 1), 14},
  {QMI_RMTFS_CLOSE_RESP_V01, TYPE16(0, 3), 7},
  {QMI_RMTFS_RW_IOVEC_RESP_V01, TYPE16(0, 5), 7},
  {QMI_RMTFS_ALLOC_BUFF_RESP_V01, TYPE16(0, 7), 18},
  {QMI_RMTFS_GET_DEV_ERROR_RESP_V01, TYPE16(0, 9), 11}
};

static const qmi_idl_service_message_table_entry rmtfs_service_indication_messages_v01[] = {
  {QMI_RMTFS_FORCE_SYNC_IND_V01, TYPE16(0, 10), 44}
};

/*Service Object*/
const struct qmi_idl_service_object rmtfs_qmi_idl_service_object_v01 = {
  02,
  01,
  14,
  3079,
