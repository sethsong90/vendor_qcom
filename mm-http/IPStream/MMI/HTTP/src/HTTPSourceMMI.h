...
private:
  ...
  OMX_U32 UseBuffer(void* pUserData);
  OMX_U32 EmptyThisBuffer(void* pUserData);
  ...
  OMX_U32 EnablePort(void* pUserData);
  OMX_U32 DisablePort(void* pUserData);
  ...
  void UpdateMp3AudioPort(OMX_U32 audioPortIndex,
                          OMX_AUDIO_PARAM_MP3TYPE* pMp3Param,
                          MediaTrackInfo &trackInfo);
  void UpdateQcelpAudioPort(OMX_U32 audioPortIndex,
  ...
  void UpdateWmvVideoPort(OMX_U32 videoPortIndex,
                          ...
                          MediaTrackInfo &trackInfo);
#endif
  void UpdatePcmAudioPort(OMX_U32 audioPortIndex,
                          OMX_AUDIO_PARAM_PCMMODETYPE* pPcmParam,
                          MediaTrackInfo &trackInfo);
  void UpdateEvrcAudioPort(OMX_U32 audioPortIndex,
  ...
  void GetQOEData(uint32& nRebufCount,char* pStopPhrase,int& nStopPhraseSize)
  {
