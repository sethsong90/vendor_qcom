...
#define MMI_HTTP_VIDEO_PORT_MAX_BUFFER_SIZE (MAX_RESOLUTION * 3/2)
...
public:
  ...
  virtual bool GetTrackMap(void *pTrackMapRecipient);
  virtual bool SetTrackState(const int32 trackIdentifier,
