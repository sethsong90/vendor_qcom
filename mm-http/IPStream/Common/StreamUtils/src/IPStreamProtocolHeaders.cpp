...
IPStreamProtocolHeaderResult IPStreamProtocolHeaders::EditIPStreamProtocolHeaders(
   ...
   uint32 whichMethodsAffected, // AffectedMethod, dc on delete
...
IPStreamProtocolHeaderResult IPStreamProtocolHeaders::addHeader(
   uint32 whichMethodsAffected, // AffectedMethod
...
========================================================================== */
int IPStreamProtocolHeaders::freeHeader(const uint32 whichMethodsAffected, const char *nameToFree)
{
...
SIDE EFFECTS
  NONE
========================================================================== */
int IPStreamProtocolHeaders::findHeaderEntry(const uint32 whichMethodsAffected, const char *nameToFind)
{
