...
public:
   ...
   */
  virtual bool GetBuffer(byte* &pBuf, int& nBufSize) = 0;
   ...
   */
  virtual int Read(int nOffset, byte* pBuf, int nBufSize) = 0;
...
public:
   ...
   * Get ptr to buffer to write to for the segment.
   */
  virtual bool GetBuffer(byte* &pBuf, int& nBufSize);
   ...
   * start of the segment.
   */
  virtual int Read(int nOffset, byte* pBuf, int nBufSize);
...
public:
   ...
   * Get ptr to buffer to write to for the segment.
   */
  bool GetBuffer(byte* &pBuf, int& nBufSize);
   ...
   * start of the segment.
   */
  int Read(int nOffset, byte* pBuf, int nBufSize);
