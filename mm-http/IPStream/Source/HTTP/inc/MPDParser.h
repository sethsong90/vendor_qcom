...
public:
  ...
  virtual bool GetRepresentationGrpByKey(uint64 key,RepresentationGroup&)=0;
  ...
  virtual HTTPDownloadStatus GetAllSegmentsForRepresentation(SegmentInfo*, uint32& numSegments,uint64 repKey)=0;
  ...
  virtual HTTPDownloadStatus GetLastAvailableSegmentForRepresentation(uint64 repKey,uint64& lastAvailableSegmentStartTime, uint64& lastAvailableSegmentEndTime)=0;
  ...
  virtual HTTPDownloadStatus GetSegmentStartTimeForPlayback(const uint64 nPeriodKey, uint64& nStartTime, bool bStartOfPlayback) = 0;
...
public:
   ...
   */
  PeriodInfo *GetPeriodInfoByKey(uint64 key);
...
public:
   ...
   * @param Scheduler
  */
  MPDParser(HTTPSessionInfo& sessionInfo,Scheduler& pScheduler, IHttpStatusNotificationHandler* pStackNotificationHandler, uint32 nRequestIDfromResolver,
  ...
  */
  ...
  virtual bool GetRepresentationGrpByKey(uint64 key,RepresentationGroup&);
  ...
  virtual HTTPDownloadStatus GetAllSegmentsForRepresentation(SegmentInfo*, uint32& numSegments,uint64 repKey);
  ...
  virtual HTTPDownloadStatus GetLastAvailableSegmentForRepresentation(uint64  repKey,uint64& lastAvailableSegmentStartTime, uint64& lastAvailableSegmentEndTime);
  ...
  virtual HTTPDownloadStatus GetSegmentStartTimeForPlayback(const uint64 nPeriodKey, uint64& nStartTime, bool bStartOfPlayback);
   ...
   * for period.
   */
  int64 GetFirstAvailableSegmentStartTimeForPeriod(PeriodInfo& rPeriodInfo, bool bStartOfPlayback);
