...
public:
  ...
  */
  ...
  static void AddIPStreamProtocolHeaders(HTTPSessionInfo& httpSessionInfo,
                                         IHttpHandler& httpStack, HTTPMethodType methodType,
   ...
   * @return bool
   */
  static bool ConfigureHTTPStack(const HTTPSessionInfo &httpSessionInfo, IHttpHandler& httpStack);
  ...
  static HTTPDownloadStatus GetContentLengthAndType( uint32 nRequestID,
    IHttpHandler& httpStack, int64& contentLength, char*& pContentType );
