...
{
public:
    PlaylistDownloader( HTTPSessionInfo&,StreamSourceClock*, IHttpStatusNotificationHandler*, uint32 nRequestIDfromResolver,
                        IHttpHandler&);
   ...
   */
   ...
   int GetElapsedTimeForPlaylistUpdate() const;
