...
public:
  DASHAdaptor( bool& bOk,
               HTTPSessionInfo& sessionInfo, uint32 nRequestIDfromResolver, IHttpHandler& HTTPStack,
 ...
 virtual bool GetConfig( HTTPCommon::HTTPMediaType mediaType,
  ...
  virtual void GetQOEData(uint32 &bandwidth, char *pVideoURL, int& nURLSize, char *pIpAddr, int& nIPAddrSize);

  void GetNetworkBandwidth(uint32& bandwidth);
