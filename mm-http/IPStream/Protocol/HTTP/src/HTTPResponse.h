...
public:
  ...
  */
   ...
   * @param size
   */
  void CommitEntityBodyBuffer(int size);
  ...
  {
    return m_NumDataBytesReadByClient;
  };
...
private:
  ...
  */
   ...
   */
  int m_NumDataBytesReadByClient;

  /**
   * HTTP Server Version
   */
  float m_HTTPServerVersion;
