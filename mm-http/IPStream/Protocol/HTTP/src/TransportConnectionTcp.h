...
public:
  ...
  virtual ResultCode Send(const char *buffer, int bufsize, int& numWritten);
  virtual ResultCode Recv(char *buffer, int bufsize, int& numBytesRead);
