...
**
**                  pattern: The pattern number to be set. -1 means that DTA
**                      mode is not on and 0-13 means DTA mode with corresponding
**                      pattern number.
**
*******************************************************************************/
NFC_API extern void NFA_DTA_Set_Pattern_Number (int pattern);
/*******************************************************************************
**
...
**
*******************************************************************************/
NFC_API extern int NFA_DTA_Get_Pattern_Number ();
...
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_NFC_Deactivate (BOOLEAN rls_request);

NFC_API extern void NFA_DTA_Mode (void);
