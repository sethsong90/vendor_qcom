...
#ifdef DTA // <DTA>
#include "dta_mode.h"
// This is defined as extern in src/include/dta_mode.h
...
**
*******************************************************************************/
void NFA_DTA_Set_Pattern_Number (int pattern)
{
...
void NFA_DTA_Mode (void) {
	int dta = 0;
	GetNumValue("DTA_MODE", &dta, sizeof(dta));
	if(dta) {
		NFA_TRACE_API0 ("NFA_DTA_MODE");
		dta_Pattern_Number = 0;
	} else {
		NFA_TRACE_API0 ("NFA_NORMAL_MODE");
		dta_Pattern_Number = -1;
	}
	return;
}
#endif // </DTA>
