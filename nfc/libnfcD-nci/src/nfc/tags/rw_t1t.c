...
#ifdef DTA // <DTA>
            /*CR511002: LT expects UID echo values 00000000 . It may be random
               but LT rejecting other than 00000000 values*/
            if(in_dta_mode() ) {
                if(opcode == T1T_CMD_RID)
                {
                    p_t1t->mem[0] = 0;
                    p_t1t->mem[1] = 0;
                    p_t1t->mem[2] = 0;
...
#endif // </!DTA>
        RW_TRACE_API1 ("p_t1t->b_rseg:%X",p_t1t->b_rseg);
    }
