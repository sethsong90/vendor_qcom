...
public:
    ...
    #ifdef DTA // <DTA>
    bool isNfcDep; // Is this tag an NFC-DEP endpoint?
    bool isInitiator; // Is this NFC-DEP endpoint an initiator or a target?
    bool isActive; // Is this NFC-DEP endpoint in the active or passive polling mode?
    bool checkP2pInitiatorOrTarget(UINT8 mode);
    void handleP2pConnection(UINT8 event, tNFA_CONN_EVT_DATA* data);
    #endif // </DTA>
    /*******************************************************************************
    **
    ** Function:        NfcTag
