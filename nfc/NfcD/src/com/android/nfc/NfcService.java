...
public class NfcService implements DeviceHostListener {
    ...
    final class NfcAdapterService extends INfcAdapter.Stub {
        ...
        return mDeviceHost.nfcDeactivate(deactivationType);
        }
            ...
            switch (msg.what) {
                ...
                case MSG_NDEF_TAG:
                    ...
                    // <DTA>
                        ...
                        dispatchTagEndpoint(tag, readerParams);
                        if (DBG) Log.d(TAG, "Tag detected, startPrecenseChecking");
                         tag.startPresenceChecking(presenceCheckDelay);
                        // If we are in DTA mode, pause the presence checking so that it
                        // doesn't disrupt the DTA tests
                         tag.pausePresenceChecking();
                    }
                    // </DTA>
                    break;
