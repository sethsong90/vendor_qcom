...
public final class NfcAdapter {
    ...
    public boolean in_dta_mode() {
        try {
            Log.e(TAG, "[DTA] in_dta_mode");
            return sService.in_dta_mode();
        } catch (RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
    ...
    public void dta_set_pattern_number(int pattern) {
        try {
            Log.e(TAG, "[DTA] dta_set_pattern_number");
            sService.dta_set_pattern_number(pattern);
        } catch (RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
    }
    ...
    public int dta_get_pattern_number() {
        try {
                Log.e(TAG, "[DTA] dta_get_pattern_number");
                return sService.dta_get_pattern_number();
        } catch (RemoteException e) {
                attemptDeadServiceRecovery(e);
        return -1;
        }
    ...
    public boolean nfcDeactivate(int deactivationType) {
        try {
            ...
            return sService.nfcDeactivate(deactivationType);
        } catch (RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
