...
void post_core_event_to_platform(int event)
{
    ...
    port_log_high("Posting Core to Platform Event : %s in state %s",
...
void post_rmnet_event_to_platform (PLATFORM_EVENT_E event)
{
    ...
    port_log_high("Posting RMNET to Platform Event : %s in state %s",
...
{
    port_log_high("Current platform state is  %s ", PLATFORM_STATE_STR[pb_platform_state]);
