...
uint32 ref_clk_speed = BT_QSOC_REF_CLOCK;
#else
uint32 ref_clk_speed = BT_QSOC_REF_CLK_32_0MHZ;
...
uint32 starting_baud = BT_QSOC_INIT_BAUDRATE;

#ifdef BT_QSOC_HCI_BAUD_RATE
uint32 ending_baud = BT_QSOC_HCI_BAUD_RATE; /* differs based on legacy vs HS uart */
#else
uint32 ending_baud = BT_QSOC_APP_BAUDRATE;  /* differs based on legacy vs HS uart */
