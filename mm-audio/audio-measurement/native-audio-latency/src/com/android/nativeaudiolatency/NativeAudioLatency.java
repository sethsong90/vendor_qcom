   ...
   protected void onStart() {
        ...
        ((Button) findViewById(R.id.show)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                double cold_play_driver;
                double warm_play_driver;
                double cont_play_driver;
                double cold_rec_driver;
                double cont_rec_driver;
		...
		/* Breakdown Cold Output Playback Latency*/
                ...
                Log.e(this.toString(),"value of cold output latency is"+ cold_play_driver);
                ...
                warm_play_driver= warm_play_driver-warm_play_app+dsp_latency;
                Log.e(this.toString(),"value of warm output latency is"+ warm_play_driver);
                ...
                cont_play_driver= cont_play_driver-cont_play_app+dsp_latency;
                Log.e(this.toString(),"value of cont output latency is"+ cont_play_driver);

                cold_rec_driver = cold_rec_app;
                Log.e(this.toString(),"value of cold input latency is"+ cold_rec_driver);
                ...
                Log.e(this.toString(),"value of cont input latency is"+ cont_rec_driver);
