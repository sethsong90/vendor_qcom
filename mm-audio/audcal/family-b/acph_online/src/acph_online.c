 ...
 ********************************************************************************
 */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acph_online/src/acph_online.c#2 $ */
/*
   -------------------------------
   |Include Files                |
   -------------------------------
						  ...
						  )
{
	...
	result = AcdbCmdSetOnlineData(tblId,pIndices,noOfTableIndices,mid,pid,pInBuff,nInDataBufLen);
	return result;
}
