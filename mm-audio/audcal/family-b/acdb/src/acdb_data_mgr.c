...
/*===========================================================================
    ...
    $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/src/acdb_data_mgr.c#2 $
...
int32_t GetCalibData(uint32_t tblId,uint32_t nLookupKey,uint32_t dataOffset,AcdbDataInfo dataPoolChnk,
...
int32_t SetCalibData(uint32_t tblId,uint32_t nLookupKey,uint32_t dataOffset,AcdbDataInfo dataPoolChnk,
...
int32_t GetMidPidCalibData(uint32_t tblId,uint32_t nLookupKey,ContentDefTblType cdefTbl,ContentDataOffsetsTblType cdotTbl,AcdbDataInfo dataPoolChnk,
...
int32_t SetMidPidCalibData(uint32_t tblId,uint32_t nLookupKey,ContentDefTblType cdefTbl,ContentDataOffsetsTblType cdotTbl,AcdbDataInfo dataPoolChnk,
					 uint32_t mid,uint32_t pid,uint8_t *pInBuff, uint32_t nInBuffLen)
{
	uint32_t result = ACDB_SUCCESS;
	uint32_t mpindex;
	AcdbDataType cData;
...
int32_t GetMidPidCalibTable(uint32_t tblId,uint32_t nLookupKey,ContentDefTblType cdefTbl,ContentDataOffsetsTblType cdotTbl,AcdbDataInfo dataPoolChnk,
					  uint8_t *pDstBuff, uint32_t nDstBuffLen,uint32_t *pDstBytesUsed)
{
...
int32_t GetMidPidCalibTableSize(uint32_t tblId,uint32_t nLookupKey,ContentDefTblType cdefTbl,ContentDataOffsetsTblType cdotTbl,AcdbDataInfo dataPoolChnk,
					 uint32_t *pSize)
{
	AcdbDataType cData;
	uint32_t i=0;
...
int32_t GetNoOfTblEntriesOnHeap(uint8_t *pCmd,uint32_t nCmdSize ,uint8_t *pRsp,uint32_t nRspSizse)
{
   ...
   result = Acdb_DM_Ioctl(ACDB_GET_NO_OF_TBL_ENTRIES_ON_HEAP,NULL,
							NULL,NULL,pCmd,nCmdSize,NULL,0,pRsp,nRspSizse,NULL,NULL);
...
int32_t GetTblEntriesOnHeap(uint8_t *pCmd,uint32_t nCmdSize ,uint8_t *pRsp,uint32_t nRspSizse)
{
   ...
   result = Acdb_DM_Ioctl(ACDB_GET_TBL_ENTRIES_ON_HEAP,NULL,
							NULL,NULL,pCmd,nCmdSize,NULL,0,pRsp,nRspSizse,NULL,NULL);
...
{
   int32_t result = ACDB_SUCCESS;
   result = Acdb_DM_Ioctl(ACDB_SYS_RESET,NULL,
							NULL,NULL,NULL,0,
