...
/*===========================================================================
    ...
    $ $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/src/acdb.c#2 $
                    ...
                    uint32_t nResponseStructLength)
{
   ...
   default:
	  ...
	  ACDB_DEBUG_LOG("Recieved unsupported command request with cmd id %08X \n",nCommandId);
      break;
   }
