...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/inc/acdb.h#2 $ */
...
*/
typedef struct _AcdbQueryCmdType {
...
*/
typedef struct _AcdbAdiePathProfileV2CmdStruct {
...
*/
typedef struct _AcdbCodecANCSettingCmdType {
...
*/
typedef struct _AcdbInitCmdType {
   uint32_t nNoOfFiles;
...
*/
typedef struct _AcdbVocProcDevCfgCmdType {
   uint32_t nTxDeviceId;
     /**< Tx device ID. */
   uint32_t nRxDeviceId;
     /**< Rx device ID. */
...
*/
typedef struct _AcdbVocProcCmnTblCmdType {
   uint32_t nTxDeviceId;
     /**< Tx device ID. */
   uint32_t nRxDeviceId;
     /**< Rx device ID. */
...
*/
typedef struct _AcdbVocProcGainDepVolTblCmdType {
   uint32_t nTxDeviceId;
     /**< Tx device ID. */
   uint32_t nRxDeviceId;
     /**< Rx device ID. */
...
} AcdbVocProcGainDepVolTblCmdType;
...
@endcode
*/
typedef struct _AcdbAudStrmTableV2CmdType {
...
*/
typedef struct _AcdbDevicePairListCmdType {
...
@endcode
*/
typedef struct _AcdbLsmTableCmdType {
   uint32_t nDeviceId;
     /**< Device ID. */
...
*/
typedef struct _AcdbCodecCalDataCmdType {
   uint32_t nDeviceID;
     /**< Device ID for which the specified pair information is needed. */
...
*/
typedef struct _AcdbDevPropCmdType {
   uint32_t nDeviceId;
     /**< Device ID. */
   uint32_t nPropID;
