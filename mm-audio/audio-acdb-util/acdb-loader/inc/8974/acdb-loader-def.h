...
#define NUM_CAL_BLOCKS			(NUM_AUDPROC_BLOCKS + NUM_VOCPROC_BLOCKS + \
					...
					NUM_LSM_BLOCKS + NUM_CUST_TOP_BLOCKS + \
					NUM_AANC_BLOCKS)
...
#define ACDB_LSM_OFFSET			(ACDB_ANC_OFFSET + NUM_ANC_BLOCKS)
#define ACDB_ADM_CUST_TOP_OFFSET	(ACDB_LSM_OFFSET + NUM_LSM_BLOCKS)
...
#define ACDB_BUFFER_SIZE		(ACDB_BLOCK_SIZE * NUM_CAL_BLOCKS)
	 ...
	 * [101 * 4096] = ANC_CAL
	 * [102 * 4096] = LSM_CAL
	 * [103 * 4096] = ADM_CUSTOM_TOPOLOGY
	 * [104 * 4096] = ASM_CUSTOM_TOPOLOGY
	 * [105 * 4096] = AANC_TX;
	 */
