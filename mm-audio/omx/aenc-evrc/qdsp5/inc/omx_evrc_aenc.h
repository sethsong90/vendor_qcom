...
#define OMX_CORE_INPUT_BUFFER_SIZE    4096 //Better to be 160
#define OMX_EVRC_OUTPUT_BUFFER_SIZE    36
...
private:
    ...
    struct evrc_enc_ipc_info           *m_ipc_to_in_th;    // for input thread
    struct evrc_enc_ipc_info           *m_ipc_to_out_th;    // for output thread
    struct evrc_enc_ipc_info           *m_ipc_to_cmd_th;    // for command thread
