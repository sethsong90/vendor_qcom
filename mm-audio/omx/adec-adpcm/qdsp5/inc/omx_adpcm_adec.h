...
#ifndef  _OMX_ADPCM_DEC_H_
#define  _OMX_ADPCM_DEC_H_
/*============================================================================
                            O p e n M A X   Component
                                Video Decoder

*//** @file comx_adpcm_adec.h
...
#define OMX_CORE_INPUT_BUFFER_SIZE    32768 //8192
//#define OMX_ADPCM_OUTPUT_BUFFER_SIZE  (4608*2) //3200
#define OMX_ADPCM_OUTPUT_BUFFER_SIZE 8192
...
#define OMX_ADPCM_DEFAULT_SF          8000
#define OMX_ADPCM_DEFAULT_CH_CFG      1
#define OMX_ADPCM_DEFAULT_VOL         25
...
private:
    ...
    omx_adpcm_adec        *m_base;
    TIMERINFO           *m_timerinfo;
public:
    timer(omx_adpcm_adec* base);
    ~timer();
    ...
    inline omx_adpcm_adec* get_comp()
    {
        return m_base;
    }
};
...
class omx_adpcm_adec: public qc_omx_component
{
public:
    omx_adpcm_adec();  // constructor
    virtual ~omx_adpcm_adec();  // destructor
...
private:
    ...
    ADPCM_PB_STATS                 m_adpcm_pb_stats;
    struct adpcm_ipc_info          *m_ipc_to_in_th;// for input thread
    struct adpcm_ipc_info          *m_ipc_to_out_th;// for output thread
    struct adpcm_ipc_info          *m_ipc_to_cmd_th;// for command thread
    struct adpcm_ipc_info          *m_ipc_to_event_th;    //for txco event thread
    OMX_PRIORITYMGMTTYPE           m_priority_mgm ;
    OMX_AUDIO_PARAM_ADPCMTYPE      m_adpcm_param; // Cache ADPCM decoder param
    ...
    void process_events(omx_adpcm_adec *client_data);
    bool omx_adpcm_fake_eos(void);
