...
#define OMX_QCELP13_OUTPUT_BUFFER_SIZE  3200
...
#define OMX_QCELP_DEFAULT_SF          8000
#define OMX_QCELP_DEFAULT_CH_CFG      1
#define OMX_QCELP_AAC_FRAME_LEN       1024
#define OMX_QCELP_DEFAULT_VOL         25
...
private:
    ...
    omx_Qcelp13_adec        *m_base;
    TIMERINFO           *m_timerinfo;
public:
    timer(omx_Qcelp13_adec* base);
    ~timer();
    ...
    inline omx_Qcelp13_adec* get_comp()
    {
        return m_base;
    }
};
...
private:
    ...
    QCELP_PB_STATS                 m_qcelp_pb_stats;
    ...
    OMX_AUDIO_PARAM_QCELP13TYPE    m_qcelp_param; // Cache QCELP13 decoder param
    ...
    void process_events(omx_Qcelp13_adec *client_data);
    bool omx_Qcelp13_fake_eos(void);
