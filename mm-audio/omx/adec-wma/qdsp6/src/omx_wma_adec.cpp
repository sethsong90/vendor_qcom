...
bool COmxWmaDec::omx_cmd_queue::insert_entry(unsigned p1,
...
bool COmxWmaDec::omx_cmd_queue::pop_entry(unsigned *p1,
		unsigned *p2, unsigned *id)
{
    bool ret = true;
    if (m_size > 0)
...
bool COmxWmaDec::omx_cmd_queue::get_msg_id(unsigned *id)
{
    if(m_size > 0)
    {
        *id = m_q[m_read].id;
...
None.
========================================================================== */
COmxWmaDec::COmxWmaDec(): m_app_data(NULL),
m_eos_bm(0),
...
*/
bool COmxWmaDec::post_input(unsigned int p1,
unsigned int p2,
unsigned int id)
{
    bool bRet = false;
...
bool COmxWmaDec::post_output(unsigned int p1,
unsigned int p2,
unsigned int id)
{
    bool bRet = false;
...
OMX_BUFFERHEADERTYPE* buffer)
{
	...
	if(wma10Pro)
	{
		...
		drv_config.advancedencodeopt =
			m_adec_param_wma10Pro.advancedEncodeOpt;
