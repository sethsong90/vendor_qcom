...
# Source Path
AENC_AMR := $(SRCDIR)/omx/aenc-amr/qdsp5
...
all: libOmxAmrEnc.so mm-aenc-omxamr-test

# ---------------------------------------------------------------------------------
#				COMPILE LIBRARY
# ---------------------------------------------------------------------------------

SRCS := $(AENC_AMR)/src/aenc_svr.c
SRCS += $(AENC_AMR)/src/omx_amr_aenc.cpp

CPPFLAGS += -I$(AENC_AMR)/inc
...
libOmxAmrEnc.so:$(SRCS)
	$(CC) $(CPPFLAGS) $(CFLAGS) $(CFLAGS_SO) $(LDFLAGS_SO) -Wl,-soname,libOmxAmrEnc.so -o $@ $^ $(LDLIBS)
...
SRCS := $(AENC_AMR)/test/omx_amr_enc_test.c

mm-aenc-omxamr-test: libOmxAmrEnc.so $(SRCS)
