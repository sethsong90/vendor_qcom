...
#define OMX_AMR_OUTPUT_BUFFER_SIZE    768
...
#define AMRDTXMODE_MAX                65535
#define AMRDTXMODE_MIN                0
...
private:
    ...
    struct amr_enc_ipc_info           *m_ipc_to_in_th;    // for input thread
    struct amr_enc_ipc_info           *m_ipc_to_out_th;    // for output thread
    struct amr_enc_ipc_info           *m_ipc_to_cmd_th;    // for command thread
