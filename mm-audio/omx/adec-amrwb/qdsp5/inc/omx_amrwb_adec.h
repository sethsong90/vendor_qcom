#ifndef  _OMX_AMRWB_DEC_H_
#define  _OMX_AMRWB_DEC_H_
/*============================================================================
                            O p e n M A X   Component
                              Audio Decoder

*//** @file comx_amrwb_adec.h
...
#define OMX_CORE_INPUT_BUFFER_SIZE 3220 //322 * 10 to accomodate minimum 6 superframes, and a max of 1610 frames of FT 15
#define OMX_AMR_TRANSCODE_BUFFER_SIZE 9660 // 6 * 1610 to accomodate all the frames in the worst case described above when FT is 15

#define OMX_AMR_OUTPUT_BUFFER_SIZE   8192

#define RESIDUALDATA_BUFFER_SIZE 322 // 320 is data and 2 bytes header

#define AMRWBP_MAX_TRANSCODE_FRMSIZE 326 //320 is data, 6 bytes is header

#define AMRWBP_MAX_INPUT_FRMSIZE 322 // 320 is data and 2 bytes header

#define TRANS_LENGTH 72

#define HEADER_LENGTH 4
#define MAX_FPS 4 //MAX number of Frames Per Superframe

#define AMR_FRAME_TYPE_MASK     0x78
#define AMR_FRAME_TYPE_SHIFT    3
#define AMR_FRAME_QUALITY_MASK  0x04

#define FRMLEN_MASK 0x03FF //vlaue to mask the framelength bits
#define SHIFT_TWO 2
#define FRMLEN_2BITS_MASK 0x00C0
#define FRMLEN_8BITS_MASK 0x00FF
#define FRMHDR_LEN 2
#define AMRWB_MODE_MAX 9 //max mode supported by amr wb
#define AMRWBP_MODE_MIN 10 //start of wb+ mode
#define AMRWBP_MODE_MAX 47 //end of wb+ mode
...
#define AMRWB_DEFAULT_SF 16000
#define AMRWB_DEFAULT_CH 1
...
public:
  ...
  //  OMX_ERRORTYPE GetStartPointsForIETFCombinedMode(OMX_BUFFERHEADERTYPE*   buffer);
 ...
 private:
    ...
    QOMX_AUDIO_PARAM_AMRWBPLUSTYPE      m_amrwbPlus_param;
