...
void *omx_qcelp13_msg(void *info)
{
    ...
    DEBUG_DETAIL("\n%s:%s message thread start\n", __FUNCTION__, qcelp13_info->thread_name);
    ...
    DEBUG_DETAIL("%s:%s message thread stop\n", __FUNCTION__, qcelp13_info->thread_name);
                                    ...
                                    char* th_name)
{
    ...
    strlcpy(qcelp13_info->thread_name,th_name,sizeof(qcelp13_info->thread_name));
