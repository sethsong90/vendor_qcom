...
/**
 * ListenMasterControl is a Java API to Qualcomm's ListenEngine
...
public class ListenMasterControl extends ListenReceiver {
   ...
   public synchronized static ListenMasterControl getInstance()
   {
      ...
      if (null == sMasterControl) {
         ...
         if (null == sMasterControl ) {
            ...
            status = sMasterControl.init(ListenReceiver.MASTERCONTROL_RECEIVER_TYPE);
   ...
   public int releaseInstance()
   {
     ...
     * VoiceWakeup feature. Only the Master Control will be able to
