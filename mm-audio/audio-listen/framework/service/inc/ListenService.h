...
public:
    ...
    */
     ...
     * Param [in]  pSoundModelParams -
     *      Currently this structure contains:
     *         pSoundModelData - pointer to SoundModel to be registered for this session
     *         detectionMode - type of detection to perform
     *            e.g. Keyword-only, User-specific
     *         minKeywordConfidence - minimum percent confidence level in keyword detection
     *            that will trigger event to be sent to the client
     *         minUserConfidence - minimum percent confidence level in user detection
     *            that will trigger event to be sent to the client
     *         bFailureNotification - tells Listen engine to ignore minimum Keyword and User confidence
     *            level settings and return all detections as an event to the client
     *
     * Return - error
     *     LISTEN_EBAD_PARAM
