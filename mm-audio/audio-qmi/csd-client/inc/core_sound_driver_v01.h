...
#define CSD_V01_IDL_MINOR_VERS 0x07
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define CSD_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define CSD_V01_MAX_MESSAGE_ID 0x00A5;
/** 
    @} 
  */
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Controls the adaptive Active Noise Cancellation (AANC) on device.  */
typedef struct {
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Response Message; Controls the adaptive Active Noise Cancellation (AANC) on device.  */
typedef struct {
