#ifndef CSD_SERVICE_H
#define CSD_SERVICE_H
/**
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Qualcomm Technologies Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/csd/main/latest/api/core_sound_driver_v01.h#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define CSD_V01_IDL_MINOR_VERS 0x03
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define CSD_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define CSD_V01_MAX_MESSAGE_ID 0x00A3;
/** 
    @} 
  */
...
typedef enum {
 ...
 VOIP WideVoice network.  */
  QMI_CSD_NETWORK_ID_VOIP_WV_V01 = 0x00011242, 
...
typedef enum {
 ...
 G.722; contains one 20-millisecond vocoder frame.  */
  QMI_CSD_MEDIA_ID_G722_V01 = 0x00010FD1, 
...
typedef enum {
 ...
 48-kHz sample rate.      */
  QMI_CSD_DEV_SR_48000_V01 = 48000, 
...
typedef enum {
 ...
 Enables dynamic companding.   */
  QMI_CSD_CODEC_COMP_ENABLE_DYNAMIC_V01 = 2, 
...
typedef enum {
 ...
 Disables the sidetone.  */
  QMI_CSD_DEV_SIDETONE_DISABLE_V01 = 2, 
...
typedef enum {
 ...
 Tx and Rx.  */
  QMI_CSD_VC_MUTE_DIR_TX_AND_RX_V01 = 2, 
...
typedef enum {
 ...
 Tx and Rx.  */
  QMI_CSD_VS_MUTE_DIR_TX_AND_RX_V01 = 2, 
...
typedef enum {
 ...
 Sets the QCELP13K vocoder rate to 7.2 kbps.  */
  QMI_CSD_VOC_RATE_QCELP13k_72_V01 = 4, 
...
typedef enum {
 ...
 Sets the narrowband vocoder rate to 4.8 kbps.  */
  QMI_CSD_VOC_RATE_4GVNB_48_V01 = 7, 
...
typedef enum {
 ...
 Sets the wideband vocoder rate to 4.8 kbps. */
  QMI_CSD_VOC_RATE_4GVWB_48_V01 = 7, 
...
typedef enum {
 ...
 Sets the AMR encoder rate to 12.2 kbps. */
  QMI_CSD_VOC_AMR_ENC_RATE_122_V01 = 7, 
...
typedef enum {
 ...
 Sets the AMR-WB encoder encoder rate to 23.85 kbps. */
  QMI_CSD_VOC_AMRWB_ENC_RATE_2335_V01 = 8, 
...
typedef enum {
 ...
 Rx tap point is at the end of the 
                                             stream.  */
  QMI_CSD_VS_TAP_POINT_STREAM_END_V01 = 0x00010F79, 
...
typedef struct {
  ...
  /**<   Voice context handle opened by QMI_CSD_OPEN_VOICE_CONTEXT_REQ message, 
...
typedef struct {
  ...
  /**<   Offset in microseconds from the vocoder frame reference to request 
         a Rx vocoder packet. The offset must be less than 20 ms.  */
...
typedef struct {
  ...
  /**<   Specifies the open mode, and indicates the optional fields that are 
         present to support the open fields. Supported values:
         \begin{itemize1}
         \item 0 -- Field does not exist.\n
         \item 1 -- Field exists. Supported values:
                \begin{itemize1}
...
typedef enum {
 ...
 Voice recognition category.  */
  QMI_CSD_AC_CATEGORY_VOICE_RECOGNITION_V01 = 4, 
...
typedef enum {
  ...
  QMI_CSD_AC_MODE_NON_LIVE_V01 = 0, /**<  Non-live mode sample buffered in the 
								        AFE. 
 Live mode. The sample is not buffered 
								        if the polling is not fast enough.  */
  QMI_CSD_AC_MODE_LIVE_V01 = 1, 
...
typedef enum {
 ...
 48 kHz.  */
  QMI_CSD_AS_FMT_SR_48K_V01 = 48000, 
...
typedef enum {
 ...
 Stereo.  */
  QMI_CSD_AS_FMT_CH_STEREO_V01 = 2, 
...
typedef enum {
 ...
 Signed.  */
  QMI_CSD_AS_FMT_PCM_SIGNED_V01 = 1, 
...
typedef enum {
  ...
  QMI_CSD_AS_FMT_PCM_NONINTERLEAVED_V01 = 0, /**<  Non-interleaved. 
 Interleaved.  */
  QMI_CSD_AS_FMT_PCM_INTERLEAVED_V01 = 1, 
...
typedef enum {
  ...
  QMI_CSD_AS_WMA_TAG_LOSELESS_V01 = 0x163, /**<  Lossless.  */
  QMI_CSD_AS_WMA_TAG_LOSSLESS_V01 = 0x163, 
...
typedef enum {
 ...
 Parametric Stereo (PS) object type.  */
  QMI_CSD_AS_FMT_AAC_OT_PS_V01 = 29, 
...
typedef enum {
 ...
 AMR-WB+ internal sampling frequency is 38400 Hz.              */
  QMI_CSD_AS_FMT_AMR_WB_PLUS_ISF_13_V01 = 13, 
...
typedef enum {
 ...
 AMR-WB+ file storage format.  */
  QMI_CSD_AS_FMT_AMR_WB_PLUS_FF_FSF_V01 = 7, 
...
typedef enum {
 ...
 AMR-WB+ mode 47.  */
  QMI_CSD_AS_FMT_AMR_BM_WB_PLUS47_V01 = 47, 
...
typedef enum {
 ...
 AMR-NB mode 7 is 12200 bps.             */
  QMI_CSD_AS_AMR_MODE_NB_7_V01 = 7, 
...
typedef enum {
 ...
 Discontinuous transmission as enhanced 
                                        full rate instead of adaptive multirate 
                                        codec standard.           */
  QMI_CSD_AS_AMR_DTX_EFR_V01 = 4, 
...
typedef enum {
 ...
 AMR-WB mode 8 is 23850 bps          */
  QMI_CSD_AS_AMR_MODE_WB_8_V01 = 8, 
...
typedef enum {
 ...
 7.2 kbps.            */
  QMI_CSD_AS_FMT_QCELP_BR_4_V01 = 4, 
...
typedef struct {
  ...
  /**<   Rate modulation. Supported values:
      \begin{itemize1}
         \item Bit 0:
                 \begin{itemize1}
...
typedef struct {
  ...
  /**<   Bitrate control command. For EVRC, this is used as the average bitrate
         control command. Supported values:
         \begin{itemize1}
         \item Bit 0:
                 \begin{itemize1}
...
typedef enum {
 ...
 4.8 kbps.       */
  QMI_CSD_AS_FMT_EVRCB_BR_7_V01 = 7, 
...
typedef enum {
 ...
 4.8 kbps.   */
  QMI_CSD_AS_FMT_EVRCWB_BR_7_V01 = 7, 
...
typedef enum {
  ...
  QMI_CSD_AS_FMT_SBC_ALLOC_LOUDNESS_V01 = 0, /**<  Loudness mode for subband 
                                                 coding. 
 Signal-to-Noise Ratio mode 
                                                 for subband coding.  */
  QMI_CSD_AS_FMT_SBC_ALLOC_SNR_V01 = 1, 
...
typedef enum {
 ...
 8-subband SBC.     */
  QMI_CSD_AS_SBC_SUBBAND_8_V01 = 8, 
...
typedef enum {
 ...
 Joint Stereo mode  */
  QMI_CSD_AS_SBC_CH_MODE_JOINTSTEREO_V01 = 9, 
...
typedef enum {
 ...
 Subwoofer channel type.  */
  QMI_CSD_AUD_PP_MULTI_CH_VOL_SUBWOOFER_V01 = 8, 
...
typedef enum {
 ...
 Equalizer filter type is band cut.  */
  QMI_CSD_AUD_PP_EQ_FILTER_TYPE_BAND_CUT_V01 = 6, 
...
typedef enum {
 ...
 Living room QCPR preset.  */
  QMI_CSD_AUD_PP_QCPR_PRESET_LIVINGROOM_V01 = 7, 
...
typedef enum {
 ...
 QCPR strength ten.   */
  QMI_CSD_AUD_PP_QCPR_STRENGTH_TEN_V01 = 9, 
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Request Message; Enables, configures, or disables QConcertPlus 
           @latexonly \texttrademark~@endlatexonly reverb (QCPR) for the audio 
           stream. */
typedef struct {
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Response Message; Enables, configures, or disables QConcertPlus 
           @latexonly \texttrademark~@endlatexonly reverb (QCPR) for the audio 
           stream. */
typedef struct {
...
typedef enum {
 ...
 SPA sample point 256.  */
  QMI_CSD_AUD_PP_SPA_SAMPLEPOINT_256_V01 = 256, 
...
typedef enum {
 ...
 Second SCE to both the left and right channels.  */
  QMI_CSD_AS_DUALMONO_REMAP_TYPE4_V01 = 4, 
...
typedef enum {
 ...
 SBR is on, and parametric stereo AAC is on.  */
  QMI_CSD_AS_AAC_SBR_PS_TYPE3_V01 = 2, 
...
typedef enum {
 ...
 Encoder type SBC is 15.  */
  QMI_CSD_AS_ENC_FMT_TYPE_SBC_V01 = 15, 
...
typedef enum {
  ...
  QMI_CSD_AS_EAC3_CHANNEL_CONFIG_FL_FC_FR_SL_SR_SLR_SRR_V01 = 21, /**<  Front left, front center, front right, surround left, surround 
         ...
         are selected. 
 Front left, front center, front right, surround left, surround 
         right, surround top, and center vertical height speakers are 
         selected.  */
  QMI_CSD_AS_EAC3_CHANNEL_CONFIG_FL_FC_FR_SL_SR_TS_CVH_V01 = 22, 
...
typedef enum {
 ...
 Extension X2 channel.      */
  QMI_CSD_AS_EAC3_CHANNEL_EX_2_V01 = 8, 
...
/** @addtogroup csd_qmi_messages
    @{
  */
/** Indication Message; Indicates the sample rate change or channel configuration change 
...
typedef enum {
 ...
 Rear right center channel.  */
  QMI_CSD_AC_MULTI_CHANNEL_MAPPING_CHANNEL_RRC_V01 = 16, 
