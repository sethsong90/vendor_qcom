...
GENERAL DESCRIPTION
 ...
 Qualcomm Technologies Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/csd/main/latest/src/core_sound_driver_v01.c#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 5.3
   ...
   It was generated on: Fri Jun 15 2012
...
static const qmi_idl_service_message_table_entry csd_service_command_messages_v01[] = {
  {QMI_CSD_QUERY_DRIVER_VERSION_REQ_V01, TYPE16(0, 0), 0},
  {QMI_CSD_INIT_REQ_V01, TYPE16(0, 2), 0},
  {QMI_CSD_DEINIT_REQ_V01, TYPE16(0, 4), 0},
  {QMI_CSD_OPEN_PASSIVE_CONTROL_VOICE_STREAM_REQ_V01, TYPE16(0, 6), 258},
  {QMI_CSD_OPEN_FULL_CONTROL_VOICE_STREAM_REQ_V01, TYPE16(0, 8), 275},
  {QMI_CSD_OPEN_VOICE_CONTEXT_REQ_V01, TYPE16(0, 10), 267},
  {QMI_CSD_OPEN_VOICE_MANAGER_REQ_V01, TYPE16(0, 12), 259},
  {QMI_CSD_OPEN_DEVICE_CONTROL_REQ_V01, TYPE16(0, 14), 0},
  {QMI_CSD_CLOSE_REQ_V01, TYPE16(0, 16), 7},
  {QMI_CSD_IOCTL_DEV_CMD_ENABLE_REQ_V01, TYPE16(0, 18), 35},
  {QMI_CSD_IOCTL_DEV_CMD_DISABLE_REQ_V01, TYPE16(0, 20), 19},
  {QMI_CSD_IOCTL_DEV_CMD_AFE_LOOPBACK_REQ_V01, TYPE16(0, 22), 21},
  {QMI_CSD_IOCTL_DEV_CMD_ANC_CONTROL_REQ_V01, TYPE16(0, 26), 15},
  {QMI_CSD_IOCTL_DEV_CMD_COMPANDING_CONTROL_REQ_V01, TYPE16(0, 28), 18},
  {QMI_CSD_IOCTL_DEV_CMD_GET_MAX_DEVICE_NUMS_REQ_V01, TYPE16(0, 30), 7},
  {QMI_CSD_IOCTL_DEV_CMD_GET_DEV_CAPS_REQ_V01, TYPE16(0, 32), 7},
  {QMI_CSD_IOCTL_DEV_CMD_DTMF_CONTROL_REQ_V01, TYPE16(0, 34), 1050},
  {QMI_CSD_IOCTL_DEV_CMD_SIDETONE_CONTROL_REQ_V01, TYPE16(0, 36), 22},
  {QMI_CSD_IOCTL_DEV_CMD_CONFIGURE_REQ_V01, TYPE16(0, 38), 35},
  {QMI_CSD_IOCTL_VC_CMD_SET_DEVICE_CONFIG_REQ_V01, TYPE16(0, 40), 37},
  {QMI_CSD_IOCTL_VC_CMD_ENABLE_REQ_V01, TYPE16(0, 42), 14},
  {QMI_CSD_IOCTL_VC_CMD_DISABLE_REQ_V01, TYPE16(0, 44), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_INDEX_REQ_V01, TYPE16(0, 46), 18},
  {QMI_CSD_IOCTL_VC_CMD_SET_MUTE_REQ_V01, TYPE16(0, 52), 27},
  {QMI_CSD_IOCTL_VC_CMD_SET_TX_DTMF_DETECTION_REQ_V01, TYPE16(0, 54), 18},
  {QMI_CSD_IOCTL_VC_CMD_SET_UI_PROPERTY_REQ_V01, TYPE16(0, 57), 2072},
  {QMI_CSD_IOCTL_VC_CMD_GET_UI_PROPERTY_REQ_V01, TYPE16(0, 59), 29},
  {QMI_CSD_IOCTL_VS_CMD_SET_MEDIA_TYPE_REQ_V01, TYPE16(0, 62), 22},
  {QMI_CSD_IOCTL_VS_CMD_SET_MUTE_REQ_V01, TYPE16(0, 64), 27},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENCODER_DTX_MODE_REQ_V01, TYPE16(0, 66), 18},
  {QMI_CSD_IOCTL_VS_CMD_SET_DEC_TIMEWARP_REQ_V01, TYPE16(0, 68), 24},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_MINMAX_RATE_REQ_V01, TYPE16(0, 70), 22},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_RATE_MODULATION_REQ_V01, TYPE16(0, 72), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_QCELP13K_SET_RATE_REQ_V01, TYPE16(0, 74), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVNB_SET_RATE_REQ_V01, TYPE16(0, 76), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVWB_SET_RATE_REQ_V01, TYPE16(0, 78), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMR_SET_ENC_RATE_REQ_V01, TYPE16(0, 80), 18},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMRWB_SET_ENC_RATE_REQ_V01, TYPE16(0, 82), 18},
  {QMI_CSD_IOCTL_VS_CMD_SET_DTMF_GENERATION_REQ_V01, TYPE16(0, 84), 26},
  {QMI_CSD_IOCTL_VS_CMD_SET_RX_DTMF_DETECTION_REQ_V01, TYPE16(0, 87), 18},
  {QMI_CSD_IOCTL_VS_CMD_SET_UI_PROPERTY_REQ_V01, TYPE16(0, 90), 2072},
  {QMI_CSD_IOCTL_VS_CMD_GET_UI_PROPERTY_REQ_V01, TYPE16(0, 92), 29},
  {QMI_CSD_IOCTL_VS_CMD_START_RECORD_REQ_V01, TYPE16(0, 94), 42},
  {QMI_CSD_IOCTL_VS_CMD_STOP_RECORD_REQ_V01, TYPE16(0, 96), 14},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_STREAM_REQ_V01, TYPE16(0, 105), 18},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_STREAM_REQ_V01, TYPE16(0, 107), 18},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_CONTEXT_REQ_V01, TYPE16(0, 109), 18},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_CONTEXT_REQ_V01, TYPE16(0, 111), 18},
  {QMI_CSD_IOCTL_VM_CMD_START_VOICE_REQ_V01, TYPE16(0, 113), 14},
  {QMI_CSD_IOCTL_VM_CMD_STOP_VOICE_REQ_V01, TYPE16(0, 117), 14},
  {QMI_CSD_IOCTL_VM_CMD_SET_NETWORK_REQ_V01, TYPE16(0, 119), 18},
  {QMI_CSD_IOCTL_VM_CMD_SET_VOICE_TIMING_REQ_V01, TYPE16(0, 121), 22},
  {QMI_CSD_IOCTL_VM_CMD_SET_TTY_MODE_REQ_V01, TYPE16(0, 123), 18},
  {QMI_CSD_IOCTL_VM_CMD_SET_WIDEVOICE_REQ_V01, TYPE16(0, 125), 18},
  {QMI_CSD_OPEN_AUDIO_STREAM_REQ_V01, TYPE16(0, 127), 31},
  {QMI_CSD_OPEN_AUDIO_CONTEXT_REQ_V01, TYPE16(0, 129), 19},
  {QMI_CSD_AS_CMD_START_SESSION_REQ_V01, TYPE16(0, 131), 22},
  {QMI_CSD_AS_CMD_STOP_SESSION_REQ_V01, TYPE16(0, 133), 7},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_REQ_V01, TYPE16(0, 135), 7},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_TX_REQ_V01, TYPE16(0, 137), 7},
  {QMI_CSD_AS_CMD_GET_VOL_LEVELS_REQ_V01, TYPE16(0, 139), 7},
  {QMI_CSD_AS_CMD_GET_DSP_CLK_REQ_V01, TYPE16(0, 141), 7},
  {QMI_CSD_AS_CMD_GET_RENDERED_TIME_REQ_V01, TYPE16(0, 143), 7},
  {QMI_CSD_AS_CMD_GET_SESSION_ID_REQ_V01, TYPE16(0, 145), 7},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_PCM_REQ_V01, TYPE16(0, 147), 40},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_ADPCM_REQ_V01, TYPE16(0, 149), 35},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_MIDI_REQ_V01, TYPE16(0, 151), 14},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV9_REQ_V01, TYPE16(0, 153), 56},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV10_REQ_V01, TYPE16(0, 155), 62},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AAC_REQ_V01, TYPE16(0, 157), 37},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_G711_REQ_V01, TYPE16(0, 159), 14},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_FLAC_REQ_V01, TYPE16(0, 161), 47},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_VORBIS_REQ_V01, TYPE16(0, 163), 56},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AMRWBPLUS_REQ_V01, TYPE16(0, 165), 42},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_PCM_REQ_V01, TYPE16(0, 167), 40},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AAC_REQ_V01, TYPE16(0, 169), 42},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_G711_REQ_V01, TYPE16(0, 171), 14},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRNB_REQ_V01, TYPE16(0, 173), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRWB_REQ_V01, TYPE16(0, 175), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_QCELP13K_REQ_V01, TYPE16(0, 177), 33},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRC_REQ_V01, TYPE16(0, 179), 33},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCB_REQ_V01, TYPE16(0, 181), 35},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCWB_REQ_V01, TYPE16(0, 183), 35},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_SBC_REQ_V01, TYPE16(0, 185), 49},
  {QMI_CSD_AS_CMD_SET_STREAM_EOS_REQ_V01, TYPE16(0, 187), 7},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MASTER_GAIN_REQ_V01, TYPE16(0, 189), 12},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_STEREO_GAIN_REQ_V01, TYPE16(0, 191), 17},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_REQ_V01, TYPE16(0, 193), 59},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MUTE_REQ_V01, TYPE16(0, 195), 14},
  {QMI_CSD_AS_CMD_CONFIG_PP_EQ_ENABLE_REQ_V01, TYPE16(0, 197), 251},
  {QMI_CSD_AS_CMD_CONFIG_PP_QCPR_REQ_V01, TYPE16(0, 199), 18},
  {QMI_CSD_AS_CMD_CONFIG_PP_SPA_REQ_V01, TYPE16(0, 201), 18},
  {QMI_CSD_AS_CMD_CONFIG_PP_TSM_REQ_V01, TYPE16(0, 203), 12},
  {QMI_CSD_AS_CMD_GET_SPA_DATA_REQ_V01, TYPE16(0, 205), 7},
  {QMI_CSD_AS_CMD_SET_DUAL_MONO_REMAP_REQ_V01, TYPE16(0, 207), 14},
  {QMI_CSD_AS_CMD_ADJUST_SESSION_CLOCK_REQ_V01, TYPE16(0, 209), 21},
  {QMI_CSD_AS_CMD_SET_AAC_SBR_PS_REQ_V01, TYPE16(0, 211), 14},
  {QMI_CSD_AS_CMD_DTMF_CTL_REQ_V01, TYPE16(0, 213), 27},
  {QMI_CSD_AS_CMD_SET_STREAM_INFO_REQ_V01, TYPE16(0, 215), 14},
  {QMI_CSD_AS_CMD_GET_RENDERED_BYTE_OFFSET_REQ_V01, TYPE16(0, 217), 7},
  {QMI_CSD_AS_CMD_GET_MIDI_SEQUENCE_ID_REQ_V01, TYPE16(0, 219), 7},
  {QMI_CSD_AS_CMD_ENCODER_BIT_RATE_UPDATE_REQ_V01, TYPE16(0, 221), 21},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_WMAV10_REQ_V01, TYPE16(0, 223), 14},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_EAC3_REQ_V01, TYPE16(0, 225), 56},
  {QMI_CSD_AC_CMD_AS_ATTACH_REQ_V01, TYPE16(0, 230), 43},
  {QMI_CSD_AC_CMD_AS_DETACH_REQ_V01, TYPE16(0, 232), 43},
  {QMI_CSD_AC_CMD_SET_DEVICE_REQ_V01, TYPE16(0, 234), 21},
  {QMI_CSD_AC_CMD_ENABLE_REQ_V01, TYPE16(0, 236), 7},
  {QMI_CSD_AC_CMD_DISABLE_REQ_V01, TYPE16(0, 238), 7},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MASTER_GAIN_REQ_V01, TYPE16(0, 240), 12},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_STEREO_GAIN_REQ_V01, TYPE16(0, 242), 17},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_REQ_V01, TYPE16(0, 244), 59},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MUTE_REQ_V01, TYPE16(0, 246), 14},
  {QMI_CSD_AC_CMD_CONFIG_PP_EQ_ENABLE_REQ_V01, TYPE16(0, 248), 251},
  {QMI_CSD_AC_CMD_CONFIG_PP_QCPR_REQ_V01, TYPE16(0, 250), 18},
  {QMI_CSD_AC_CMD_CONFIG_PP_SPA_REQ_V01, TYPE16(0, 252), 18},
  {QMI_CSD_AC_CMD_GET_SPA_DATA_REQ_V01, TYPE16(0, 254), 7},
  {QMI_CSD_AC_CMD_CONFIG_MULTI_CHANNEL_REQ_V01, TYPE16(0, 256), 47},
  {QMI_CSD_IOCTL_DEV_CMD_CONNECT_DEVICE_REQ_V01, TYPE16(0, 24), 19},
  {QMI_CSD_IOCTL_VC_CMD_SET_NUMBER_OF_VOLUME_STEPS_REQ_V01, TYPE16(0, 48), 18},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_STEP_REQ_V01, TYPE16(0, 50), 20},
  {QMI_CSD_IOCTL_VS_CMD_START_PLAYBACK_REQ_V01, TYPE16(0, 98), 21},
  {QMI_CSD_IOCTL_VS_CMD_STOP_PLAYBACK_REQ_V01, TYPE16(0, 100), 14},
  {QMI_CSD_IOCTL_VM_CMD_STANDBY_VOICE_REQ_V01, TYPE16(0, 115), 14}
};

static const qmi_idl_service_message_table_entry csd_service_response_messages_v01[] = {
  {QMI_CSD_QUERY_DRIVER_VERSION_RESP_V01, TYPE16(0, 1), 14},
  {QMI_CSD_INIT_RESP_V01, TYPE16(0, 3), 14},
  {QMI_CSD_DEINIT_RESP_V01, TYPE16(0, 5), 14},
  {QMI_CSD_OPEN_PASSIVE_CONTROL_VOICE_STREAM_RESP_V01, TYPE16(0, 7), 21},
  {QMI_CSD_OPEN_FULL_CONTROL_VOICE_STREAM_RESP_V01, TYPE16(0, 9), 21},
  {QMI_CSD_OPEN_VOICE_CONTEXT_RESP_V01, TYPE16(0, 11), 21},
  {QMI_CSD_OPEN_VOICE_MANAGER_RESP_V01, TYPE16(0, 13), 21},
  {QMI_CSD_OPEN_DEVICE_CONTROL_RESP_V01, TYPE16(0, 15), 21},
  {QMI_CSD_CLOSE_RESP_V01, TYPE16(0, 17), 21},
  {QMI_CSD_IOCTL_DEV_CMD_ENABLE_RESP_V01, TYPE16(0, 19), 14},
  {QMI_CSD_IOCTL_DEV_CMD_DISABLE_RESP_V01, TYPE16(0, 21), 14},
  {QMI_CSD_IOCTL_DEV_CMD_AFE_LOOPBACK_RESP_V01, TYPE16(0, 23), 14},
  {QMI_CSD_IOCTL_DEV_CMD_ANC_CONTROL_RESP_V01, TYPE16(0, 27), 14},
  {QMI_CSD_IOCTL_DEV_CMD_COMPANDING_CONTROL_RESP_V01, TYPE16(0, 29), 14},
  {QMI_CSD_IOCTL_DEV_CMD_GET_MAX_DEVICE_NUMS_RESP_V01, TYPE16(0, 31), 21},
  {QMI_CSD_IOCTL_DEV_CMD_GET_DEV_CAPS_RESP_V01, TYPE16(0, 33), 3095},
  {QMI_CSD_IOCTL_DEV_CMD_DTMF_CONTROL_RESP_V01, TYPE16(0, 35), 14},
  {QMI_CSD_IOCTL_DEV_CMD_SIDETONE_CONTROL_RESP_V01, TYPE16(0, 37), 14},
  {QMI_CSD_IOCTL_DEV_CMD_CONFIGURE_RESP_V01, TYPE16(0, 39), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_DEVICE_CONFIG_RESP_V01, TYPE16(0, 41), 28},
  {QMI_CSD_IOCTL_VC_CMD_ENABLE_RESP_V01, TYPE16(0, 43), 28},
  {QMI_CSD_IOCTL_VC_CMD_DISABLE_RESP_V01, TYPE16(0, 45), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_INDEX_RESP_V01, TYPE16(0, 47), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_MUTE_RESP_V01, TYPE16(0, 53), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_TX_DTMF_DETECTION_RESP_V01, TYPE16(0, 55), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_UI_PROPERTY_RESP_V01, TYPE16(0, 58), 28},
  {QMI_CSD_IOCTL_VC_CMD_GET_UI_PROPERTY_RESP_V01, TYPE16(0, 60), 2093},
  {QMI_CSD_IOCTL_VS_CMD_SET_MEDIA_TYPE_RESP_V01, TYPE16(0, 63), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_MUTE_RESP_V01, TYPE16(0, 65), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENCODER_DTX_MODE_RESP_V01, TYPE16(0, 67), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_DEC_TIMEWARP_RESP_V01, TYPE16(0, 69), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_MINMAX_RATE_RESP_V01, TYPE16(0, 71), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_ENC_RATE_MODULATION_RESP_V01, TYPE16(0, 73), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_QCELP13K_SET_RATE_RESP_V01, TYPE16(0, 75), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVNB_SET_RATE_RESP_V01, TYPE16(0, 77), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_4GVWB_SET_RATE_RESP_V01, TYPE16(0, 79), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMR_SET_ENC_RATE_RESP_V01, TYPE16(0, 81), 28},
  {QMI_CSD_IOCTL_VS_CMD_VOC_AMRWB_SET_ENC_RATE_RESP_V01, TYPE16(0, 83), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_DTMF_GENERATION_RESP_V01, TYPE16(0, 85), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_RX_DTMF_DETECTION_RESP_V01, TYPE16(0, 88), 28},
  {QMI_CSD_IOCTL_VS_CMD_SET_UI_PROPERTY_RESP_V01, TYPE16(0, 91), 28},
  {QMI_CSD_IOCTL_VS_CMD_GET_UI_PROPERTY_RESP_V01, TYPE16(0, 93), 2093},
  {QMI_CSD_IOCTL_VS_CMD_START_RECORD_RESP_V01, TYPE16(0, 95), 28},
  {QMI_CSD_IOCTL_VS_CMD_STOP_RECORD_RESP_V01, TYPE16(0, 97), 28},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_STREAM_RESP_V01, TYPE16(0, 106), 28},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_STREAM_RESP_V01, TYPE16(0, 108), 28},
  {QMI_CSD_IOCTL_VM_CMD_ATTACH_CONTEXT_RESP_V01, TYPE16(0, 110), 28},
  {QMI_CSD_IOCTL_VM_CMD_DETACH_CONTEXT_RESP_V01, TYPE16(0, 112), 28},
  {QMI_CSD_IOCTL_VM_CMD_START_VOICE_RESP_V01, TYPE16(0, 114), 28},
  {QMI_CSD_IOCTL_VM_CMD_STOP_VOICE_RESP_V01, TYPE16(0, 118), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_NETWORK_RESP_V01, TYPE16(0, 120), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_VOICE_TIMING_RESP_V01, TYPE16(0, 122), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_TTY_MODE_RESP_V01, TYPE16(0, 124), 28},
  {QMI_CSD_IOCTL_VM_CMD_SET_WIDEVOICE_RESP_V01, TYPE16(0, 126), 28},
  {QMI_CSD_OPEN_AUDIO_STREAM_RESP_V01, TYPE16(0, 128), 21},
  {QMI_CSD_OPEN_AUDIO_CONTEXT_RESP_V01, TYPE16(0, 130), 21},
  {QMI_CSD_AS_CMD_START_SESSION_RESP_V01, TYPE16(0, 132), 21},
  {QMI_CSD_AS_CMD_STOP_SESSION_RESP_V01, TYPE16(0, 134), 21},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_RESP_V01, TYPE16(0, 136), 21},
  {QMI_CSD_AS_CMD_FLUSH_STREAM_TX_RESP_V01, TYPE16(0, 138), 21},
  {QMI_CSD_AS_CMD_GET_VOL_LEVELS_RESP_V01, TYPE16(0, 140), 28},
  {QMI_CSD_AS_CMD_GET_DSP_CLK_RESP_V01, TYPE16(0, 142), 36},
  {QMI_CSD_AS_CMD_GET_RENDERED_TIME_RESP_V01, TYPE16(0, 144), 36},
  {QMI_CSD_AS_CMD_GET_SESSION_ID_RESP_V01, TYPE16(0, 146), 28},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_PCM_RESP_V01, TYPE16(0, 148), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_ADPCM_RESP_V01, TYPE16(0, 150), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_MIDI_RESP_V01, TYPE16(0, 152), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV9_RESP_V01, TYPE16(0, 154), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_WMAV10_RESP_V01, TYPE16(0, 156), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AAC_RESP_V01, TYPE16(0, 158), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_G711_RESP_V01, TYPE16(0, 160), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_FLAC_RESP_V01, TYPE16(0, 162), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_VORBIS_RESP_V01, TYPE16(0, 164), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_RX_AMRWBPLUS_RESP_V01, TYPE16(0, 166), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_PCM_RESP_V01, TYPE16(0, 168), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AAC_RESP_V01, TYPE16(0, 170), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_G711_RESP_V01, TYPE16(0, 172), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRNB_RESP_V01, TYPE16(0, 174), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_AMRWB_RESP_V01, TYPE16(0, 176), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_QCELP13K_RESP_V01, TYPE16(0, 178), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRC_RESP_V01, TYPE16(0, 180), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCB_RESP_V01, TYPE16(0, 182), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_EVRCWB_RESP_V01, TYPE16(0, 184), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_FMT_TX_SBC_RESP_V01, TYPE16(0, 186), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_EOS_RESP_V01, TYPE16(0, 188), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MASTER_GAIN_RESP_V01, TYPE16(0, 190), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_STEREO_GAIN_RESP_V01, TYPE16(0, 192), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_RESP_V01, TYPE16(0, 194), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_VOL_MUTE_RESP_V01, TYPE16(0, 196), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_EQ_ENABLE_RESP_V01, TYPE16(0, 198), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_QCPR_RESP_V01, TYPE16(0, 200), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_SPA_RESP_V01, TYPE16(0, 202), 21},
  {QMI_CSD_AS_CMD_CONFIG_PP_TSM_RESP_V01, TYPE16(0, 204), 21},
  {QMI_CSD_AS_CMD_GET_SPA_DATA_RESP_V01, TYPE16(0, 206), 21},
  {QMI_CSD_AS_CMD_SET_DUAL_MONO_REMAP_RESP_V01, TYPE16(0, 208), 21},
  {QMI_CSD_AS_CMD_ADJUST_SESSION_CLOCK_RESP_V01, TYPE16(0, 210), 35},
  {QMI_CSD_AS_CMD_SET_AAC_SBR_PS_RESP_V01, TYPE16(0, 212), 21},
  {QMI_CSD_AS_CMD_DTMF_CTL_RESP_V01, TYPE16(0, 214), 21},
  {QMI_CSD_AS_CMD_SET_STREAM_INFO_RESP_V01, TYPE16(0, 216), 21},
  {QMI_CSD_AS_CMD_GET_RENDERED_BYTE_OFFSET_RESP_V01, TYPE16(0, 218), 32},
  {QMI_CSD_AS_CMD_GET_MIDI_SEQUENCE_ID_RESP_V01, TYPE16(0, 220), 25},
  {QMI_CSD_AS_CMD_ENCODER_BIT_RATE_UPDATE_RESP_V01, TYPE16(0, 222), 21},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_WMAV10_RESP_V01, TYPE16(0, 224), 21},
  {QMI_CSD_AS_CMD_CONFIG_DECODER_MULTI_CHANNEL_EAC3_RESP_V01, TYPE16(0, 226), 21},
  {QMI_CSD_AC_CMD_AS_ATTACH_RESP_V01, TYPE16(0, 231), 21},
  {QMI_CSD_AC_CMD_AS_DETACH_RESP_V01, TYPE16(0, 233), 21},
  {QMI_CSD_AC_CMD_SET_DEVICE_RESP_V01, TYPE16(0, 235), 21},
  {QMI_CSD_AC_CMD_ENABLE_RESP_V01, TYPE16(0, 237), 21},
  {QMI_CSD_AC_CMD_DISABLE_RESP_V01, TYPE16(0, 239), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MASTER_GAIN_RESP_V01, TYPE16(0, 241), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_STEREO_GAIN_RESP_V01, TYPE16(0, 243), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MULTICHANNEL_GAIN_RESP_V01, TYPE16(0, 245), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_VOL_MUTE_RESP_V01, TYPE16(0, 247), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_EQ_ENABLE_RESP_V01, TYPE16(0, 249), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_QCPR_RESP_V01, TYPE16(0, 251), 21},
  {QMI_CSD_AC_CMD_CONFIG_PP_SPA_RESP_V01, TYPE16(0, 253), 21},
  {QMI_CSD_AC_CMD_GET_SPA_DATA_RESP_V01, TYPE16(0, 255), 21},
  {QMI_CSD_AC_CMD_CONFIG_MULTI_CHANNEL_RESP_V01, TYPE16(0, 257), 21},
  {QMI_CSD_IOCTL_DEV_CMD_CONNECT_DEVICE_RESP_V01, TYPE16(0, 25), 14},
  {QMI_CSD_IOCTL_VC_CMD_SET_NUMBER_OF_VOLUME_STEPS_RESP_V01, TYPE16(0, 49), 28},
  {QMI_CSD_IOCTL_VC_CMD_SET_RX_VOLUME_STEP_RESP_V01, TYPE16(0, 51), 28},
  {QMI_CSD_IOCTL_VS_CMD_START_PLAYBACK_RESP_V01, TYPE16(0, 99), 28},
  {QMI_CSD_IOCTL_VS_CMD_STOP_PLAYBACK_RESP_V01, TYPE16(0, 101), 28},
  {QMI_CSD_IOCTL_VM_CMD_STANDBY_VOICE_RESP_V01, TYPE16(0, 116), 28}
};

static const qmi_idl_service_message_table_entry csd_service_indication_messages_v01[] = {
  {QMI_CSD_IOCTL_VC_TX_DTMF_DETECTED_IND_V01, TYPE16(0, 56), 17},
  {QMI_CSD_IOCTL_VC_STATE_IND_V01, TYPE16(0, 61), 14},
  {QMI_CSD_IOCTL_VS_DTMF_GENERATION_ENDED_IND_V01, TYPE16(0, 86), 19},
  {QMI_CSD_IOCTL_VS_RX_DTMF_DETECTED_IND_V01, TYPE16(0, 89), 17},
  {QMI_CSD_IOCTL_VS_STATE_IND_V01, TYPE16(0, 102), 14},
  {QMI_CSD_IOCTL_VS_ENC_BUFFER_IND_V01, TYPE16(0, 103), 7},
  {QMI_CSD_IOCTL_VS_DEC_BUFFER_IND_V01, TYPE16(0, 104), 7},
  {QMI_CSD_AS_EVT_EOS_IND_V01, TYPE16(0, 227), 7},
  {QMI_CSD_AS_EVT_SPA_BUF_READY_IND_V01, TYPE16(0, 229), 4108},
  {QMI_CSD_AS_EVT_SR_CM_CHANGE_IND_V01, TYPE16(0, 228), 30},
  {QMI_CSD_AC_EVT_SPA_BUF_READY_IND_V01, TYPE16(0, 258), 4108}
};

/*Service Object*/
const struct qmi_idl_service_object csd_qmi_idl_service_object_v01 = {
  0x04,
  0x01,
  0x14,
  4108,
