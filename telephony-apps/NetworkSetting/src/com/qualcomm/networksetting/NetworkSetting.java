    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (ACTION_INCREMENTAL_NW_SCAN_IND.equals(intent.getAction())) {
                ...
                int subcription = intent.getIntExtra("sub_id",
                ...
                logd("on scanned result received, result:" + result + ", subscription:"
                        + subcription + ", scanInfo:" + (scanInfo == null ? 0 : scanInfo.length));
                if (subcription == mSubscription && mState == State.SCAN) {
        ...
        if (mState == State.IDLE) {
            ...
            new Handler(thread.getLooper()).post(new Runnable() {
                ...
                public void run() {
                    ...
                    clearNetworkList();
                    updateUIState();
                    boolean success = mQcRilHook.qcRilPerformIncrManualScan(mSubscription);
