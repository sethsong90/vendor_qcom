...
public class Element {
    static final String CONF_INFO = "conference-info";
    static final String CONF_STATE = "state";
    static final String CONF_VERSION = "version";
    static final String CONF_ENTITY = "entity";
    static final String CONF_DESC = "conference-description";
    static final String CONF_MAX_COUNT = "maximum-user-count";
    static final String CONF_USER = "user";
    static final String CONF_USERS = "users";
    static final String CONF_DISPLAY_TEXT = "display-text";
    static final String CONF_ASSOCIATED_AORS = "associated-aors";
    static final String CONF_URI = "uri";
    static final String CONF_ROLES = "roles";
    static final String CONF_ENDPOINT = "endpoint";
    static final String CONF_URIS = "conf_uris";
    static final String CONF_ENTRY = "entry";
    static final String CONF_REFERRED = "refrred";
    static final String CONF_JOINING_INFO = "joining-info";
    static final String CONF_DISC_INFO = "disconnection-info";
    static final String CONF_CALL_INFO = "call-info";
    static final String CONF_SUBJECT = "subject";
    static final String CONF_FREE_TEXT = "free-text";
    static final String CONF_KEYWORDS = "keywords";
    static final String CONF_PURPOSE = "purpose";
    static final String CONF_LANGUAGE = "languages";
    static final String CONF_STATUS = "status";
    static final String CONF_JOIN_METHOD = "joining-method";
    static final String CONF_DISC_METHOD = "disconnection-method";
    static final String CONF_WHEN = "when";
    static final String CONF_REASON = "reason";
    static final String CONF_BY = "by";
    static final String CONF_CALL_ID = "call-id";
    static final String CONF_FROM_TAG = "from-tag";
    static final String CONF_TO_TAG = "to-tag";
    static final String CONF_AVIL_MEDIA = "available-media";
    static final String HOST_INFO = "host-info";
    static final String STATE_PARTIAL = "partial";
    static final String STATE_DELETE = "delete";
    static final String STATE_FULL = "full";
    static final String STATE_INVALID = "invalid";
    static final String CONF_SIDEBAR_VALUE = "sidebars-by-val";
    static final String CONF_SIDEBAR_REF = "sidebars-by-ref";
    static final String CONF_MEDIA = "media";
    static final String CONF_ID = "id";
    static final String CONF_NA = "NotApplicable";
