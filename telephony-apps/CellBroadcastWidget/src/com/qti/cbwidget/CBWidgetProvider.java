...
public class CBWidgetProvider extends AppWidgetProvider {
    ...
    private static int sSubscription = MSimConstants.DEFAULT_SUBSCRIPTION;
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            if (TextUtils.isEmpty(sCBMessage)) {
                ...
                getLatestIntent.putExtra(MSimConstants.SUBSCRIPTION_KEY, sSubscription);
    ...
    protected void onReceiveWithPrivilege(Context context, Intent intent, boolean privileged) {
        ...
        isMSim = MSimTelephonyManager.getDefault().isMultiSimEnabled();
        sSubscription = MSimTelephonyManager.getDefault().getDefaultSubscription();
        ...
        if (action.equals("android.appwidget.action.APPWIDGET_DISABLED")) {
            ...
            if (privileged) {
                ...
                String country = "";
                if (isMSim) {
                    country = MSimTelephonyManager.getDefault().getSimCountryIso(
                            message.getSubId());
                } else {
