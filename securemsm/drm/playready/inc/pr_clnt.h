...
/********************************************************************************
  Protect or Unprotect Memory from HLOS

  @return
  Success or Failure

  @param[in]	  pBufStart        Physical start address of input content buffer
  @param[in]	  pBufEnd          Physical end address of input content buffer
  @param[in]	  bLock            TRUE - Lock   FALSE - Unlock
