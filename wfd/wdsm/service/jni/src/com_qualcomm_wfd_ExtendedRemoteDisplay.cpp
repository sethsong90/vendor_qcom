...
)
{
    ...
    return reinterpret_cast<jint>(pRD);
}
...
static JNINativeMethod gMethods[] = {
 // nameOfNativeMethod, methodSignature, methodPointer
    {"getNativeObject",  "()I",                      (void *)Java_com_qualcomm_wfd_ExtendedRemoteDisplay_getNativeObject},
    {"getSurface",       "(III)Landroid/view/Surface;",(void *)Java_com_qualcomm_wfd_ExtendedRemoteDisplay_getSurface},
    {"destroySurface",   "(ILandroid/view/Surface;)I",(void *)Java_com_qualcomm_wfd_ExtendedRemoteDisplay_destroySurface},
    {"destroyNativeObject", "(I)V",             (void *)Java_com_qualcomm_wfd_ExtendedRemoteDisplay_destroyNativeObject }
};
