...
static const int numSupportedCmds = (sizeof(supportedCmds) / sizeof(supportedCmds[0]));
...
static const int numRtspStatusCodes = (sizeof(rtspStatus) / sizeof(rtspStatus[0]));
...
public:
    ...
    void setRxCseq(unsigned short seq) { state.rxCseq = seq; }
