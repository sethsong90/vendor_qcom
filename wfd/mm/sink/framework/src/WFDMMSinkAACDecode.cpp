...
OMX_ERRORTYPE WFDMMSinkAACDecode::createResources()
{
    ...
    mhAACDec =  (int)aacDecoder_Open(TT_MP4_ADTS, 1);
...
OMX_ERRORTYPE WFDMMSinkAACDecode::Decode(OMX_BUFFERHEADERTYPE *pBuffer)
{
    ...
    */
    ...
    UCHAR* pInBuffer[1] = {pBuffer->pBuffer};
    UINT nSizes[1]      = {pBuffer->nFilledLen};
    UINT nOccupancy[1]  = {pBuffer->nFilledLen};
    ...
    */
    ...
    pBuffer->nFilledLen = ((CStreamInfo*)mpAACStreamInfo)->aacSamplesPerFrame
                           * 2 * mCfg.nChannels;
    WFDMMLOGD1("AudioDecoder DecodeFrame Success Size = %lu",
               pBuffer->nFilledLen);
