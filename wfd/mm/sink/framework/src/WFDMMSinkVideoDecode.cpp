...
/*            CmdType cmd;
    ...
    else if (eEvent == OMX_EventError)
    {
        ...
        cmd.eResult = (OMX_ERRORTYPE) nData1;
           ...
           (void*)((WFDMMSinkVideoDecode*) pAppData)->mClientData,
      ...
      OMX_IN OMX_BUFFERHEADERTYPE* pBuffer)
{
    ...
    OMX_ERRORTYPE result = OMX_ErrorNone;
    WFDMMLOGH2("WFDMMSinkVdec::FillDoneCallback Size = %lu, TS = %lu",
    ...
    */
    ...
    for(uint32 i = 0; i < mnNumInputBuffers; i++)
    {
        ...
        if (mhVdec)
        {
            ...
            WFDMMLOGE1("Popped InputBuffer %x", (unsigned int)pBuffer);
            /*------------------------------------------------------------------
...
bool WFDMMSinkVideoDecode::HandlePortReconfig()
{
    ...
    WFDMMLOGH2("AFter Port Change Height %lu Width %lu",
