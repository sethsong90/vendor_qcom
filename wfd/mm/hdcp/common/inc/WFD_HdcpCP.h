...
#define VIDEO_STREAMID   32
#define AUDIO_STREAMID   33
...
public:
  ...
  WFD_HDCP_DEVICETYPE       m_eDeviceType;
  unsigned char             m_ucHDCPVersion;
