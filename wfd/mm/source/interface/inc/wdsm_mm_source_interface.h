...
WFD_status_t wfd_mm_set_framerate_source(WFD_MM_HANDLE hHandle,uint32 nFrameRate);
WFD_status_t wfd_mm_set_bitrate_source(WFD_MM_HANDLE hHandle, uint32 nBitRate);
...
WFD_status_t wfd_mm_create_hdcp_session_source(WFD_MM_capability_t* pMMCfg_local,WFD_MM_capability_t* pMMCfg_remote,WFD_MM_capability_t* pMMCfg_negotiated );
#ifdef __cplusplus
}
#endif
