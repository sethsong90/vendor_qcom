 ...
 if((pMMCfg_negotiated))
 {
    ...
    /* This code  can be used to override negotiated capability from file */
    {
      ...
      if(pMMCfg_negotiated->audio_method == WFD_AUDIO_AAC)
      {
         ...
         pMMCfg_negotiated->audio_config.aac_codec.supported_modes_bitmap =  negValue ? ( 1 <<  (negValue - 1) ) : 0 ;
      }
       ...
       for(int remIdx = 0 ; remIdx < pMMCfg_remote->video_config.video_config.num_h264_profiles; remIdx ++)
       {
         ...
         (pMMCfg_common->video_config.video_config.h264_codec[comIdx]).supported_cea_mode =
          ...
          if((pMMCfg_common->video_config.video_config.h264_codec[comIdx]).supported_cea_mode)
          {
              ...
              MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_MEDIUM,"nego alog ,nego cea value = %ld ceaIndexValue = %d",
         ...
         // VESA mode
          ...
          if((pMMCfg_common->video_config.video_config.h264_codec[comIdx]).supported_vesa_mode)
          {
              ...
              MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_MEDIUM,"nego alog ,commom vesa value = %ld vesaIndexValue = %d",
        ...
        // HH mode
           ...
           if((pMMCfg_common->video_config.video_config.h264_codec[comIdx]).supported_hh_mode)
           {
              ...
              MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_MEDIUM,"nego alog ,commom hh value = %ld hhIndexValue = %d",
              ...
              ((pMMCfg_local->video_config.video_config.h264_codec[locIdx]).frame_rate_control_support & 0x1) )
           {
             ...
             (pMMCfg_common->video_config.video_config.h264_codec[comIdx]).frame_rate_control_support = (((uMinFrameSkipInterval << 1)| 0x1) & 0xF );
           }
           ...
           if(ceaModeWeight < vesaModeWeight && ceaModeWeight < hhModeWeight)
           {
              ...
              (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_hh_mode = 0 ;
               MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_MEDIUM,"nego alog video format cea = %ld",
           ...
           else if(vesaModeWeight < ceaModeWeight && vesaModeWeight < hhModeWeight)
           {
              ...
              (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_hh_mode = 0 ;
               MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_MEDIUM,"nego alog video format ves = %ld",
           ...
           else if(hhModeWeight < ceaModeWeight && hhModeWeight < vesaModeWeight)
           {
              ...
              (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_hh_mode = ( 1 << hhIndexValue ) ;
               MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_MEDIUM,"nego alog video format hh = %ld",               
     ...
     (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).slice_enc_params = 0;
      ...
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "local capabilty (pMMCfg_local->video_config.video_config.h264_codec[0]).supported_cea_mode = %ld", (pMMCfg_local->video_config.video_config.h264_codec[0]).supported_cea_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "local capabilty (pMMCfg_local->video_config.video_config.h264_codec[0]).supported_vesa_mode = %ld", (pMMCfg_local->video_config.video_config.h264_codec[0]).supported_vesa_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "local capabilty (pMMCfg_local->video_config.video_config.h264_codec[0]).supported_hh_mode = %ld", (pMMCfg_local->video_config.video_config.h264_codec[0]).supported_hh_mode);
      ...
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "remote capabilty (pMMCfg_remote->video_config.video_config.h264_codec[0]).supported_cea_mode = %ld", (pMMCfg_remote->video_config.video_config.h264_codec[0]).supported_cea_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "remote capabilty (pMMCfg_remote->video_config.video_config.h264_codec[0]).supported_vesa_mode = %ld", (pMMCfg_remote->video_config.video_config.h264_codec[0]).supported_vesa_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "remote capabilty (pMMCfg_remote->video_config.video_config.h264_codec[0]).supported_hh_mode = %ld", (pMMCfg_remote->video_config.video_config.h264_codec[0]).supported_hh_mode);
      ...
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "negotiated capabilty (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_cea_mode = %ld", (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_cea_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "negotiated capabilty (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_vesa_mode = %ld", (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_vesa_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "negotiated capabilty (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_hh_mode = %ld", (pMMCfg_negotiated->video_config.video_config.h264_codec[0]).supported_hh_mode);
      ...
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "common capabilty (pMMCfg_common->video_config.video_config.h264_codec[0]).supported_cea_mode = %ld", (pMMCfg_common->video_config.video_config.h264_codec[0]).supported_cea_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "common capabilty (pMMCfg_common->video_config.video_config.h264_codec[0]).supported_vesa_mode = %ld", (pMMCfg_common->video_config.video_config.h264_codec[0]).supported_vesa_mode);
      MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_DEBUG, "common capabilty (pMMCfg_common->video_config.video_config.h264_codec[0]).supported_hh_mode = %ld", (pMMCfg_common->video_config.video_config.h264_codec[0]).supported_hh_mode);
...
/** @brief set the bit rate at source
  ...
  * @return  WFD_status_t - status
  */
WFD_status_t wfd_mm_set_bitrate_source(WFD_MM_HANDLE handle, OMX_U32 nBitRate)
{
...
/** @brief set the frame rate at source
  ...
  * @return  WFD_status_t - status
  */
WFD_status_t wfd_mm_set_framerate_source(WFD_MM_HANDLE handle, OMX_U32 nFrameRate)
{
...
WFD_status_t wfd_mm_create_hdcp_session_source(WFD_MM_capability_t* pMMCfg_local, 
                                               WFD_MM_capability_t* pMMCfg_remote,
                                               WFD_MM_capability_t* pMMCfg_negotiated )
{
  ...
  */
    ...
    if(nRetVal == 0)
    {
      uEncryptAudioStream = nEncryptAudioDecision ? AUDIO_STREAMID : OMX_FALSE;
    }

    MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_HIGH,
                     "wfd_mm_create_hdcp_session_source: Audio Encryption Flag m_bEncryptFlag = %d",
  ...
  // Create a HDCP Session heare itself.
    ...
    *-------------------------------------------------------------------------*/
           ...
           (pMMCfg_remote->content_protection_config.content_protection_capability <= (uint8)WFD_HDCP_VERSION_MAX)))
    {
      ...
      MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_HIGH,
                  "Peer IpAddr is =%ld  Hdcp Ctrl Port=%d", 
      ...
      pMMCfg_negotiated->HdcpCtx.hHDCPSession = (CWFD_HdcpCp*)new CWFD_HdcpCp(NULL, 
                                  pMMCfg_remote->peer_ip_addrs.ipv4_addr1,
                                  pMMCfg_remote->content_protection_config.content_protection_ake_port,
                                  VIDEO_STREAMID/*STREAM_VIDEO*/,
                                  uEncryptAudioStream, /*STREAM_AUDIO*/
                                  SOURCE_DEVICE,
