...
wfdmmsource_item* wfdmmsourcequeue::Pop_Front()
{
  ...
  MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_ERROR, "wfdmmsourcequeue::Pop_Front before read Queue size is %d  read index is %i",m_nSize, m_nRead);
  ...
  MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_ERROR, "wfdmmsourcequeue::Pop_Front after read Queue size is %d  read index is %i",m_nSize, m_nRead);
