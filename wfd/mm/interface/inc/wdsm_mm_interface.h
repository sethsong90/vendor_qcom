...
#define		DOLBY_DIGITAL_48_16_2_EAC3	BIT3
#define		DOLBY_DIGITAL_48_16_4_EAC3	BIT4
#define		DOLBY_DIGITAL_48_16_6_EAC3	BIT5
#define		DOLBY_DIGITAL_48_16_8_EAC3	BIT6
...
/** @brief
  ...
  * @return  WFD_status_t - status
  */
WFD_status_t wfd_mm_create_HDCP_session( WFD_device_t, 
                                         WFD_MM_capability_t*,
                                         WFD_MM_capability_t*,
                                         WFD_MM_capability_t*);
