...
public:
  ...
  virtual void getUibcCapability(WFD_uibc_capability_t* pCapability) {}
  ...
  virtual bool sendUIBCEvent (WFD_uibc_event_t* event){return false;}
  virtual bool readUIBCCfgCapability(WFD_uibc_capability_t* pUibcCapability){return false;}
};
#endif
