...
int setResolution (int type, int value, int *resParams = NULL);
...
void eventMMUpdate (MMEventType, MMEventStatusType, int, int, int evtData3 = 0);
int getResolution(short int*, short int*);
