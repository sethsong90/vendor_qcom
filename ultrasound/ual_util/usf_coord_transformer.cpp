 ...
 * @param trans_props the transformation properties
 */
static void get_rotated_point(Vector &point,
                              ...
                              transformation_properties off_screen_trans_prop)
{
  ...
  */
  ...
  get_rotated_point(on_trans_point,
                    on_screen_trans_prop);

  zone_t on_screen_zone = get_zone(on_trans_point,
                                   on_screen_trans_prop);
  ...
  else
  {
    ...
    get_rotated_point(off_trans_point,
                      off_screen_trans_prop);
    zone_t off_screen_zone = get_zone(off_trans_point,
                                      off_screen_trans_prop);
 ...
 * See function definition above.
 */
void get_rotated_point(Vector &point,
                       const transformation_properties &trans_props)
{
