                                          ...
                                          us_all_info* paramsStruct)
{
  ...
  memcpy(tx_ports_cpy,
         paramsStruct->usf_tx_ports,
         FILE_PATH_MAX_LEN);
  uint8_t parsedTxPorts[FILE_PATH_MAX_LEN];
  // Separating tx ports
                                            ...
                                            char *cfg_file_name)
{
  ...
  on_origin = paramsStruct->usf_epos_on_screen_transform_origin;
  on_end_x = paramsStruct->usf_epos_on_screen_transform_end_X;
  on_end_y = paramsStruct->usf_epos_on_screen_transform_end_Y;
                                        ...
                                        us_all_info* paramsStruct)
{
  ...
  if (0 == strcmp(daemonName,"digitalpen") &&
      (0 != usf_dependencies_check_transformation(paramsStruct->usf_epos_on_screen_transform_origin,
                                                  paramsStruct->usf_epos_on_screen_transform_end_X,
                                                  paramsStruct->usf_epos_on_screen_transform_end_Y,
                                                  "usf_epos_on_screen_transform",
                                                  cfgFileName) ||
                                        ...
                                        us_all_info* paramsStruct)
{
  ...
  // usf_tx_port_data_size
  if (TX_DATA_FORMAT3 != paramsStruct->usf_tx_data_format &&
