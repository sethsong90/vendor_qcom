...
typedef struct {
    ...
    char usf_epos_on_screen_transform_origin[FILE_PATH_MAX_LEN];
    char usf_epos_on_screen_transform_end_X[FILE_PATH_MAX_LEN];
    char usf_epos_on_screen_transform_end_Y[FILE_PATH_MAX_LEN];
    ...
    // Private Pairing
    char usf_pairing_socket_path[FILE_PATH_MAX_LEN];
    uint32_t usf_pairing_max_aquisition_time;
    uint32_t usf_pairing_num_series_calib_files;
