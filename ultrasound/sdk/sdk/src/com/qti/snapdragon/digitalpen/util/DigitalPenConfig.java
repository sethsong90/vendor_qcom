...
// TODO: OEM sends portrait side, but service should send 3x3 plane to daemon
public class DigitalPenConfig implements Parcelable {
    ...
    private final OffScreen mOffScreen = new OffScreen();
    private final Hover mOnScreenHover = new Hover();
    private final Hover mOffScreenHover = new Hover();
    ...
    private final EraseButton mEraseButton = new EraseButton();
    ...
    public DigitalPenConfig() {
        ...
        mOffScreen.mode = DP_OFF_SCREEN_MODE_DISABLED;
        mOffScreen.smarterStand = true;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(mOffScreen.smarterStand ? 1 : 0);
        ...
        out.writeInt(mEraseButton.mode);
    }
    ...
    private DigitalPenConfig(Parcel in) {
        ...
        mOffScreen.smarterStand = (in.readInt() == 1);
    ...
    public DigitalPenConfig setSmarterStand(boolean enable) {
        mOffScreen.smarterStand = enable;
        return this;
    }

    public boolean isSmarterStandEnabled() {
        return mOffScreen.smarterStand;
    }
    ...
    public byte[] marshalForDaemon() {
        ...
        msg
                .put(getOffScreenMode())
                .putInt(getTouchRange())
                .put(getPowerSave())
                .putInt(getOnScreenHoverMaxRange())
                .put((byte) (isOnScreenHoverEnabled() ? 1 : 0))
                .put((byte) (isShowingOnScreenHoverIcon() ? 1 : 0))
                .putInt(getOffScreenHoverMaxRange())
                .put((byte) (isOffScreenHoverEnabled() ? 1 : 0))
                .put((byte) (isSmarterStandEnabled() ? 1 : 0))
                ...
                .putInt(getEraseButtonIndex())
                .put(getEraseButtonMode());
