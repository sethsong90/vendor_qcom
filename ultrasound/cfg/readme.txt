...
req_buttons_bitmap       -       A bitmap with the stylus buttons to use.
                                 [1] - use library's switch 2 output.
                                 [2] - use library's switch 1 output.
...
usf_epos_on_screen_transform_origin      -       On-screen plane origin in mm (x0,y0,z0)
...
usf_epos_on_screen_transform_end_X       -       On-screen plane end of x axis (x1,y1,z1).
                                                 This is the offset from EPOS origin.
                                                 Please see above description.
usf_epos_on_screen_transform_end_Y       -       On-screen plane end of y axis (x2,y2,z2).
                                                 This is the offset from EPOS origin.
                                                 Please see above description.
...
usf_epos_zero_angle_thres                -       This is the threshold for treating the angle as zero.
                                                 ...
                                                 0 < angle < 0 + thres OR 180 > angle > 180 - thres
