...
virtual MUX_STATUS MUX_write_header (uint32 audio_str, uint32 audio_header_size, const uint8 *audio_header){return MUX_SUCCESS;};
...
/*!
   ...
   @param[in]  stream_number - Steram type can be either audio/video/text/data
    ...
    @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_write_footer (uint32 stream_num, uint32 footer_length, const uint8 *buf_ptr){return MUX_SUCCESS;};
/*!
   ...
   @param[in]  stream_number - Steram type can be either audio/video/text/data
    ...
    @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_write_header_text (uint32 stream_num, const MUX_text_type_t *entry){return MUX_SUCCESS;};
/*!
   ...
   @param[in]  stream_number - Steram type can be either audio/video/text/data
    ...
    @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_write_text (uint32 stream_num, void * handle, uint32 delta){return MUX_SUCCESS;};
...
/*!
   ...
   @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_write_uuid (const uint8 *uuid, const void *data, uint32 size){return MUX_SUCCESS;};
...
/*!
   ...
   @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_write_user_meta_data(const void * pdata, uint32 nsize){return MUX_SUCCESS;};
/*!
...
/*!
   ...
   @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_update_streamport(uint32 port){return MUX_SUCCESS;};
...
/*!
   ...
   @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_modify_user_atoms (MUX_user_data_type *puser_data, void  *handle){return MUX_SUCCESS;};
