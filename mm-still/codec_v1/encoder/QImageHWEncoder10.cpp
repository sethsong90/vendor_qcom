...
int QImageHW10Encoder::ConfigureInputBuffer()
{
  ...
  if (mInputImage->PlaneCount() == 1) {
    ...
    lJpegBuf.y_off = mInputImage->getPlane(QIPlane::PLANE_Y)->Offset();
    ...
    lBufferlength = mInputImage->getPlane(QIPlane::PLANE_CB_CR)->PhyOffset() +
      mInSize[IC].Length();
    lJpegBuf.y_len = mInputImage->getPlane(QIPlane::PLANE_CB_CR)->PhyOffset();
    lJpegBuf.y_off = mInputImage->getPlane(QIPlane::PLANE_Y)->Offset();
    lJpegBuf.cbcr_len = mInSize[IC].Length();
    lJpegBuf.cbcr_off = mInputImage->getPlane(QIPlane::PLANE_CB_CR)->Offset();
    ...
    lJpegBuf.cbcr_off = mInputImage->getPlane(QIPlane::PLANE_CB)->Offset();
    lJpegBuf.cr_len = mInSize[IC2].Length();
    lJpegBuf.cr_offset = mInputImage->getPlane(QIPlane::PLANE_CR)->Offset();
  } else {
  ...
  if (mInputImage->getPlane(QIPlane::PLANE_Y)->Fd() > 0) {
    lJpegBuf.vaddr = mInputImage->getPlane(QIPlane::PLANE_Y)->Addr();
    lJpegBuf.fd = mInputImage->getPlane(QIPlane::PLANE_Y)->Fd();
  } else {
