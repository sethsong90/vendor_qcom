...
extern jpege_engine_profile_t jpege_engine_sw_profile;
...
** up to 2^(32-POLYPHASE_ACCUM_Q_BITS)
** ----------------------------------------------------------------------- */
#define POLYPHASE_ACCUM_Q_BITS 17     // for quant of accumulator

#define POLYPHASE_FILTER_COEFFS 32*4  // 4-tap 32 polyphase filter

#define POLYPHASE_FILTER_TAP 4        // tap is 4

#define MAX_UPSCALE_FACTOR 8          // support up to 8x upscale
