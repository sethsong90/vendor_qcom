	...
	uint32_t       rotation)
{
	...
	p_scale_up->vert_luma_row_index = 0;
    p_scale_up->vert_chroma_row_index = 0;
    /*------------------------------------------------------------
    ...
    uint32_t  rotated_mcu_height)
{
	...
	uint32_t  vert_luma_row_index = p_scale_up->vert_luma_row_index;
	uint32_t  vert_luma_row_init = p_scale_up->vert_luma_row_index;
	uint32_t  vert_chroma_row_index = p_scale_up->vert_chroma_row_index;
    ...
    p_scale_up->vert_luma_row_index = vert_luma_row_index;
    p_scale_up->vert_chroma_row_index = vert_chroma_row_index;
