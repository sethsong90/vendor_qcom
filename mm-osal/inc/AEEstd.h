...
//String functions
extern int           std_strlen(const char* s1);
...
// Mem functions
extern int           std_memcmp(const void* p1, const void* p2, int n);
extern void*         std_memset(void* s, int c, int n);
extern void *        std_memmove(void* s, const void* c, int n);
