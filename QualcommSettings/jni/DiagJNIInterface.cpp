...
const char *kInterfacePath = "com/qualcomm/qualcommsettings/DiagJNIInterface";
const char *kDataPath = "com/qualcomm/qualcommsettings/DiagCommand";

/* Subsystem command codes for the test app  */
#define DIAG_TEST_APP_MT_NO_SUBSYS    143
#define DIAG_SUBSYS_TEST_CLIENT_MT     11  /* @@REVIEW - 29 for mode reset */
...
extern "C" {
    ...
    static void diag_callback_handler(char *s) {
        int jniError;
        JNIEnv *env;
    ...
    JNIEXPORT void JNICALL Java_com_qualcomm_qualcommsettings_DiagJNIInterface_getNextCommand
        ...
        JNINativeMethod methods[] = {
            {
                "getNextCommand",
                "()V",
                (void *) Java_com_qualcomm_qualcommsettings_DiagJNIInterface_getNextCommand
            },
        };
