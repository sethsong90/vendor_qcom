...
soc_setup()
{
  if [ "x$1" = "x8660" ]; then
    ...
    # Clocks that are voteable: they might not turn off when disabled.
    voteable_clocks="gcc_boot_rom_ahb_clk
		     gcc_prng_ahb_clk
		     gcc_bam_dma_ahb_clk
		     gcc_blsp1_ahb_clk
		     gcc_blsp2_ahb_clk
    ...
    # Clocks that should not be tested
    blacklist="cxo_clk_src cxo_a_clk_src
	       qdss_clk qdss_a_clk
	       snoc_clk snoc_a_clk
	       pnoc_clk pnoc_a_clk
	       cnoc_clk cnoc_a_clk
	       ...
	       analog_postdiv_clk byte_clk_src byte_mux
	       dsi_vco_clk indirect_path_div2_clk pixel_clk_src
	       ...
	       mdss_edppixel_clk mdss_byte0_clk mdss_byte1_clk mdss_edplink_clk
	       mdss_pclk0_clk mdss_pclk1_clk
	       krait0_m_clk krait1_m_clk krait2_m_clk krait3_m_clk l2_m_clk
	       gcc_lpass_q6_axi_clk mdss_extpclk_clk
	       cxo_otg_clk cxo_pil_lpass_clk cxo_pil_mss_clk cxo_wlan_clk
	       cxo_pil_pronto_clk cxo_dwc3_clk cxo_ehci_host_clk
	       q6ss_ahbm_clk
