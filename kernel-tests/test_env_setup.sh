################################################################################
# Copyright (c) 2009-2011,2013 Qualcomm Technologies, Inc.  All Rights Reserved.
...
target_lists="7X27 7X30 8650B 8650D 8660 8960 9x15 8974 9x25 8x10 8910 8610 8226 8x26 8926 8026 8084 msmsamarium 8x62"

if [ -e /sys/devices/soc0/build_id ]; then
    build_id=`cat /sys/devices/soc0/build_id`
elif [ -e /sys/devices/system/soc/soc0/build_id ]; then
