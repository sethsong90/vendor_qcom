...
Pass *createReplaceLibCallVersionsPass();
...
//
FunctionPass *createGVNPass(bool NoPre, bool NoLoads);
...
Pass *createPostIncrementPass();

Pass *createPartialLICMPass();

Pass *createLoopIndexOffsetPass();

Pass *createTypePromotionPass();

Pass *createEnableBaseOffsetPass();
...
//===----------------------------------------------------------------------===//
//
// LoopLocalizeGlobalsPass - Localize global variables.
//
Pass *createLoopLocalizeGlobalsPass();

//===----------------------------------------------------------------------===//
//
// OptInitGlobalsPass - Optimize function static variables initialized in the
// function prologue.
//
Pass *createOptInitGlobalsPass();

//===----------------------------------------------------------------------===//
//
// OptInitGlobalsMFPass - Optimize file static variables inside a function by
// saving and restoring it before and after function calls.
//
Pass *createOptInitGlobalsMFPass();
...
// TailDuplicationPass - Perform tail duplication on constant phi nodes.
FunctionPass *createTailDuplicationPass();

// SelectConversionPass - Convert conditional indirect stores to "select" form.
FunctionPass *createSelectConversionPass();

FunctionPass *createFactorizeExpressionsPass();

FunctionPass *createPrecomputeLoopExpressionsPass();
