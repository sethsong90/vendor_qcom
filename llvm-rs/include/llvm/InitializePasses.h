...
void initializeFactorizeExpressionsPass(PassRegistry&);
...
void initializeMachineGCHPass(PassRegistry&);
...
void initializePrecomputeLoopExpressionsPass(PassRegistry&);
...
void initializeSelectConversionPass(PassRegistry&);
...
void initializeLoopLocalizeGlobalsPass(PassRegistry&);
void initializeOptInitGlobalsPass(PassRegistry&);
void initializeOptInitGlobalsMFPass(PassRegistry&);
void initializeEnableBaseOffsetPass(PassRegistry&);
void initializePartialLICMPass(PassRegistry&);
void initializePostIncrementPass(PassRegistry&);
void initializeLoopIndexOffsetPass(PassRegistry&);
void initializeTypePromotionPass(PassRegistry&);
void initializeUnpackMachineBundlesPass(PassRegistry&);
void initializeFinalizeMachineBundlesPass(PassRegistry&);
void initializeBBVectorizePass(PassRegistry&);
void initializeTailDuplicationPass(PassRegistry&);
}
