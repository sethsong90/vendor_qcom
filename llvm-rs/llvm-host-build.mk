...
LOCAL_C_INCLUDES :=	\
	...
	$(LLVM_ROOT_PATH)/android_config/host/include	\
	$(LLVM_ROOT_PATH)/include/llvm/TableGen \
	$(LOCAL_C_INCLUDES) 
...
$(hide) $(TBLGEN) \
	...
	-I $(LLVM_ROOT_PATH)/android_config/host/include	\
	-I $(LLVM_ROOT_PATH)/lib/Target	\
	$(if $(strip $(CLANG_ROOT_PATH)),-I $(CLANG_ROOT_PATH)/include,)	\
	-gen-$(strip $(1))	\
	-o $@ $<
endef
define transform-host-clangtd-to-out
@mkdir -p $(dir $@)
@echo "Host TableGen: $(LOCAL_MODULE) (gen-$(1)) <= $<"
$(hide) $(CLANG_TBLGEN) \
	-I $(dir $<)	\
