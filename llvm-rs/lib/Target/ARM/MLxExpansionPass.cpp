...
namespace {
  ...
  private:
    ...
    bool isA9Or8K; // ARM cortex-a9, QCOM 8K processors scorpion and krait
    unsigned MIIdx;
...
bool MLxExpansion::FindMLxHazard(MachineInstr *MI) {
  ...
  unsigned Limit1 = isA9Or8K ? 1 : 4;
  unsigned Limit2 = isA9Or8K ? 1 : 4;
...
bool MLxExpansion::runOnMachineFunction(MachineFunction &Fn) {
  ...
  isA9Or8K = (STI->isCortexA9() || STI->isScorpion() || STI->isKrait());
