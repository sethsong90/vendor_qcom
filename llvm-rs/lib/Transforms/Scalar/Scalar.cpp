...
void llvm::initializeScalarOpts(PassRegistry &Registry) {
  ...
  initializeFactorizeExpressionsPass(Registry);
  ...
  initializePrecomputeLoopExpressionsPass(Registry);
  initializeReassociatePass(Registry);
  initializeRegToMemPass(Registry);
  initializeSCCPPass(Registry);
  initializeSelectConversionPass(Registry);
  ...
  initializeTailDuplicationPass(Registry);
}
...
void LLVMAddSelectConversionPass(LLVMPassManagerRef PM) {
  unwrap(PM)->add(createSelectConversionPass());
}

void LLVMAddFactorizeExpressionsPass(LLVMPassManagerRef PM) {
  unwrap(PM)->add(createFactorizeExpressionsPass());
}

void LLVMAddPrecomputeLoopExpressionsPass(LLVMPassManagerRef PM) {
  unwrap(PM)->add(createPrecomputeLoopExpressionsPass());
}
