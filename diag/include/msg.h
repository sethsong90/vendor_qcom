...
// Added for Linux
#elif defined (T_WINNT) || defined (TARGET_UNIX) || defined (FEATURE_WINCE) || defined (__GNUC__)
...
---------------------------------------------------------------------------*/
  ...
  #define XX_MSG_CONST_SAVE(xx_ss_id, xx_ss_mask, xx_fmt, do_save) \
    static msg_const_type xx_msg_const = { \
      {0, (xx_ss_id), (xx_ss_mask)}, (xx_fmt), msg_file, do_save}; \
      xx_msg_const.desc.line = __LINE__
  ...
  #define XX_MSG_CONST_SAVE(xx_ss_id, xx_ss_mask, xx_fmt, do_save) \
    ...
    #define XX_MSG_CONST(xx_ss_id, xx_ss_mask, xx_fmt) \
    static msg_const_type xx_msg_const = { \
      {0, (xx_ss_id), (xx_ss_mask)}, (xx_fmt), msg_file}; \
      xx_msg_const.desc.line = __LINE__
  #else
