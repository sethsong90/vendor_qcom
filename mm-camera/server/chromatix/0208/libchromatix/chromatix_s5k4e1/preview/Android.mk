S5K4E1_CHROMATIX_PREVIEW_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(S5K4E1_CHROMATIX_PREVIEW_PATH)
...
#LOCAL_C_INCLUDES += chromatix_s5k4e1_preview.h

LOCAL_SRC_FILES:= chromatix_s5k4e1_preview.c

LOCAL_MODULE           := libchromatix_s5k4e1_preview
