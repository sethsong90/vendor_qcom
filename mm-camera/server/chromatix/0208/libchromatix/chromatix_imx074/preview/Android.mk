IMX074_CHROMATIX_PREVIEW_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX074_CHROMATIX_PREVIEW_PATH)
...
LOCAL_SRC_FILES:= chromatix_imx074_preview.c

LOCAL_MODULE           := libchromatix_imx074_preview
