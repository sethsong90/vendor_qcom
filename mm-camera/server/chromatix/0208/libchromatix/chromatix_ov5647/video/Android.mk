OV5647_CHROMATIX_VIDEO_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(OV5647_CHROMATIX_VIDEO_PATH)
...
LOCAL_C_INCLUDES += chromatix_ov5647_video.h

LOCAL_SRC_FILES:= chromatix_ov5647_video.c

LOCAL_MODULE           := libchromatix_ov5647_default_video
