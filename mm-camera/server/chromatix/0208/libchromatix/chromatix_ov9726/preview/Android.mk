OV9726_CHROMATIX_PREVIEW_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#                      Make the shared library (libchromatix_ov9726_preview)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(OV9726_CHROMATIX_PREVIEW_PATH)
...
LOCAL_C_INCLUDES += chromatix_ov9726_preview.h

LOCAL_SRC_FILES:= chromatix_ov9726_preview.c

LOCAL_MODULE           := libchromatix_ov9726_preview
