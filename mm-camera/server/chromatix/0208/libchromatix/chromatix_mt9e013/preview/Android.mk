MT9E013_CHROMATIX_PREVIEW_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(MT9E013_CHROMATIX_PREVIEW_PATH)
...
LOCAL_C_INCLUDES += chromatix_mt9e013_preview.h

LOCAL_SRC_FILES:= chromatix_mt9e013_preview.c

LOCAL_MODULE           := libchromatix_mt9e013_preview
