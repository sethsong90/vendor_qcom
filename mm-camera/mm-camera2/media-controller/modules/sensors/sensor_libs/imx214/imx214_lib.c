...
static msm_sensor_dimension_t imx214_scale_size_tbl[] = {
  {3200, 2400},
};
...
static struct sensor_lib_out_info_t sensor_out_info[] = {
  {/* 20 fps full size settings */
    .x_output = 4208,
    .y_output = 3120,
    .line_length_pclk = 5008,
    .frame_length_lines = 3160,
...
static struct sensor_meta_data_out_info_t sensor_meta_data_out_info[] = {
  {
    ...
    .width  = 4208,
    .height = 2,
    .fmt = 0,   /* CAM_FORMAT_META_RAW_8BIT */
    //.stats_type = YYYY,
  },
};
...
static struct sensor_lib_chromatix_t imx214_chromatix[] = {
  {
    ...
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES0 */
  ...
  },
  {
    ...
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(default_video), /* RES2 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(liveshot), /* RES2 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(hfr_120fps), /* RES3 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(hfr_120fps), /* RES3 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(hfr_120fps), /* RES3 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(liveshot), /* RES3 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(video_hdr), /* RES4 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(video_hdr), /* RES4 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(video_hdr), /* RES4 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(video_hdr), /* RES4 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(snapshot_hdr), /* RES5 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(snapshot_hdr), /* RES5 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(snapshot_hdr), /* RES5 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(snapshot_hdr), /* RES5 */
  },
};
  ...
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  ...
  float sensor_real_gain = imx214_register_to_real_gain(exp_info->reg_gain);
...
static sensor_video_hdr_table_t imx214_video_hdr_tbl = {
  ...
  .awb_table_size = 2,
  .video_hdr_capability = 0x100 | 0x1000,
};
#endif
...
#else
  .video_hdr_awb_lsc_func_table = NULL,
#endif
  /* chromatix array */
