OV8865_QTECH_SENSOR_LIBS_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(OV8865_QTECH_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= ov8865_qtech_f8865ac_lib.c
LOCAL_MODULE           := libmmcamera_ov8865_qtech
