...
static struct sensor_lib_chromatix_t ov2720_chromatix[] = {
  ...
  {
    .common_chromatix = OV2720_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV2720_LOAD_CHROMATIX(preview), /* RES1 */
    .camera_snapshot_chromatix = OV2720_LOAD_CHROMATIX(preview), /* RES1 */
    .camcorder_chromatix = OV2720_LOAD_CHROMATIX(default_video), /* RES1 */
  ...
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  ...
  float sensor_real_gain = ov2720_register_to_real_gain(exp_info->reg_gain);
