...
#define SENSOR_MODEL_NO_s5k4e1 "SKUAB_ST_s5k4e1"
...
static struct msm_camera_i2c_reg_array res2_reg_array[] = {
	...
	{0x034C, 0x02},/* x_output size */
	{0x034D, 0x80},
	{0x034E, 0x01},/* y_output size */
	{0x034F, 0xE0},
...
static struct sensor_lib_chromatix_t s5k4e1_chromatix[] = {
  ...
  {
    .common_chromatix = s5k4e1_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = s5k4e1_LOAD_CHROMATIX(hfr_60fps), /* RES2 */
    .camera_snapshot_chromatix = s5k4e1_LOAD_CHROMATIX(hfr_60fps), /* RES2 */
    .camcorder_chromatix = s5k4e1_LOAD_CHROMATIX(hfr_60fps), /* RES2 */
    .liveshot_chromatix = s5k4e1_LOAD_CHROMATIX(liveshot), /* RES2 */
  },
};
  ...
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  ...
  float sensor_real_gain = s5k4e1_register_to_real_gain(exp_info->reg_gain);
...
/*===========================================================================
 * FUNCTION    - SKUAB_ST_s5k4e1_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *SKUAB_ST_s5k4e1_open_lib(void)
{
