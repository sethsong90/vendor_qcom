...
static msm_sensor_dimension_t skuf_ov5648_p5v23c_scale_size_tbl[] = {
  {3200, 2400},
};
...
static int32_t skuf_ov5648_p5v23c_get_scale_tbl(msm_sensor_dimension_t * tbl)
{
  int i;
  if(sensor_lib_ptr.scale_tbl_cnt == 0)
    return -1;
  for(i = 0; i < sensor_lib_ptr.scale_tbl_cnt; i++){
    tbl[i] = skuf_ov5648_p5v23c_scale_size_tbl[i];
  }
  return 0;
}
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  .scale_tbl_cnt = ARRAY_SIZE(skuf_ov5648_p5v23c_scale_size_tbl),
  /* function to get scale size tbl*/
  .get_scale_tbl = skuf_ov5648_p5v23c_get_scale_tbl, 
};
