...
static struct sensor_lib_out_info_t sensor_out_info[] = {
  ...
  { /* For SNAPSHOT */
	.x_output = 0xC80,  // 1600*2 = 0x640 *2 = 0xC80, for 2Mp
...
//by wangpl, set platform vfe clk. need >= camera, for preview
    .x_output = 0x500, //640 x2
    .y_output = 0x1E0, //480
    .line_length_pclk = 2236, //
    .frame_length_lines = 644, // AD_18M  AD_LINE=1118  N=161
...
void *gc2035_open_lib(void)
{
    ALOGE("=====>in [gc2035_open_lib]\n");
