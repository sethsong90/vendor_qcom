...
static struct sensor_pix_fmt_info_t ov2685_pix_fmt1_fourcc[] = {
  { MSM_V4L2_PIX_FMT_META },
};

static sensor_stream_info_t ov2685_stream_info[] = {
  {1, &ov2685_cid_cfg[0], ov2685_pix_fmt0_fourcc},
  {1, &ov2685_cid_cfg[1], ov2685_pix_fmt1_fourcc},
};
...
static struct sensor_lib_out_info_t sensor_out_info[] = {
  ...
  },
  {
    ...
    .x_output = 0x320*2,
    .y_output = 0x258,
    .line_length_pclk = 0x320*2, /* 800 */
    .frame_length_lines = 0x258, /* 600 */
    .vt_pixel_clk = 28800000,
    .op_pixel_clk = 80000000,
    .binning_factor = 1,
    .max_fps = 30.0,
