IMX188_LITEON_13P_SENSOR_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#                      Make the shared library (libmmcamera_imx188_liteon_13p)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(IMX188_LITEON_13P_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= imx188_liteon_13p_lib.c
LOCAL_MODULE           := libmmcamera_imx188_liteon_13p
