...
/******************************************************************************/
         ...
         /* Reference Noise */
         {
            /* Noise Profile 1 */
            {
               ...
               {
                  1.3*0.940126f, 1.3*1.739671f, 3.636830f, 6.265405f, 1.3*0.525270f, 1.3*0.823489f, 2.769490f, 4.497624f,
            ...
            /* Noise Profile 2 */
            {
               2.880000f, /* Trigger Value */
               {
                  1.5*1.555621f, 1.5*2.694127f, 5.584493f, 8.225087f, 1.5*0.855522f, 1.5*1.358061f, 4.232477f, 6.474411f,
               ...
               /* Denoise Weight Y */
               {
                  0.000000f, 0.0000000f, 0.0000000f, 0.0000000f
               },
               /* Denoise Weight Chroma */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f
            ...
            /* Noise Profile 3 */
            {
               ...
               {
                  2.3*2.168488f, 2.3*3.585361f, 6.637492f, 8.975364f, 2.3*1.095644f, 2.3*1.927981f, 4.867748f, 7.840800f,
                  2.3*1.525086f, 2.3*4.545071f, 6.666667f, 6.666667f, 2.3*0.430846f, 2.3*1.142099f, 6.666667f, 6.666667f,
                  2.3*1.375621f, 2.3*4.081024f, 6.666667f, 6.666667f, 2.3*0.416465f, 2.3*1.025189f, 6.666667f, 6.666667f
               },
               /* Denoise Scale Y */
               {
            ...
            /* Noise Profile 4 */
            {
               ...
               {
                  2.0*3.173663f, 2.0*4.954436f, 9.108896f, 12.288897f, 2.0*1.825851f, 2.0*3.074269f, 7.266802f, 10.058430f,
            ...
            /* Noise Profile 5 */
            {
               ...
               {
                  2.5*5.074828f, 2.5*7.999325f, 1.5*15.919268f, 1.5*16.114914f, 2.5*3.012555f, 2.5*5.031218f, 1.5*10.307377f, 1.5*14.751428f,
                  2.5*3.677376f, 2.5*6.354329f, 1.5*10.000000f, 1.5*10.000000f, 2.5*1.072035f, 2.5*1.374401f, 1.5*10.000000f, 1.5*10.000000f,
                  2.5*3.096865f, 2.5*5.254936f, 1.5*10.000000f, 1.5*10.000000f, 2.5*0.909064f, 2.5*1.180012f, 1.5*10.000000f, 1.5*10.000000f
               },
               /* Denoise Scale Y */
               {
                  5.000000f, 5.000000f, 5.000000f, 5.000000f
            ...
            /* Noise Profile 6 */
            {
               ...
               {
                  2.5*3.680606f, 2.5*6.404408f, 2.0*13.504833f, 2.0*20.206486f, 2.5*2.038440f, 2.5*3.360987f, 2.0*10.147203f, 2.0*19.645155f,
                  2.5*3.550709f, 2.5*6.666667f,2.0*10.000000f, 2.0*10.000000f, 2.5*0.800279f, 2.5*1.727670f, 2.0*10.000000f, 2.0*10.000000f,
                  2.5*3.294334f, 2.5*6.666667f, 2.0*10.000000f, 2.0*10.000000f, 2.5*0.785868f, 2.5*1.695412f, 2.0*10.000000f, 2.0*10.000000f
               },
               /* Denoise Scale Y */
               {
                  5.000000f,5.000000f, 5.000000f, 5.000000f
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      1, /* Use Digital Gain */
      /* Exposure Table */
      250, /* Max Exposure Table Entries When Digital Gain is Used for EV */
      0, /* Enable Digital Gain for EV Lowlight */
      265, /* Max Exposure Table Entries for Regular AEC */
      {
         ...
         {259, 484},   /* Gain= 1.012   Exposure Index=172   */
         {267, 484},   /* Gain= 1.043   Exposure Index=173   */
         {275, 484},   /* Gain= 1.074   Exposure Index=174   */
         {283, 484},   /* Gain= 1.105   Exposure Index=175   */
         {291, 484},   /* Gain= 1.137   Exposure Index=176   */
         {300, 484},   /* Gain= 1.172   Exposure Index=177   */
         {309, 484},   /* Gain= 1.207   Exposure Index=178   */
         {318, 484},   /* Gain= 1.242   Exposure Index=179   */
         {328, 484},   /* Gain= 1.281   Exposure Index=180   */
         {338, 484},   /* Gain= 1.320   Exposure Index=181   */
         {348, 484},   /* Gain= 1.359   Exposure Index=182   */
         {358, 484},   /* Gain= 1.398   Exposure Index=183   */
         {369, 484},   /* Gain= 1.441   Exposure Index=184   */
         {380, 484},   /* Gain= 1.484   Exposure Index=185   */
         {391, 484},   /* Gain= 1.527   Exposure Index=186   */
         {403, 484},   /* Gain= 1.574   Exposure Index=187   */
         {415, 484},   /* Gain= 1.621   Exposure Index=188   */
         {427, 484},   /* Gain= 1.668   Exposure Index=189   */
         {440, 484},   /* Gain= 1.719   Exposure Index=190   */
         {453, 484},   /* Gain= 1.770   Exposure Index=191   */
         {467, 484},   /* Gain= 1.824   Exposure Index=192   */
         {481, 484},   /* Gain= 1.879   Exposure Index=193   */
         {495, 484},   /* Gain= 1.934   Exposure Index=194   */
         {510, 484},   /* Gain= 1.992   Exposure Index=195   */
         {525, 484},   /* Gain= 2.051   Exposure Index=196   */
         {541, 484},   /* Gain= 2.113   Exposure Index=197   */
         {557, 484},   /* Gain= 2.176   Exposure Index=198   */
         {574, 484},   /* Gain= 2.242   Exposure Index=199   */
         {591, 484},   /* Gain= 2.309   Exposure Index=200   */
         {609, 484},   /* Gain= 2.379   Exposure Index=201   */
         {627, 484},   /* Gain= 2.449   Exposure Index=202   */
         {646, 484},   /* Gain= 2.523   Exposure Index=203   */
         {665, 484},   /* Gain= 2.598   Exposure Index=204   */
         {685, 484},   /* Gain= 2.676   Exposure Index=205   */
         {706, 484},   /* Gain= 2.758   Exposure Index=206   */
         {727, 484},   /* Gain= 2.840   Exposure Index=207   */
         {749, 484},   /* Gain= 2.926   Exposure Index=208   */
         {771, 484},   /* Gain= 3.012   Exposure Index=209   */
         {794, 484},   /* Gain= 3.102   Exposure Index=210   */
         {818, 484},   /* Gain= 3.195   Exposure Index=211   */
         {843, 484},   /* Gain= 3.293   Exposure Index=212   */
         {868, 484},   /* Gain= 3.391   Exposure Index=213   */
         {894, 484},   /* Gain= 3.492   Exposure Index=214   */
         {921, 484},   /* Gain= 3.598   Exposure Index=215   */
         {949, 484},   /* Gain= 3.707   Exposure Index=216   */
         {977, 484},   /* Gain= 3.816   Exposure Index=217   */
         {1006, 484},   /* Gain= 3.930   Exposure Index=218   */
         {1036, 484},   /* Gain= 4.047   Exposure Index=219   */
         {1067, 484},   /* Gain= 4.168   Exposure Index=220   */
         {1099, 484},   /* Gain= 4.293   Exposure Index=221   */
         {1132, 484},   /* Gain= 4.422   Exposure Index=222   */
         {1166, 484},   /* Gain= 4.555   Exposure Index=223   */
         {1201, 484},   /* Gain= 4.691   Exposure Index=224   */
         {1237, 484},   /* Gain= 4.832   Exposure Index=225   */
         {1274, 484},   /* Gain= 4.977   Exposure Index=226   */
         {1312, 484},   /* Gain= 5.125   Exposure Index=227   */
         {1351, 484},   /* Gain= 5.277   Exposure Index=228   */
         {1392, 484},   /* Gain= 5.438   Exposure Index=229   */
         {1434, 484},   /* Gain= 5.602   Exposure Index=230   */
         {1477, 484},   /* Gain= 5.770   Exposure Index=231   */
         {1521, 484},   /* Gain= 5.941   Exposure Index=232   */
         {1567, 484},   /* Gain= 6.121   Exposure Index=233   */
         {1614, 484},   /* Gain= 6.305   Exposure Index=234   */
         {1662, 484},   /* Gain= 6.492   Exposure Index=235   */
         {1712, 484},   /* Gain= 6.688   Exposure Index=236   */
         {1763, 484},   /* Gain= 6.887   Exposure Index=237   */
         {1816, 484},   /* Gain= 7.094   Exposure Index=238   */
         {1870, 484},   /* Gain= 7.305   Exposure Index=239   */
         {1926, 484},   /* Gain= 7.523   Exposure Index=240   */
         {1984, 484},   /* Gain= 7.750   Exposure Index=241   */
         {2044, 484},   /* Gain= 7.984   Exposure Index=242   */
         {2105, 484},   /* Gain= 8.223   Exposure Index=243   */
         {2168, 484},   /* Gain= 8.469   Exposure Index=244   */
         {2233, 484},   /* Gain= 8.723   Exposure Index=245   */
         {2300, 484},   /* Gain= 8.984   Exposure Index=246   */
         {2369, 484},   /* Gain= 9.254   Exposure Index=247   */
         {2440, 484},   /* Gain= 9.531   Exposure Index=248   */
         {2513, 484},   /* Gain= 9.816   Exposure Index=249   */
         {2588, 484},   /* Gain=10.109   Exposure Index=250   */
         {2666, 484},   /* Gain=10.414   Exposure Index=251   */
         {2746, 484},   /* Gain=10.727   Exposure Index=252   */
         {2828, 484},   /* Gain=11.047   Exposure Index=253   */
         {2913, 484},   /* Gain=11.379   Exposure Index=254   */
         {3000, 484},   /* Gain=11.719   Exposure Index=255   */
         {3090, 484},   /* Gain=12.070   Exposure Index=256   */
         {3183, 484},   /* Gain=12.434   Exposure Index=257   */
         {3278, 484},   /* Gain=12.805   Exposure Index=258   */
         {3376, 484},   /* Gain=13.188   Exposure Index=259   */
         {3477, 484},   /* Gain=13.582   Exposure Index=260   */
         {3581, 484},   /* Gain=13.988   Exposure Index=261   */
         {3688, 484},   /* Gain=14.406   Exposure Index=262   */
         {3799, 484},   /* Gain=14.840   Exposure Index=263   */
         {3913, 484},   /* Gain=15.285   Exposure Index=264   */
         {4030, 484},   /* Gain=15.742   Exposure Index=265   */
      },
   },
