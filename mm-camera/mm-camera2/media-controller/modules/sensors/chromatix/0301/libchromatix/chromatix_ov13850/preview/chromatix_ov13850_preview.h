...
/******************************************************************************/
      ...
      /* ABF2 Low Light */
      {
         ...
         {340, 356, 2356}, /* 12-bit pixels */
         {1.000000f, 0.000000f},
         
         /* Green channel parameters */
         {308, 324, 2356}, /* 12-bit pixels */
         {0.988578f, 0.000000f},
         {1.000000f, 1.000000f},
         
         /* Blue channel parameters */
         {372, 388, 2356}, /* 12-bit pixels */
         {1.000000f, 0.000000f},
      ...
      {
         /* Red channel parameters */
         {124, 140, 2268}, /* 12-bit pixels */
         {0.069992f, 0.000000f},
         
         /* Green channel parameters */
         {108, 124, 2428}, /* 12-bit pixels */
         {0.040648f, 0.000000f},
         {1.000000f, 1.000000f},
...
/*********************************************************************/
      ...
      {
         2.5399f,    -1.4622f,    -0.0777f,
         -0.0513f,    1.1423f,    -0.0911f,
         0.2991f,    -1.9812f,    2.6821f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      /* Low-Light Color Correction */
      {
         1.7439f,    -0.5973f,    -0.1466f,
         -0.1343f,    1.3016f,    -0.1674f,
         -0.0139f,    -0.8820f,    1.8959f,
         0,    0,    0,
         0
      },
      /* D65 Color Correction */
      {
         2.9210f,    -1.9698f,    0.0488f,
         -0.1102f,    1.5257f,    -0.4155f,
         0.3829f,    -1.6112f,    2.2283f,
         0,    0,    0,
         0
      },
      /* A Color Correction */
      {
         2.4300f,    -0.6988f,    -0.7312f,
         -0.2833f,    1.2702f,    0.0131f,
         -0.2396f,    -1.5794f,    2.8189f,
         0,    0,    0,
         0
      },
      ...
      {
         2.2151f,    -1.3646f,    0.1495f,
         -0.1071f,    1.1272f,    -0.0201f,
         0.1231f,    -0.9030f,    1.7800f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      /* 7x7 ASF */
      {
         ...
         /* H / Lut1 */
         {
            ...
            /* Normal Light */
            {
               0.100000f, 0.100000f, 0.668586f, 1.749916f, 2.272967f, 2.387081f,
...
/*********************************************************************/
   ...
   {1.399108f, 1.000000f, 1.280727f},
   /* D50 Whitebalance - RGB */
   {1.693000f, 1.000000f, 1.560000f},
   /* A Whitebalance - RGB */
   {1.351860f, 1.000000f, 1.881785f},
   /* D65 Whitebalance - RGB */
   {1.584805f, 1.000000f, 1.329661f},
...
/******************************************************************************/
   ...
   /* Lowlight LUT */
   {
      1, /* Enable */
      {
         ...
         {
            321, /* Lux Index */
            -0.714775f, /* Green RG Offset Adj */
            -2.473586f, /* Green BG Offset Adj */
            2.574788f, /* Outlier Dist Adj */
         },
         /* Entry 2 */
         {
            344, /* Lux Index */
            -0.852333f, /* Green RG Offset Adj */
            -4.361708f, /* Green BG Offset Adj */
            4.444206f, /* Outlier Dist Adj */
         },
         /* Entry 3 */
         {
            373, /* Lux Index */
            -1.414832f, /* Green RG Offset Adj */
            -4.361708f, /* Green BG Offset Adj */
            4.444206f, /* Outlier Dist Adj */
         },
         /* Entry 4 */
         ...
         {
            378, /* Lux Index */
            -3.580339f, /* Green RG Offset Adj */
            -4.361708f, /* Green BG Offset Adj */
            5.085259f, /* Outlier Dist Adj */
         },
      },
   },
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      ...
      379, /* Max Exposure Table Entries for EV+2 with digital gain */
      {
         ...
         {261, 1660},	/* Gain= 1.020	Exposure Index=252	*/
         {269, 1660},	/* Gain= 1.051	Exposure Index=253	*/
         {277, 1660},	/* Gain= 1.082	Exposure Index=254	*/
         {285, 1660},	/* Gain= 1.113	Exposure Index=255	*/
         {294, 1660},	/* Gain= 1.148	Exposure Index=256	*/
         {303, 1660},	/* Gain= 1.184	Exposure Index=257	*/
         {312, 1660},	/* Gain= 1.219	Exposure Index=258	*/
         {321, 1660},	/* Gain= 1.254	Exposure Index=259	*/
         {331, 1660},	/* Gain= 1.293	Exposure Index=260	*/
         {341, 1660},	/* Gain= 1.332	Exposure Index=261	*/
         {351, 1660},	/* Gain= 1.371	Exposure Index=262	*/
         {362, 1660},	/* Gain= 1.414	Exposure Index=263	*/
         {373, 1660},	/* Gain= 1.457	Exposure Index=264	*/
         {384, 1660},	/* Gain= 1.500	Exposure Index=265	*/
         {396, 1660},	/* Gain= 1.547	Exposure Index=266	*/
         {408, 1660},	/* Gain= 1.594	Exposure Index=267	*/
         {420, 1660},	/* Gain= 1.641	Exposure Index=268	*/
         {433, 1660},	/* Gain= 1.691	Exposure Index=269	*/
         {446, 1660},	/* Gain= 1.742	Exposure Index=270	*/
         {459, 1660},	/* Gain= 1.793	Exposure Index=271	*/
         {473, 1660},	/* Gain= 1.848	Exposure Index=272	*/
         {487, 1660},	/* Gain= 1.902	Exposure Index=273	*/
         {502, 1660},	/* Gain= 1.961	Exposure Index=274	*/
         {517, 1660},	/* Gain= 2.020	Exposure Index=275	*/
         {533, 1660},	/* Gain= 2.082	Exposure Index=276	*/
         {549, 1660},	/* Gain= 2.145	Exposure Index=277	*/
         {565, 1660},	/* Gain= 2.207	Exposure Index=278	*/
         {582, 1660},	/* Gain= 2.273	Exposure Index=279	*/
         {599, 1660},	/* Gain= 2.340	Exposure Index=280	*/
         {617, 1660},	/* Gain= 2.410	Exposure Index=281	*/
         {636, 1660},	/* Gain= 2.484	Exposure Index=282	*/
         {655, 1660},	/* Gain= 2.559	Exposure Index=283	*/
         {675, 1660},	/* Gain= 2.637	Exposure Index=284	*/
         {695, 1660},	/* Gain= 2.715	Exposure Index=285	*/
         {716, 1660},	/* Gain= 2.797	Exposure Index=286	*/
         {737, 1660},	/* Gain= 2.879	Exposure Index=287	*/
         {759, 1660},	/* Gain= 2.965	Exposure Index=288	*/
         {782, 1660},	/* Gain= 3.055	Exposure Index=289	*/
         {805, 1660},	/* Gain= 3.145	Exposure Index=290	*/
         {829, 1660},	/* Gain= 3.238	Exposure Index=291	*/
         {854, 1660},	/* Gain= 3.336	Exposure Index=292	*/
         {880, 1660},	/* Gain= 3.438	Exposure Index=293	*/
         {906, 1660},	/* Gain= 3.539	Exposure Index=294	*/
         {933, 1660},	/* Gain= 3.645	Exposure Index=295	*/
         {961, 1660},	/* Gain= 3.754	Exposure Index=296	*/
         {990, 1660},	/* Gain= 3.867	Exposure Index=297	*/
         {1020, 1660},	/* Gain= 3.984	Exposure Index=298	*/
         {1051, 1660},	/* Gain= 4.105	Exposure Index=299	*/
         {1083, 1660},	/* Gain= 4.230	Exposure Index=300	*/
         {1115, 1660},	/* Gain= 4.355	Exposure Index=301	*/
         {1148, 1660},	/* Gain= 4.484	Exposure Index=302	*/
         {1182, 1660},	/* Gain= 4.617	Exposure Index=303	*/
         {1217, 1660},	/* Gain= 4.754	Exposure Index=304	*/
         {1254, 1660},	/* Gain= 4.898	Exposure Index=305	*/
         {1292, 1660},	/* Gain= 5.047	Exposure Index=306	*/
         {1331, 1660},	/* Gain= 5.199	Exposure Index=307	*/
         {1371, 1660},	/* Gain= 5.355	Exposure Index=308	*/
         {1412, 1660},	/* Gain= 5.516	Exposure Index=309	*/
         {1454, 1660},	/* Gain= 5.680	Exposure Index=310	*/
         {1498, 1660},	/* Gain= 5.852	Exposure Index=311	*/
         {1543, 1660},	/* Gain= 6.027	Exposure Index=312	*/
         {1589, 1660},	/* Gain= 6.207	Exposure Index=313	*/
         {1637, 1660},	/* Gain= 6.395	Exposure Index=314	*/
         {1686, 1660},	/* Gain= 6.586	Exposure Index=315	*/
         {1737, 1660},	/* Gain= 6.785	Exposure Index=316	*/
         {1789, 1660},	/* Gain= 6.988	Exposure Index=317	*/
         {1843, 1660},	/* Gain= 7.199	Exposure Index=318	*/
         {1898, 1660},	/* Gain= 7.414	Exposure Index=319	*/
         {1955, 1660},	/* Gain= 7.637	Exposure Index=320	*/
         {2014, 1660},	/* Gain= 7.867	Exposure Index=321	*/
         {2074, 1660},	/* Gain= 8.102	Exposure Index=322	*/
         {2136, 1660},	/* Gain= 8.344	Exposure Index=323	*/
         {2200, 1660},	/* Gain= 8.594	Exposure Index=324	*/
         {2266, 1660},	/* Gain= 8.852	Exposure Index=325	*/
         {2334, 1660},	/* Gain= 9.117	Exposure Index=326	*/
         {2404, 1660},	/* Gain= 9.391	Exposure Index=327	*/
         {2476, 1660},	/* Gain= 9.672	Exposure Index=328	*/
         {2550, 1660},	/* Gain= 9.961	Exposure Index=329	*/
         {2560, 1660},	/* Gain=10.000	Exposure Index=330	*/
         {2560, 1709},	/* Gain=10.000	Exposure Index=331	*/
         {2560, 1760},	/* Gain=10.000	Exposure Index=332	*/
         {2560, 1812},	/* Gain=10.000	Exposure Index=333	*/
         {2560, 1866},	/* Gain=10.000	Exposure Index=334	*/
         {2560, 1921},	/* Gain=10.000	Exposure Index=335	*/
         {2560, 1978},	/* Gain=10.000	Exposure Index=336	*/
         {2560, 2037},	/* Gain=10.000	Exposure Index=337	*/
         {2560, 2098},	/* Gain=10.000	Exposure Index=338	*/
         {2560, 2160},	/* Gain=10.000	Exposure Index=339	*/
         {2560, 2224},	/* Gain=10.000	Exposure Index=340	*/
         {2560, 2290},	/* Gain=10.000	Exposure Index=341	*/
         {2560, 2358},	/* Gain=10.000	Exposure Index=342	*/
         {2560, 2428},	/* Gain=10.000	Exposure Index=343	*/
         {2560, 2500},	/* Gain=10.000	Exposure Index=344	*/
         {2560, 2575},	/* Gain=10.000	Exposure Index=345	*/
         {2560, 2652},	/* Gain=10.000	Exposure Index=346	*/
         {2560, 2731},	/* Gain=10.000	Exposure Index=347	*/
         {2560, 2812},	/* Gain=10.000	Exposure Index=348	*/
         {2560, 2896},	/* Gain=10.000	Exposure Index=349	*/
         {2560, 2982},	/* Gain=10.000	Exposure Index=350	*/
         {2560, 3071},	/* Gain=10.000	Exposure Index=351	*/
         {2560, 3163},	/* Gain=10.000	Exposure Index=352	*/
         {2560, 3257},	/* Gain=10.000	Exposure Index=353	*/
         {2560, 3354},	/* Gain=10.000	Exposure Index=354	*/
         {2560, 3454},	/* Gain=10.000	Exposure Index=355	*/
         {2560, 3557},	/* Gain=10.000	Exposure Index=356	*/
         {2560, 3663},	/* Gain=10.000	Exposure Index=357	*/
         {2560, 3772},	/* Gain=10.000	Exposure Index=358	*/
         {2560, 3885},	/* Gain=10.000	Exposure Index=359	*/
         {2560, 4001},	/* Gain=10.000	Exposure Index=360	*/
         {2560, 4121},	/* Gain=10.000	Exposure Index=361	*/
         {2560, 4244},	/* Gain=10.000	Exposure Index=362	*/
         {2560, 4371},	/* Gain=10.000	Exposure Index=363	*/
         {2560, 4502},	/* Gain=10.000	Exposure Index=364	*/
         {2560, 4637},	/* Gain=10.000	Exposure Index=365	*/
         {2560, 4776},	/* Gain=10.000	Exposure Index=366	*/
         {2560, 4919},	/* Gain=10.000	Exposure Index=367	*/
         {2600, 4988},	/* Gain=10.156	Exposure Index=368	*/
         {2678, 4988},	/* Gain=10.461	Exposure Index=369	*/
         {2758, 4988},	/* Gain=10.773	Exposure Index=370	*/
         {2841, 4988},	/* Gain=11.098	Exposure Index=371	*/
         {2926, 4988},	/* Gain=11.430	Exposure Index=372	*/
         {3014, 4988},	/* Gain=11.773	Exposure Index=373	*/
         {3104, 4988},	/* Gain=12.125	Exposure Index=374	*/
         {3197, 4988},	/* Gain=12.488	Exposure Index=375	*/
         {3293, 4988},	/* Gain=12.863	Exposure Index=376	*/
         {3392, 4988},	/* Gain=13.250	Exposure Index=377	*/
         {3494, 4988}	/* Gain=13.648	Exposure Index=378	*/
      },
   },
