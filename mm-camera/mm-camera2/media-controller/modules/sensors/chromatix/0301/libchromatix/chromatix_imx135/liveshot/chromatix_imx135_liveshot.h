...
/*********************************************************************/
   ...
   {
      1, /* Use Digital Gain */
      387, /* Max Exposure Table entries */
      ...
      {259, 2676},	/* Gain= 1.012	Exposure Index=268	*/
      {267, 2676},	/* Gain= 1.043	Exposure Index=269	*/
      {275, 2676},	/* Gain= 1.074	Exposure Index=270	*/
      {283, 2676},	/* Gain= 1.105	Exposure Index=271	*/
      {291, 2676},	/* Gain= 1.137	Exposure Index=272	*/
      {300, 2676},	/* Gain= 1.172	Exposure Index=273	*/
      {309, 2676},	/* Gain= 1.207	Exposure Index=274	*/
      {318, 2676},	/* Gain= 1.242	Exposure Index=275	*/
      {328, 2676},	/* Gain= 1.281	Exposure Index=276	*/
      {338, 2676},	/* Gain= 1.320	Exposure Index=277	*/
      {348, 2676},	/* Gain= 1.359	Exposure Index=278	*/
      {358, 2676},	/* Gain= 1.398	Exposure Index=279	*/
      {369, 2676},	/* Gain= 1.441	Exposure Index=280	*/
      {380, 2676},	/* Gain= 1.484	Exposure Index=281	*/
      {391, 2676},	/* Gain= 1.527	Exposure Index=282	*/
      {403, 2676},	/* Gain= 1.574	Exposure Index=283	*/
      {415, 2676},	/* Gain= 1.621	Exposure Index=284	*/
      {427, 2676},	/* Gain= 1.668	Exposure Index=285	*/
      {440, 2676},	/* Gain= 1.719	Exposure Index=286	*/
      {453, 2676},	/* Gain= 1.770	Exposure Index=287	*/
      {467, 2676},	/* Gain= 1.824	Exposure Index=288	*/
      {481, 2676},	/* Gain= 1.879	Exposure Index=289	*/
      {495, 2676},	/* Gain= 1.934	Exposure Index=290	*/
      {510, 2676},	/* Gain= 1.992	Exposure Index=291	*/
      {525, 2676},	/* Gain= 2.051	Exposure Index=292	*/
      {541, 2676},	/* Gain= 2.113	Exposure Index=293	*/
      {557, 2676},	/* Gain= 2.176	Exposure Index=294	*/
      {574, 2676},	/* Gain= 2.242	Exposure Index=295	*/
      {591, 2676},	/* Gain= 2.309	Exposure Index=296	*/
      {609, 2676},	/* Gain= 2.379	Exposure Index=297	*/
      {627, 2676},	/* Gain= 2.449	Exposure Index=298	*/
      {646, 2676},	/* Gain= 2.523	Exposure Index=299	*/
      {665, 2676},	/* Gain= 2.598	Exposure Index=300	*/
      {685, 2676},	/* Gain= 2.676	Exposure Index=301	*/
      {706, 2676},	/* Gain= 2.758	Exposure Index=302	*/
      {727, 2676},	/* Gain= 2.840	Exposure Index=303	*/
      {749, 2676},	/* Gain= 2.926	Exposure Index=304	*/
      {771, 2676},	/* Gain= 3.012	Exposure Index=305	*/
      {794, 2676},	/* Gain= 3.102	Exposure Index=306	*/
      {818, 2676},	/* Gain= 3.195	Exposure Index=307	*/
      {843, 2676},	/* Gain= 3.293	Exposure Index=308	*/
      {868, 2676},	/* Gain= 3.391	Exposure Index=309	*/
      {894, 2676},	/* Gain= 3.492	Exposure Index=310	*/
      {921, 2676},	/* Gain= 3.598	Exposure Index=311	*/
      {949, 2676},	/* Gain= 3.707	Exposure Index=312	*/
      {977, 2676},	/* Gain= 3.816	Exposure Index=313	*/
      {1006, 2676},	/* Gain= 3.930	Exposure Index=314	*/
      {1036, 2676},	/* Gain= 4.047	Exposure Index=315	*/
      {1067, 2676},	/* Gain= 4.168	Exposure Index=316	*/
      {1099, 2676},	/* Gain= 4.293	Exposure Index=317	*/
      {1132, 2676},	/* Gain= 4.422	Exposure Index=318	*/
      {1166, 2676},	/* Gain= 4.555	Exposure Index=319	*/
      {1201, 2676},	/* Gain= 4.691	Exposure Index=320	*/
      {1237, 2676},	/* Gain= 4.832	Exposure Index=321	*/
      {1274, 2676},	/* Gain= 4.977	Exposure Index=322	*/
      {1312, 2676},	/* Gain= 5.125	Exposure Index=323	*/
      {1351, 2676},	/* Gain= 5.277	Exposure Index=324	*/
      {1392, 2676},	/* Gain= 5.438	Exposure Index=325	*/
      {1434, 2676},	/* Gain= 5.602	Exposure Index=326	*/
      {1477, 2676},	/* Gain= 5.770	Exposure Index=327	*/
      {1521, 2676},	/* Gain= 5.941	Exposure Index=328	*/
      {1567, 2676},	/* Gain= 6.121	Exposure Index=329	*/
      {1614, 2676},	/* Gain= 6.305	Exposure Index=330	*/
      {1662, 2676},	/* Gain= 6.492	Exposure Index=331	*/
      {1712, 2676},	/* Gain= 6.688	Exposure Index=332	*/
      {1763, 2676},	/* Gain= 6.887	Exposure Index=333	*/
      {1816, 2676},	/* Gain= 7.094	Exposure Index=334	*/
      {1870, 2676},	/* Gain= 7.305	Exposure Index=335	*/
      {1926, 2676},	/* Gain= 7.523	Exposure Index=336	*/
      {1984, 2676},	/* Gain= 7.750	Exposure Index=337	*/
      {2044, 2676},	/* Gain= 7.984	Exposure Index=338	*/
      ...
      {2048, 6665},	/* Gain= 8.000	Exposure Index=370	*/
      {2048, 6864},	/* Gain= 8.000	Exposure Index=371	*/
      {2048, 7069},	/* Gain= 8.000	Exposure Index=372	*/
      {2048, 7281},	/* Gain= 8.000	Exposure Index=373	*/
      {2048, 7499},	/* Gain= 8.000	Exposure Index=374	*/
      {2048, 7723},	/* Gain= 8.000	Exposure Index=375	*/
      {2048, 7954},	/* Gain= 8.000	Exposure Index=376	*/
      {2048, 8192},	/* Gain= 8.000	Exposure Index=377	*/
      {2048, 8437},	/* Gain= 8.000	Exposure Index=378	*/
      {2048, 8690},	/* Gain= 8.000	Exposure Index=379	*/
      {2048, 8950},	/* Gain= 8.000	Exposure Index=380	*/
      {2048, 9218},	/* Gain= 8.000	Exposure Index=381	*/
      {2048, 9494},	/* Gain= 8.000	Exposure Index=382	*/
      {2048, 9778},	/* Gain= 8.000	Exposure Index=383	*/
      {2048, 10071},	/* Gain= 8.000	Exposure Index=384	*/
      {2048, 10373},	/* Gain= 8.000	Exposure Index=385	*/
      {2048, 10684}	/* Gain= 8.000	Exposure Index=386	*/
      },
   },
