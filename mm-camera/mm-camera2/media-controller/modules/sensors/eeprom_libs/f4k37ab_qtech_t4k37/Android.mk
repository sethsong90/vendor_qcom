F4K37AB_QTECH_T4K37_EEPROM_LIBS_PATH := $(call my-dir)


# ---------------------------------------------------------------------------
#        Make the shared library (libmmcamera_f4k37ab_qtech_t4k37_eeprom.so)
# ---------------------------------------------------------------------------


include $(CLEAR_VARS)
LOCAL_PATH := $(F4K37AB_QTECH_T4K37_EEPROM_LIBS_PATH)
...
LOCAL_SRC_FILES:= f4k37ab_qtech_t4k37_eeprom.c
LOCAL_MODULE           := libmmcamera_f4k37ab_qtech_t4k37_eeprom
