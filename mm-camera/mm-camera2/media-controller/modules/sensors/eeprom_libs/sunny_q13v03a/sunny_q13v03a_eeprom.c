...
#define RG_TYPICAL_VALUE 0x139
#define BG_TYPICAL_VALUE 0x13A


#define SUNNY_Q13V013A_EEPROM_AWB_ENABLE 1
#define SUNNY_Q13V013A_EEPROM_LSC_ENABLE 1
...
/** sunny_q13v03a_get_calibration_items:
 ...
 * Return: void.
 **/
void sunny_q13v03a_get_calibration_items(void *e_ctrl)
{
 ...
 * Return: void.
 */
static void sunny_q13v03a_calc_otp(uint16_t r_ratio, uint16_t b_ratio,
 ...
 * Return: void.
 **/
static void sunny_q13v03a_calc_gain(uint16_t R_target, uint16_t B_target,
 ...
 **/
static void sunny_q13v03a_update_awb()
{
  uint16_t R_gain = 0;
  uint16_t G_gain = 0;
  uint16_t B_gain = 0;
  ...
  R_offset_inside = RG_TYPICAL_VALUE / 100; // ?ид1%
  R_offset_outside = RG_TYPICAL_VALUE * 3 / 100; // ?ид3%
  ...
  if ((ABS(otp_data.rg_ratio - RG_TYPICAL_VALUE)
    ...
    if ((ABS(otp_data.rg_ratio - RG_TYPICAL_VALUE) < R_offset_outside)
      ...
      sunny_q13v03a_calc_otp(otp_data.rg_ratio, otp_data.bg_ratio,
        &R_target, &B_target, R_offset_inside, B_offset_inside);
    } else {
      sunny_q13v03a_calc_otp(otp_data.rg_ratio, otp_data.bg_ratio,
        &R_target, &B_target, R_offset_outside, B_offset_outside);
    }
    sunny_q13v03a_calc_gain(R_target,B_target,&R_gain,&B_gain,&G_gain);
  }


#if SUNNY_Q13V013A_EEPROM_AWB_ENABLE
 ...
 **/
static int sunny_q13v03a_read_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  uint8_t flag, temp;
  int index, offset;
 ...
 * Return: void.
 **/
static void sunny_q13v03a_format_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  int rc = 0;
  rc = sunny_q13v03a_read_wbdata(e_ctrl);
  if(rc < 0)
...
/** sunny_q13v03a_format_lensshading:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void sunny_q13v03a_format_lensshading(sensor_eeprom_data_t *e_ctrl)
{
  uint8_t flag, temp;
  int index, offset, i;
...
#if SUNNY_Q13V013A_EEPROM_LSC_ENABLE
  g_reg_array[g_reg_setting.size].reg_data
...
/** sunny_q13v03a_format_calibration_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void sunny_q13v03a_format_calibration_data(void *e_ctrl) {
  ...
  sunny_q13v03a_format_wbdata(ectrl);
  sunny_q13v03a_format_lensshading(ectrl);
  SLOW("Exit %s", __func__);
}


/** sunny_q13v03a_get_raw_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 ...
 * Return: void.
 **/
void sunny_q13v03a_get_raw_data(void *e_ctrl, void *data) {
  if (e_ctrl && data)
...
static eeprom_lib_func_t sunny_q13v03a_lib_func_ptr = {
  .get_calibration_items = sunny_q13v03a_get_calibration_items,
  .format_calibration_data = sunny_q13v03a_format_calibration_data,
  .do_af_calibration = NULL,
  .do_wbc_calibration = NULL,
  .do_lsc_calibration = NULL,
  .do_dpc_calibration = NULL,
  .get_dpc_calibration_info = NULL,
  .get_raw_data = sunny_q13v03a_get_raw_data,
};


/** sunny_q13v03a_eeprom_open_lib:
 *
 ...
 **/
void* sunny_q13v03a_eeprom_open_lib(void) {
  return &sunny_q13v03a_lib_func_ptr;
}