...
============================================================================*/{
  {
    ...
    /* af_tuning_algo_t */{
      ...
      /* af_tuning_exhaustive_t */{
         ...
         * fewer windows eligible for counting into the total FV.
         * 3A version:
         * Default value: 0.10
         * Data range: 0.0 to 1.0
         * Constraints: None
         ...
         * 3A version:
         * Default value: mw_thresh_1*1.5 (0.10*1.5=0.15)
         * Data range: 0.0 to 1.0
         * Constraints: None
         * Effect:
         */
         ...
         * 3A version:
         * Default value: mw_thresh_1*2 (0.10*2=0.20)
         * Data range: 0.0 to 1.0
         * Constraints: None
         * Effect:
         */
         ...
         * work if enabled.
         * 3A version:
         * Default value: 70% of max_gain of the sensor
         * Data range: 0.0 to max_gain
         * Constraints: None
         * Effect:
         */
        8.0,
    ...
    /* actuator_params_t */{
      ...
      4,
      /* init_settings */{
        {0xcc, 0x3b},   /* 80Hz, slew rate 0x11 */
        {0xd4, 0x01},   /* step mode, point A:0x001 */
        {0xdc, 0x02},   /* step mode, point B:0x002 */
        {0xe4, 0x21},
      }
      ,
    }
