...
typedef struct
{
  ...
  unsigned short  af_uphill_allowance;
  ...
  unsigned short  af_init_search_type; // search algorithm to use before
                                       //entering monitor mode
  unsigned short  af_search_type; // search algorithm to use after monitor mode
  unsigned short  af_lux_index_trig_threshold;
}AF_CAF_t;
