...
/******************************************************************************/
    ...
    AF_SLOPE_PREDICTIVE_SEARCH, /* Process Type */
    0, /* Near End */
    36, /* Default In Macro */
    20, /* Boundary */
    36, /* Defult In Normal */
...
/******************************************************************************/
      ...
      2, /* Downhill Allowance */
      3, /* Uphill allowance - used for Macro focus position */
...
/******************************************************************************/
      ...
      AF_EXHAUSTIVE_SEARCH, /* AF algo to use before entering monitor mode */
      AF_SLOPE_PREDICTIVE_SEARCH, /* AF algo to use after scene change is detected */
      23,
    },
...
/******************************************************************************/
    ...
    {
      0.9, /* af_fv_curve_flat_threshold */
      0.9, /* af_slope_threshold1 */
      1.1, /* af_slope_threshold2 */
      0.5, /* af_slope_threshold3 */
      3, /* af_slope_threshold4 */
      33, /* af_lens_pos_0 */
      29, /* af_lens_pos_1 */
      25, /* af_lens_pos_2 */
      21, /* af_lens_pos_3 */
      ...
      7, /* af_lens_pos_5 */
      1, /* af_sp_frame_delay */
      2, /* af_downhill_allowance */
      1, /* af_downhill_allowance_1 */
    },
