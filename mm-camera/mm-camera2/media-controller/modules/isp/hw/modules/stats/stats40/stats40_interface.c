  ...
  enum msm_isp_stats_type stats_type)
{
  ...
  case MSM_ISP_STATS_AEC:
    stats->stats_ops[stats_type] = aec_stats_open(stats, stats_type);
  ...
  case MSM_ISP_STATS_AF:
    stats->stats_ops[stats_type] = af_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_AWB:
    stats->stats_ops[stats_type] = awb_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_RS:
    stats->stats_ops[stats_type] = rs_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_CS:
    stats->stats_ops[stats_type] = cs_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_IHIST:
    stats->stats_ops[stats_type] = ihist_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_BG:
    stats->stats_ops[stats_type] = bg_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_BF:
    stats->stats_ops[stats_type] = bf_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_BE:
    stats->stats_ops[stats_type] = be_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
  ...
  case MSM_ISP_STATS_BHIST:
    stats->stats_ops[stats_type] = bhist_stats_open(stats, stats_type);
    if (stats->stats_ops[stats_type] == NULL) {
 ...
 **/
isp_ops_t *stats40_open(uint32_t version)
{
