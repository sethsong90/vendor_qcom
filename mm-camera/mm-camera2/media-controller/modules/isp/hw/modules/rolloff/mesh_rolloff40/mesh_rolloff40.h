...
/* extend  mesh size decide by system algo
   function: mesh_rolloff_V4_ScaleRolloffMesh_by_sensor_info*/
...
typedef struct {
  ...
  MESH_RollOff_v4_ConfigParams applied_CfgParams;
