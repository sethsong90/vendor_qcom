...
#define C2D_NUM_SINK_PORTS    5
#define C2D_NUM_SOURCE_PORTS  5
  ...
  unsigned int sessionid)
{
  ...
  pp_cap->min_required_pp_mask |= CAM_QCOM_FEATURE_CROP;
  pp_cap->feature_mask |= (CAM_QCOM_FEATURE_FLIP| CAM_QCOM_FEATURE_SCALE);
  return TRUE;
}
